...
var Module = typeof LibYUV !== 'undefined' ? LibYUV : {};
...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_ConvertRGBA88882YUV420P')) {
        Object.defineProperty(Module['ready'], '_ConvertRGBA88882YUV420P', { configurable: true, get: function() { abort('You are getting _ConvertRGBA88882YUV420P on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_ConvertRGBA88882YUV420P', { configurable: true, set: function() { abort('You are setting _ConvertRGBA88882YUV420P on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_ConvertYUV420P2RGBA8888')) {
        Object.defineProperty(Module['ready'], '_ConvertYUV420P2RGBA8888', { configurable: true, get: function() { abort('You are getting _ConvertYUV420P2RGBA8888 on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_ConvertYUV420P2RGBA8888', { configurable: true, set: function() { abort('You are setting _ConvertYUV420P2RGBA8888 on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_I420ToABGR')) {
        Object.defineProperty(Module['ready'], '_I420ToABGR', { configurable: true, get: function() { abort('You are getting _I420ToABGR on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_I420ToABGR', { configurable: true, set: function() { abort('You are setting _I420ToABGR on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_ABGRToI420')) {
        Object.defineProperty(Module['ready'], '_ABGRToI420', { configurable: true, get: function() { abort('You are getting _ABGRToI420 on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_ABGRToI420', { configurable: true, set: function() { abort('You are setting _ABGRToI420 on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var wasmBinaryFile = 'LibYUV.wasm';
...
/** @type {function(...*):?} */
var _ConvertRGBA88882YUV420P = Module["_ConvertRGBA88882YUV420P"] = createExportWrapper("ConvertRGBA88882YUV420P");

/** @type {function(...*):?} */
var _ABGRToI420 = Module["_ABGRToI420"] = createExportWrapper("ABGRToI420");

/** @type {function(...*):?} */
var _ConvertYUV420P2RGBA8888 = Module["_ConvertYUV420P2RGBA8888"] = createExportWrapper("ConvertYUV420P2RGBA8888");

/** @type {function(...*):?} */
var _I420ToABGR = Module["_I420ToABGR"] = createExportWrapper("I420ToABGR");
...
Module['onRuntimeInitialized'] = window.onRuntimeInitialized;
...
if (typeof exports === 'object' && typeof module === 'object')
  module.exports = LibYUV;
else if (typeof define === 'function' && define['amd'])
  define([], function() { return LibYUV; });
else if (typeof exports === 'object')
  exports["LibYUV"] = LibYUV;
