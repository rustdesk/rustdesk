...
create-dmg --icon "KassatkaDesk.app" 200 190 --hide-extension "KassatkaDesk.app" --window-size 800 400 --app-drop-link 600 185 rustdesk-$VERSION.dmg ./flutter/build/macos/Build/Products/Release/KassatkaDesk.app
