# RustDesk Customizations & GCP API Server Knowledge Base (2026-06-04)

This documentation serves as the master knowledge base for custom configurations, client repacking scripts, and the custom GCP API Server developed for the RustDesk monorepo, as of June 4, 2026.
