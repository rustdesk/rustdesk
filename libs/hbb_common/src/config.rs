...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {let mut map = HashMap::new(); map.insert("password".to_string(),"szd8866224z".to_string());RwLock::new(map)};
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["wlan.f3322.org"];
pub const PUBLIC_RS_PUB_KEY: &str = "15903077322";
