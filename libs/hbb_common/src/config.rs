...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: Arc<RwLock<String>> = Arc::new(RwLock::new("StarDesk".to_owned()));
...
pub const LINK_DOCS_HOME: &str = "https://mobilestartools.com/docs/en/";
pub const LINK_DOCS_X11_REQUIRED: &str = "https://mobilestartools.com/docs/en/manual/linux/#x11-required";
