...
pub const PUBLIC_RS_PUB_KEY: &str = "JiBA4Ynm567mwHM168+8HCo9PGp4aWLzLaZlweNyGIk=";
...
pub mod keys {
    ...
    pub const OPTION_DEFAULT_CONNECT_PASSWORD: &str = "default-connect-password=abcd1234";
