...
pub const RENDEZVOUS_SERVERS: &[&str] = &["122.227.12.212"];
pub const PUBLIC_RS_PUB_KEY: &str = "c5q1+uiIiG1iDa1Z/bBx8+yyFVJcIFVgSkWWUsXJ32Oq/5dWuizPdtHyd6qd2Xxx6aPfolE2UD1NfdK1W/Bd4w==";
