...
// pub const RENDEZVOUS_SERVERS: &[&str] = &["rustdesk.songques.com"];
// pub const PUBLIC_RS_PUB_KEY: &str = "TkQvNKhnvN6YVUxT2DpTEbPteLbKde+0TBPGQf1VjU0=";

pub const RENDEZVOUS_SERVERS: &[&str] = &["47.94.136.90"];
pub const PUBLIC_RS_PUB_KEY: &str = "TkQvNKhnvN6YVUxT2DpTEbPteLbKde+0TBPGQf1VjU0=";
