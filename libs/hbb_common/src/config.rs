...
lazy_static::lazy_static! {
    ...
    pub static ref OVERWRITE_LOCAL_SETTINGS: RwLock<HashMap<String, String>> = Default::default();
     pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "Biyi8888".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["223.94.34.179:53186"];
pub const PUBLIC_RS_PUB_KEY: &str = "e5TZ75pFMrGAJ4GDmvK8CWIaFVyFEiURHgeCtzEFP7k=";
