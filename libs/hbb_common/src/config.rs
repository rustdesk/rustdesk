...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rust.master.mmnn.online"];
pub const PUBLIC_RS_PUB_KEY: &str = "MIJypXZwanshs6GI9uehOEH5BPhs502cfTqQw3gsU3w=";
...
pub const RENDEZVOUS_PORT: i32 = 37210;
pub const RELAY_PORT: i32 = 37211;
