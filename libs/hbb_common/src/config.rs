...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("IT-Breitenstein-Fernwartung".to_owned());
...
pub const LINK_DOCS_HOME: &str = "https://breitenstein.it";
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["fernwartung.it-breitenstein.de"];
pub const PUBLIC_RS_PUB_KEY: &str = "Npglzp1NfKE67GWoSakgjEyTQ+HvIVkbrWoSX44+BK0=";
