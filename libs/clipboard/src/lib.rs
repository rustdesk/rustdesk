...
pub fn create_cliprdr_context(enable_files: bool) -> ResultType<Box<CliprdrClientContext>> {
...
extern "C" fn client_format_list(
    ...
    log::info!("client_format_list called");
...
extern "C" fn client_format_list_response(
    ...
    log::info!("client_format_list_response called");
...
extern "C" fn client_format_data_request(
    ...
    log::info!("client_format_data_request called");
...
extern "C" fn client_format_data_response(
    ...
    log::info!("client_format_data_response called");
...
extern "C" fn client_file_contents_request(
    ...
    log::info!("client_file_contents_request called");
...
extern "C" fn client_file_contents_response(
    ...
    log::info!("client_file_contents_response called");
