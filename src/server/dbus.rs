...
///
/// Note:
/// On linux, we use dbus to communicate multiple techdesk process.
...
const DBUS_NAME: &str = "org.techdesk.techdesk";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "TechDesk DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.techdesk.techdesk /dbus org.techdesk.techdesk.NewConnection string:'PEER_ID'`
