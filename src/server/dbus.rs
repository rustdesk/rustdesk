...
const DBUS_NAME: &str = "org.kassatka.kassatkadesk";
...
/// `dbus-send --session --print-reply --dest=org.kassatka.kassatkadesk /dbus org.kassatka.kassatkadesk.NewConnection string:'PEER_ID'`
