...
///1    log_to_file(&format!("update_latest_input_cursor_time process id {}", std::process::id()));
    log::debug!(&format!("update_latest_input_cursor_time process id {}", std::process::id()));
