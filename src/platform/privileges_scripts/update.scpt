on run {daemon_file, agent_file, user, cur_pid, source_dir}
  ...
  set sh to "set -e;" & check_source & resolve_uid & unload_agent & unload_service & unload_legacy_agent & unload_legacy_service & remove_legacy_plists & kill_others & copy_files & write_daemon_plist & write_agent_plist & load_service & load_agent
