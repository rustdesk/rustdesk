...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Slogan_tip", "Keep Technology Human"),
        ...
        ("install_tip", "Due to UAC, RustDesk can not work properly as the remote side in some cases. To avoid UAC, you may click the button below to install RustDesk to the system."),
        ...
        ("Ignore Battery Optimizations", "Ignore battery optimisations"),
        ...
        ("elevated_foreground_window_tip", "The current window of the remote desktop requires higher privilege to operate, so it's unable to use the mouse and keyboard temporarily. Please ask the request the remote user to minimise the current window, or click elevation button on the connection management window. To avoid this problem, it is recommended to install the software on the remote device."),
        ...
        ("wait_accept_uac_tip", "Please wait for the remote user to accept the UAC dialogue."),
        ...
        ("empty_recent_tip", "No recent sessions.\nTime to connect!"),
        ("empty_favorite_tip", "No favourite peers yet.\nYou can add favourites to make things easier to find."),
        ("empty_lan_tip", "No peers discovered yet."),
        ...
        ("synced_peer_readded_tip", "The devices that were present in the recent sessions will be synchronised back to the address book."),
        ("Change Color", "Change color"),
        ("Primary Color", "Primary color"),
        ("HSV Color", "HSV color"),
        ("Installation Successful!", "Installation successful!"),
        ("scam_title", "BE SCAM AWARE!"),
        ("scam_text1", "If you are not communicating with an Interactive employee, do not proceed."),
        ("scam_text2", "This may be a scammer trying to steal your money or other private information."),
