...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Due to UAC, BurgerTop can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install BurgerTop to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant BurgerTop \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant BurgerTop \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow BurgerTop to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [BurgerTop Input] service."),
        ...
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next BurgerTop application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant BurgerTop \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant BurgerTop \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running BurgerTop."),
        ...
        ("View Mode", "View mode"),
        ("verify_rustdesk_password_tip", "Verify BurgerTop password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use BurgerTop and start the service, do not proceed and hang up immediately."),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent BurgerTop from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by BurgerTop"),
        ("About RustDesk", "About BurgerTop"),
        ("Keep RustDesk background service", "Keep BurgerTop background service"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if BurgerTop window is open"),
        ...
        ("floating_window_tip", "It helps to keep BurgerTop background service"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, BurgerTop verifies the server certificate for protocols using TLS.\nWith this option enabled, BurgerTop will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, BurgerTop will not use UDP 21116 any more, TCP 21116 will be used instead."),
