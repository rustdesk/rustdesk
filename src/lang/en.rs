...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the TechDesk network..."),
        ...
        ("install_tip", "Due to UAC, TechDesk can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install TechDesk to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant TechDesk \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant TechDesk \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow TechDesk to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [TechDesk Input] service."),
        ...
        ("doc_mac_permission", "https://techdesk.com/docs/en/client/mac/#enable-permissions"),
        ("Ignore Battery Optimizations", "Ignore battery optimizations"),
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next TechDesk application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant TechDesk \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant TechDesk \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running TechDesk."),
        ...
        ("verify_techdesk_password_tip", "Verify TechDesk password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use TechDesk and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_techdesk_server_pro_to_{}_tip", "Please upgrade TechDesk Server Pro to version {} or newer!"),
        ("pull_group_failed_tip", "Failed to refresh group"),
        ("doc_fix_wayland", "https://techdesk.com/docs/en/client/linux/#x11-required"),
        ("display_is_plugged_out_msg", "The display is plugged out, switch to the first display."),
        ("selinux_tip", "SELinux is enabled on your device, which may prevent TechDesk from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by TechDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if TechDesk window is open"),
        ...
        ("upgrade_remote_techdesk_client_to_{}_tip", "Please upgrade the TechDesk client to version {} or newer on the remote side!"),
