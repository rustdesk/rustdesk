...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("View Mode", "View mode"),
        ("verify_rustdesk_password_tip", "Verify KassatkaDesk password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use KassatkaDesk and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Please upgrade KassatkaDesk Server Pro to version {} or newer!"),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent KassatkaDesk from running properly as controlled side."),
        ...
        ("floating_window_tip", "It helps to keep KassatkaDesk background service"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Please upgrade the KassatkaDesk client to version {} or newer on the remote side!"),
