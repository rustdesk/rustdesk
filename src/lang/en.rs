...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("multi-control-notice-borrow-expired", "Your turn with the pointer timed out"),
        ("multi-control-notice-handover", "Another controller is the primary controller now"),
        ("multi-control-notice-layout-changed", "The host changed its display layout, move the pointer once"),
        ("multi-control-notice-no-permission", "The host has not given you input permission"),
        ("multi-control-notice-no-position", "Move the pointer once before this action"),
        ("multi-control-notice-no-primary", "No controller owns the pointer on the host right now"),
        ("multi-control-notice-not-owner", "Only the controller that owns the pointer may send this"),
        ("multi-control-notice-peer-unsupported", "The host does not run this mode, you can only watch"),
        ("multi-control-notice-permission-lost", "The host took your input permission away"),
        ("multi-control-notice-unsupported", "This input is not available while the pointer is shared"),
        ("multi-control-is-primary", "This controller owns the pointer"),
        ("multi-control-operate-key-invalid", "Use a key name such as RControl, a letter, a digit or F1-F24"),
    ].iter().cloned().collect();
}
