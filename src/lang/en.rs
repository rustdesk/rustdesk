...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the Breitenstein IT network..."),
        ...
        ("Slogan_tip", "Definitely not a virus /ᐠ-ꞈ-ᐟ\\"),
        ...
        ("install_tip", "To avoid UAC, please click the button below to install IT-Breitenstein Fernwartung to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant Breitenstein IT \"Accessibility\" permissions."),
        ...
        ("setup_server_tip", "You are connected to IT-Breitenstein Server"),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow Breitenstein IT to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [Breitenstein IT Input] service."),
        ...
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next Breitenstein IT application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant Breitenstein IT \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant Breitenstein IT \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running Breitenstein IT."),
        ...
        ("verify_rustdesk_password_tip", "Verify Breitenstein IT password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use Breitenstein IT and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Please upgrade Breitenstein IT Server Pro to version {} or newer!"),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent Breitenstein IT from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by Breitenstein IT"),
