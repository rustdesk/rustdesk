...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("web-clipboard-unfocus-failed-tip", "Failed to write to the clipboard. The RustDesk web page is not active. To synchronize the clipboard on the controlled side, make the RustDesk web page active again.\nFor images, wait a little longer to ensure the clipboard is written.")
    ].iter().cloned().collect();
}
