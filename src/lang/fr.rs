...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Successful", "Succès"),
        ("Connected, waiting for image...", "Connecté, en attente de transmission..."),
        ("Name", "Nom"),
        ("Type", "Type"),
        ("Modified", "Modifié"),
        ("Size", "Taille"),
        ...
        ("Custom Quality", "Personnaliser la qualité"),
        ("Show remote cursor", "Afficher le curseur distant"),
        ("Show quality monitor", "Afficher les informations débit/qualité"),
        ...
        ("Scale adaptive", "Mise à l'échelle"),
        ("General", "Général"),
        ("Security", "Sécurité"),
        ("Account", "Compte"),
        ("Theme", "Thème"),
