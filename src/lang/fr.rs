...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Width", "Largeur"),
        ("Height", "Hauteur"),
        ("Swap width and height", "Permuter la largeur et la hauteur"),
        ("Current resolution", "Résolution actuelle"),
        ("Reset changes", "Réinitialiser les modifications"),
        ("Select a resolution supported by the display", "Sélectionnez une résolution prise en charge par l’écran"),
        ("Display settings changed. Reopen the resolution menu and try again.", "Les paramètres d’affichage ont changé. Rouvrez le menu de résolution et réessayez."),
        ("Closest supported resolution", "Résolution prise en charge la plus proche"),
        ("Adjusted to display limits", "Ajusté aux limites de l’écran"),
        ("Local resolution is unavailable or unsupported", "La résolution locale est indisponible ou non prise en charge"),
        ("Looks like", "Apparence"),
        ("Rendering quality", "Qualité du rendu"),
        ("Standard", "Standard"),
        ("Enter dimensions within the range", "Saisissez des dimensions comprises dans la plage"),
        ("Aspect ratio", "Rapport largeur/hauteur"),
        ("Available resolutions", "Résolutions disponibles"),
        ("System scaling", "Mise à l’échelle du système"),
        ("Recommended", "Recommandé"),
        ("System scaling is unavailable for this display or desktop environment.", "La mise à l’échelle du système est indisponible pour cet écran ou cet environnement de bureau."),
        ("The system did not apply the requested scale. Refresh and try again.", "Le système n’a pas appliqué l’échelle demandée. Actualisez et réessayez."),
        ("Select a scaling level supported by the display.", "Sélectionnez un niveau de mise à l’échelle pris en charge par l’écran."),
        ("No permission to change display settings.", "Vous n’avez pas l’autorisation de modifier les paramètres d’affichage."),
        ("Invalid display scaling request.", "Demande de mise à l’échelle de l’affichage non valide."),
        ("Display settings are busy. Try again.", "Les paramètres d’affichage sont en cours de traitement. Réessayez."),
        ("Display settings timed out. Refresh and try again.", "Le délai des paramètres d’affichage a expiré. Actualisez et réessayez."),
        ("Use nearest supported scale", "Utiliser l’échelle prise en charge la plus proche"),
        ("Scaling was applied, but the resolution request failed.", "La mise à l’échelle a été appliquée, mais la demande de résolution a échoué."),
        ("Failed to change display settings", "Impossible de modifier les paramètres d’affichage"),
        ("Remote connection has closed", "La connexion distante a été fermée"),
        ("Failed to resize macOS virtual display", "Impossible de redimensionner l’écran virtuel macOS"),
        ("Failed to toggle macOS virtual display", "Impossible d’activer ou de désactiver l’écran virtuel macOS"),
        ("Failed to start macOS virtual display worker", "Impossible de démarrer le processus de gestion des écrans virtuels macOS"),
        ("Virtual display dimensions must be between 320 and 4096", "Les dimensions de l’écran virtuel doivent être comprises entre 320 et 4096"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "L’échelle de l’écran virtuel doit être de 1 ou 2 et diviser exactement les deux dimensions en pixels"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "Les dimensions de l’écran virtuel doivent être comprises entre 1 et 4096 pixels logiques"),
        ("Display configuration response is too large.", "La réponse de configuration de l’affichage est trop volumineuse."),
        ("Invalid display scaling response", "Réponse de mise à l’échelle de l’affichage non valide"),
        ("Invalid display scaling levels", "Niveaux de mise à l’échelle de l’affichage non valides"),
