...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", ""),
        ("Language", ""),
        ("Keep TeamDesk background service", ""),
        ...
        ("upgrade_teamdesk_server_pro_to_{}_tip", ""),
        ...
        ("new-version-of-{}-tip", ""),
        ("Accessible devices", ""),
        ("upgrade_remote_teamdesk_client_to_{}_tip", ""),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
        ...
        ("TeamDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that TeamDesk can use it", ""),
        ...
        ("TeamDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", ""),
        ("TeamDesk could not load a GStreamer component needed for screen capture ({})", ""),
    ].iter().cloned().collect();
}
