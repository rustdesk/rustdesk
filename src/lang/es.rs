...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conexión a la red TechDesk en progreso..."),
        ...
        ("install_tip", "Debido al Control de cuentas de usuario, es posible que TechDesk no funcione correctamente como escritorio remoto. Para evitar este problema, haga clic en el botón de abajo para instalar TechDesk a nivel de sistema."),
        ("Click to upgrade", "Clic para actualizar"),
        ("Click to download", "Clic para descargar"),
        ("Click to update", "Clic para refrescar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar su escritorio desde el exterior, debe otorgar permiso a TechDesk de \"Accesibilidad\"."),
        ("config_screen", "Para controlar su escritorio desde el exterior, debe otorgar permiso a TechDesk de \"Grabación de pantalla\"."),
        ...
        ("android_input_permission_tip1", "Para que un dispositivo remoto controle su dispositivo Android a través del ratón o toque, debe permitir que TechDesk use el servicio de \"Accesibilidad\"."),
        ("android_input_permission_tip2", "Vaya a la página de configuración del sistema que se abrirá a continuación, busque y acceda a [Servicios instalados], active el servicio [TechDesk Input]."),
        ...
        ("Turned off", "Apagado"),
        ("Language", "Idioma"),
        ("Keep TechDesk background service", "Dejar TechDesk como Servicio en 2do plano"),
        ...
        ("Show TechDesk", "Mostrar TechDesk"),
        ("This PC", "Este PC"),
        ("or", "o"),
        ...
        ("config_input", "Para controlar el escritorio remoto con el teclado necesitas dar a TechDesk permisos de \"Monitorización de entrada\"."),
        ("config_microphone", "Para poder hablar de forma remota necesitas darle a TechDesk permisos de \"Grabar Audio\"."),
        ...
        ("verify_techdesk_password_tip", "Verificar la contraseña de TechDesk"),
        ...
        ("scam_text1", "Si estás al teléfono con alguien a quien NO conoces y en quien NO confías y te ha pedido que uses TechDesk e inicies el servicio, no lo hagas y cuelga inmediatamente."),
        ...
        ("upgrade_techdesk_server_pro_to_{}_tip", "¡Por favor, actualiza TechDesk Server Pro a la versión {} o superior"),
        ...
        ("selinux_tip", "SELinux está activado en tu dispositivo, lo que puede hacer que TechDesk no se ejecute correctamente como lado controlado."),
        ...
        ("powered_by_me", "Con tecnología de TechDesk"),
        ...
        ("floating_window_tip", "Ayuda a mantener el servicio de TechDesk de fondo"),
        ...
        ("About TechDesk", "Acerca de TechDesk"),
        ...
        ("upgrade_remote_techdesk_client_to_{}_tip", "Por favor, actualiza el cliente TechDesk a la versión {} o superior en el lado remoto"),
