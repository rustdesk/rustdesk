...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Width", "Anchura"),
        ("Height", "Altura"),
        ("Swap width and height", "Intercambiar anchura y altura"),
        ("Current resolution", "Resolución actual"),
        ("Reset changes", "Restablecer cambios"),
        ("Select a resolution supported by the display", "Seleccione una resolución compatible con la pantalla"),
        ("Display settings changed. Reopen the resolution menu and try again.", "La configuración de pantalla ha cambiado. Vuelva a abrir el menú de resolución e inténtelo de nuevo."),
        ("Closest supported resolution", "Resolución compatible más cercana"),
        ("Adjusted to display limits", "Ajustado a los límites de la pantalla"),
        ("Local resolution is unavailable or unsupported", "La resolución local no está disponible o no es compatible"),
        ("Looks like", "Se ve como"),
        ("Rendering quality", "Calidad de renderizado"),
        ("Standard", "Estándar"),
        ("Enter dimensions within the range", "Introduzca dimensiones dentro del intervalo"),
        ("Aspect ratio", "Relación de aspecto"),
        ("Available resolutions", "Resoluciones disponibles"),
        ("System scaling", "Escala del sistema"),
        ("Recommended", "Recomendado"),
        ("System scaling is unavailable for this display or desktop environment.", "La escala del sistema no está disponible para esta pantalla o entorno de escritorio."),
        ("The system did not apply the requested scale. Refresh and try again.", "El sistema no ha aplicado la escala solicitada. Actualice e inténtelo de nuevo."),
        ("Select a scaling level supported by the display.", "Seleccione un nivel de escala compatible con la pantalla."),
        ("No permission to change display settings.", "No tiene permiso para cambiar la configuración de pantalla."),
        ("Invalid display scaling request.", "Solicitud de escala de pantalla no válida."),
        ("Display settings are busy. Try again.", "La configuración de pantalla está ocupada. Inténtelo de nuevo."),
        ("Display settings timed out. Refresh and try again.", "Se agotó el tiempo de espera de la configuración de pantalla. Actualice e inténtelo de nuevo."),
        ("Use nearest supported scale", "Usar la escala compatible más cercana"),
        ("Scaling was applied, but the resolution request failed.", "Se ha aplicado la escala, pero la solicitud de resolución ha fallado."),
        ("Failed to change display settings", "No se pudo cambiar la configuración de pantalla"),
        ("Remote connection has closed", "La conexión remota se ha cerrado"),
        ("Failed to resize macOS virtual display", "No se pudo cambiar el tamaño de la pantalla virtual de macOS"),
        ("Failed to toggle macOS virtual display", "No se pudo activar o desactivar la pantalla virtual de macOS"),
        ("Failed to start macOS virtual display worker", "No se pudo iniciar el proceso de pantallas virtuales de macOS"),
        ("Virtual display dimensions must be between 320 and 4096", "Las dimensiones de la pantalla virtual deben estar entre 320 y 4096"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "La escala de la pantalla virtual debe ser 1 o 2 y dividir exactamente ambas dimensiones en píxeles"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "Las dimensiones de la pantalla virtual deben estar entre 1 y 4096 píxeles lógicos"),
        ("Display configuration response is too large.", "La respuesta de configuración de pantalla es demasiado grande."),
        ("Invalid display scaling response", "Respuesta de escala de pantalla no válida"),
        ("Invalid display scaling levels", "Niveles de escala de pantalla no válidos"),
