...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Đang kết nối đến mạng lưới TeamDesk..."),
        ...
        ("install_tip", "Do cơ chế UAC, TeamDesk có thể không hoạt động ổn định ở phía người dùng từ xa trong một số trường hợp. Để tránh vấn đề này, vui lòng nhấn nút bên dưới để cài đặt TeamDesk vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Configure", "Cấu hình"),
        ("config_acc", "Để điều khiển từ xa, bạn cần cấp quyền \"Trợ năng\" cho TeamDesk."),
        ("config_screen", "Để truy cập từ xa, bạn cần cấp quyền \"Ghi màn hình\" cho TeamDesk."),
        ...
        ("android_input_permission_tip2", "Vui lòng tìm [Dịch vụ đã cài đặt] trong cài đặt và bật [TeamDesk Input]."),
        ...
        ("Turned off", "Đã tắt"),
        ("Language", "Ngôn ngữ"),
        ("Keep TeamDesk background service", "Giữ dịch vụ TeamDesk chạy nền"),
        ...
        ("verify_teamdesk_password_tip", "Xác thực mật khẩu TeamDesk"),
        ...
        ("scam_text2", "Chỉ sử dụng TeamDesk với những người bạn thực sự tin tưởng."),
        ...
        ("upgrade_teamdesk_server_pro_to_{}_tip", "Nâng cấp lên Pro để có thêm tính năng"),
        ...
        ("allow-only-conn-window-open-tip", "Chỉ cho phép khi cửa sổ TeamDesk mở"),
        ...
        ("floating_window_tip", "Giữ TeamDesk trên cùng"),
        ...
        ("upgrade_remote_teamdesk_client_to_{}_tip", "Vui lòng nâng cấp đối tác lên {}"),
        ...
        ("TeamDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that TeamDesk can use it", "TeamDesk không thể truy cập phiên màn hình nền trên thiết bị từ xa, hãy kiểm tra rằng một phiên đang chạy và TeamDesk có thể dùng nó"),
        ...
        ("TeamDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "TeamDesk không lấy được màn hình dùng được từ XDG Desktop Portal, thư viện PipeWire có thể quá cũ"),
        ("TeamDesk could not load a GStreamer component needed for screen capture ({})", "TeamDesk không thể tải một thành phần GStreamer cần cho việc ghi màn hình ({})"),
    ].iter().cloned().collect();
}
