...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Width", "Chiều rộng"),
        ("Height", "Chiều cao"),
        ("Swap width and height", "Đổi chiều rộng và chiều cao"),
        ("Current resolution", "Độ phân giải hiện tại"),
        ("Reset changes", "Đặt lại thay đổi"),
        ("Select a resolution supported by the display", "Chọn độ phân giải được màn hình hỗ trợ"),
        ("Display settings changed. Reopen the resolution menu and try again.", "Cài đặt hiển thị đã thay đổi. Hãy mở lại trình đơn độ phân giải và thử lại."),
        ("Closest supported resolution", "Độ phân giải được hỗ trợ gần nhất"),
        ("Adjusted to display limits", "Đã điều chỉnh theo giới hạn màn hình"),
        ("Local resolution is unavailable or unsupported", "Độ phân giải cục bộ không khả dụng hoặc không được hỗ trợ"),
        ("Looks like", "Hiển thị như"),
        ("Rendering quality", "Chất lượng kết xuất"),
        ("Standard", "Tiêu chuẩn"),
        ("Enter dimensions within the range", "Nhập kích thước trong phạm vi cho phép"),
        ("Aspect ratio", "Tỷ lệ khung hình"),
        ("Available resolutions", "Độ phân giải khả dụng"),
        ("System scaling", "Tỷ lệ hiển thị hệ thống"),
        ("Recommended", "Đề xuất"),
        ("System scaling is unavailable for this display or desktop environment.", "Tỷ lệ hiển thị hệ thống không khả dụng cho màn hình hoặc môi trường máy tính để bàn này."),
        ("The system did not apply the requested scale. Refresh and try again.", "Hệ thống chưa áp dụng tỷ lệ được yêu cầu. Hãy làm mới và thử lại."),
        ("Select a scaling level supported by the display.", "Chọn mức tỷ lệ hiển thị được màn hình hỗ trợ."),
        ("No permission to change display settings.", "Không có quyền thay đổi cài đặt hiển thị."),
        ("Invalid display scaling request.", "Yêu cầu tỷ lệ hiển thị không hợp lệ."),
        ("Display settings are busy. Try again.", "Cài đặt hiển thị đang bận. Hãy thử lại."),
        ("Display settings timed out. Refresh and try again.", "Yêu cầu cài đặt hiển thị đã hết thời gian chờ. Hãy làm mới và thử lại."),
        ("Use nearest supported scale", "Dùng tỷ lệ được hỗ trợ gần nhất"),
        ("Scaling was applied, but the resolution request failed.", "Đã áp dụng tỷ lệ nhưng yêu cầu độ phân giải thất bại."),
        ("Failed to change display settings", "Không thể thay đổi cài đặt hiển thị"),
        ("Remote connection has closed", "Kết nối từ xa đã đóng"),
        ("Failed to resize macOS virtual display", "Không thể đổi kích thước màn hình ảo macOS"),
        ("Failed to toggle macOS virtual display", "Không thể bật hoặc tắt màn hình ảo macOS"),
        ("Failed to start macOS virtual display worker", "Không thể khởi chạy luồng xử lý màn hình ảo macOS"),
        ("Virtual display dimensions must be between 320 and 4096", "Kích thước màn hình ảo phải nằm trong khoảng từ 320 đến 4096"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "Tỷ lệ màn hình ảo phải là 1 hoặc 2 và cả hai kích thước tính bằng pixel phải chia hết cho tỷ lệ này"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "Kích thước màn hình ảo phải nằm trong khoảng từ 1 đến 4096 pixel logic"),
        ("Display configuration response is too large.", "Phản hồi cấu hình hiển thị quá lớn."),
        ("Invalid display scaling response", "Phản hồi tỷ lệ hiển thị không hợp lệ"),
        ("Invalid display scaling levels", "Các mức tỷ lệ hiển thị không hợp lệ"),
