...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Output resolution", "Irteerako bereizmena"),
        ("Width", "Zabalera"),
        ("Height", "Altuera"),
        ("Swap width and height", "Trukatu zabalera eta altuera"),
        ("Current resolution", "Uneko bereizmena"),
        ("Reset changes", "Berrezarri aldaketak"),
        ("Select a resolution supported by the display", "Hautatu pantailak onartzen duen bereizmen bat"),
        ("Display settings changed. Reopen the resolution menu and try again.", "Pantailaren ezarpenak aldatu dira. Ireki berriro bereizmenaren menua eta saiatu berriro."),
        ("Closest supported resolution", "Onartutako bereizmen hurbilena"),
        ("Adjusted to display limits", "Pantailaren mugetara egokituta"),
        ("Local resolution is unavailable or unsupported", "Bertako bereizmena ez dago erabilgarri edo ez da onartzen"),
        ("Looks like", "Honen itxura du"),
        ("Rendering quality", "Errendatze-kalitatea"),
        ("Standard", "Estandarra"),
        ("Enter dimensions within the range", "Sartu baimendutako barrutiko neurriak"),
        ("Aspect ratio", "Aspektu-erlazioa"),
        ("Available resolutions", "Bereizmen erabilgarriak"),
        ("System scaling", "Sistemaren eskalatzea"),
        ("Recommended", "Gomendatua"),
        ("System scaling is unavailable for this display or desktop environment.", "Sistemaren eskalatzea ez dago erabilgarri pantaila edo mahaigaineko ingurune honetarako."),
        ("The system did not apply the requested scale. Refresh and try again.", "Sistemak ez du eskatutako eskala aplikatu. Freskatu eta saiatu berriro."),
        ("Select a scaling level supported by the display.", "Hautatu pantailak onartzen duen eskalatze-maila bat."),
        ("No permission to change display settings.", "Ez duzu pantailaren ezarpenak aldatzeko baimenik."),
        ("Invalid display scaling request.", "Pantailaren eskalatze-eskaera baliogabea da."),
        ("Display settings are busy. Try again.", "Pantailaren ezarpenak lanpetuta daude. Saiatu berriro."),
        ("Display settings timed out. Refresh and try again.", "Pantailaren ezarpenen itxarote-denbora agortu da. Freskatu eta saiatu berriro."),
        ("Use nearest supported scale", "Erabili onartutako eskalarik hurbilena"),
        ("Scaling was applied, but the resolution request failed.", "Eskala aplikatu da, baina bereizmen-eskaerak huts egin du."),
        ("Failed to change display settings", "Ezin izan dira pantailaren ezarpenak aldatu"),
        ("Remote connection has closed", "Urruneko konexioa itxi da"),
        ("Failed to resize macOS virtual display", "Ezin izan da macOS pantaila birtualaren tamaina aldatu"),
        ("Failed to toggle macOS virtual display", "Ezin izan da macOS pantaila birtuala aktibatu edo desaktibatu"),
        ("Failed to start macOS virtual display worker", "Ezin izan da macOS pantaila birtualen lan-prozesua abiarazi"),
        ("Virtual display dimensions must be between 320 and 4096", "Pantaila birtualaren neurriek 320 eta 4096 artean egon behar dute"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "Pantaila birtualaren eskalak 1 edo 2 izan behar du, eta pixel-neurri biek eskalaz zatigarriak izan behar dute hondarrik gabe"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "Pantaila birtualaren neurriek 1 eta 4096 pixel logiko artean egon behar dute"),
        ("Display configuration response is too large.", "Pantailaren konfigurazioaren erantzuna handiegia da."),
        ("Invalid display scaling response", "Pantailaren eskalatze-erantzun baliogabea"),
        ("Invalid display scaling levels", "Pantailaren eskalatze-maila baliogabeak"),
        ("Invalid display scaling range", "Pantailaren eskalatze-barruti baliogabea"),
        ("Interface size", "Interfazearen tamaina"),
        ("Current interface size", "Interfazearen uneko tamaina"),
    ].iter().cloned().collect();
}
