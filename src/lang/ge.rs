...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Width", "სიგანე"),
        ("Height", "სიმაღლე"),
        ("Swap width and height", "სიგანისა და სიმაღლის გაცვლა"),
        ("Current resolution", "მიმდინარე გარჩევადობა"),
        ("Reset changes", "ცვლილებების განულება"),
        ("Select a resolution supported by the display", "აირჩიეთ ეკრანის მიერ მხარდაჭერილი გარჩევადობა"),
        ("Display settings changed. Reopen the resolution menu and try again.", "ეკრანის პარამეტრები შეიცვალა. ხელახლა გახსენით გარჩევადობის მენიუ და სცადეთ თავიდან."),
        ("Closest supported resolution", "უახლოესი მხარდაჭერილი გარჩევადობა"),
        ("Adjusted to display limits", "მორგებულია ეკრანის შეზღუდვებზე"),
        ("Local resolution is unavailable or unsupported", "ლოკალური გარჩევადობა მიუწვდომელია ან არ არის მხარდაჭერილი"),
        ("Looks like", "გამოიყურება როგორც"),
        ("Rendering quality", "გამოსახვის ხარისხი"),
        ("Standard", "სტანდარტული"),
        ("Enter dimensions within the range", "შეიყვანეთ ზომები დასაშვებ დიაპაზონში"),
        ("Aspect ratio", "გვერდების თანაფარდობა"),
        ("Available resolutions", "ხელმისაწვდომი გარჩევადობები"),
        ("System scaling", "სისტემური მასშტაბირება"),
        ("Recommended", "რეკომენდებული"),
        ("System scaling is unavailable for this display or desktop environment.", "სისტემური მასშტაბირება მიუწვდომელია ამ ეკრანისთვის ან სამუშაო გარემოსთვის."),
        ("The system did not apply the requested scale. Refresh and try again.", "სისტემამ მოთხოვნილი მასშტაბი არ გამოიყენა. განაახლეთ და სცადეთ თავიდან."),
        ("Select a scaling level supported by the display.", "აირჩიეთ ეკრანის მიერ მხარდაჭერილი მასშტაბირების დონე."),
        ("No permission to change display settings.", "ეკრანის პარამეტრების შეცვლის ნებართვა არ გაქვთ."),
        ("Invalid display scaling request.", "ეკრანის მასშტაბირების მოთხოვნა არასწორია."),
        ("Display settings are busy. Try again.", "ეკრანის პარამეტრები დაკავებულია. სცადეთ თავიდან."),
        ("Display settings timed out. Refresh and try again.", "ეკრანის პარამეტრების მოლოდინის დრო ამოიწურა. განაახლეთ და სცადეთ თავიდან."),
        ("Use nearest supported scale", "უახლოესი მხარდაჭერილი მასშტაბის გამოყენება"),
        ("Scaling was applied, but the resolution request failed.", "მასშტაბი გამოყენებულია, მაგრამ გარჩევადობის მოთხოვნა ვერ შესრულდა."),
        ("Failed to change display settings", "ეკრანის პარამეტრების შეცვლა ვერ მოხერხდა"),
        ("Remote connection has closed", "დისტანციური კავშირი დაიხურა"),
        ("Failed to resize macOS virtual display", "macOS-ის ვირტუალური ეკრანის ზომის შეცვლა ვერ მოხერხდა"),
        ("Failed to toggle macOS virtual display", "macOS-ის ვირტუალური ეკრანის ჩართვა ან გამორთვა ვერ მოხერხდა"),
        ("Failed to start macOS virtual display worker", "macOS-ის ვირტუალური ეკრანების სამუშაო პროცესის გაშვება ვერ მოხერხდა"),
        ("Virtual display dimensions must be between 320 and 4096", "ვირტუალური ეკრანის ზომები უნდა იყოს 320-დან 4096-მდე"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "ვირტუალური ეკრანის მასშტაბი უნდა იყოს 1 ან 2 და ორივე პიქსელური ზომა მასზე უნაშთოდ უნდა იყოფოდეს"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "ვირტუალური ეკრანის ზომები უნდა იყოს 1-დან 4096-მდე ლოგიკური პიქსელი"),
        ("Display configuration response is too large.", "ეკრანის კონფიგურაციის პასუხი ზედმეტად დიდია."),
