...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Width", "Gjerësia"),
        ("Height", "Lartësia"),
        ("Swap width and height", "Ndërro gjerësinë dhe lartësinë"),
        ("Current resolution", "Rezolucioni aktual"),
        ("Reset changes", "Rivendos ndryshimet"),
        ("Select a resolution supported by the display", "Zgjidhni një rezolucion që mbështetet nga ekrani"),
        ("Display settings changed. Reopen the resolution menu and try again.", "Cilësimet e ekranit kanë ndryshuar. Rihapni menynë e rezolucionit dhe provoni përsëri."),
        ("Closest supported resolution", "Rezolucioni i mbështetur më i afërt"),
        ("Adjusted to display limits", "Përshtatur me kufijtë e ekranit"),
        ("Local resolution is unavailable or unsupported", "Rezolucioni lokal nuk është i disponueshëm ose nuk mbështetet"),
        ("Looks like", "Duket si"),
        ("Rendering quality", "Cilësia e paraqitjes"),
        ("Standard", "Standarde"),
        ("Enter dimensions within the range", "Vendosni përmasa brenda intervalit"),
        ("Aspect ratio", "Raporti i përmasave"),
        ("Available resolutions", "Rezolucionet e disponueshme"),
        ("System scaling", "Shkallëzimi i sistemit"),
        ("Recommended", "Rekomandohet"),
        ("System scaling is unavailable for this display or desktop environment.", "Shkallëzimi i sistemit nuk është i disponueshëm për këtë ekran ose mjedis desktopi."),
        ("The system did not apply the requested scale. Refresh and try again.", "Sistemi nuk e zbatoi shkallën e kërkuar. Rifreskoni dhe provoni përsëri."),
        ("Select a scaling level supported by the display.", "Zgjidhni një nivel shkallëzimi që mbështetet nga ekrani."),
        ("No permission to change display settings.", "Nuk keni leje për të ndryshuar cilësimet e ekranit."),
        ("Invalid display scaling request.", "Kërkesë e pavlefshme për shkallëzimin e ekranit."),
        ("Display settings are busy. Try again.", "Cilësimet e ekranit janë të zëna. Provoni përsëri."),
        ("Display settings timed out. Refresh and try again.", "Koha e pritjes për cilësimet e ekranit mbaroi. Rifreskoni dhe provoni përsëri."),
        ("Use nearest supported scale", "Përdor shkallën e mbështetur më të afërt"),
        ("Scaling was applied, but the resolution request failed.", "Shkalla u zbatua, por kërkesa për rezolucionin dështoi."),
        ("Failed to change display settings", "Ndryshimi i cilësimeve të ekranit dështoi"),
        ("Remote connection has closed", "Lidhja në distancë është mbyllur"),
        ("Failed to resize macOS virtual display", "Ndryshimi i përmasave të ekranit virtual macOS dështoi"),
        ("Failed to toggle macOS virtual display", "Aktivizimi ose çaktivizimi i ekranit virtual macOS dështoi"),
        ("Failed to start macOS virtual display worker", "Nisja e procesit të punës për ekranet virtuale macOS dështoi"),
        ("Virtual display dimensions must be between 320 and 4096", "Përmasat e ekranit virtual duhet të jenë midis 320 dhe 4096"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "Shkalla e ekranit virtual duhet të jetë 1 ose 2 dhe të pjesëtojë pa mbetje të dyja përmasat në pikselë"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "Përmasat e ekranit virtual duhet të jenë midis 1 dhe 4096 pikselëve logjikë"),
        ("Display configuration response is too large.", "Përgjigjja e konfigurimit të ekranit është shumë e madhe."),
        ("Invalid display scaling response", "Përgjigje e pavlefshme për shkallëzimin e ekranit"),
        ("Invalid display scaling levels", "Nivele të pavlefshme të shkallëzimit të ekranit"),
