...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("swap-left-right-mouse", "Menukar fungsi tombol kiri dan kanan mouse"),
        ("2FA code", "Kode 2FA"),
        ("More", "Lainnya"),
        ("enable-2fa-title", "Aktifkan autentikasi dua faktor"),
        ("enable-2fa-desc", "Silakan atur autentikator Anda sekarang. Anda dapat menggunakan aplikasi autentikator seperti Authy, Microsoft Authenticator, atau Google Authenticator di ponsel atau desktop Anda\n\nPindai kode QR dengan aplikasi Anda dan masukkan kode yang ditampilkan oleh aplikasi untuk mengaktifkan autentikasi dua faktor."),
