...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Output resolution", "Resolusi keluaran"),
        ("Width", "Lebar"),
        ("Height", "Tinggi"),
        ("Swap width and height", "Tukar lebar dan tinggi"),
        ("Current resolution", "Resolusi saat ini"),
        ("Reset changes", "Atur ulang perubahan"),
        ("Select a resolution supported by the display", "Pilih resolusi yang didukung layar"),
        ("Display settings changed. Reopen the resolution menu and try again.", "Pengaturan tampilan telah berubah. Buka kembali menu resolusi dan coba lagi."),
        ("Closest supported resolution", "Resolusi terdekat yang didukung"),
        ("Adjusted to display limits", "Disesuaikan dengan batas layar"),
        ("Local resolution is unavailable or unsupported", "Resolusi lokal tidak tersedia atau tidak didukung"),
        ("Looks like", "Tampak seperti"),
        ("Rendering quality", "Kualitas rendering"),
        ("Standard", "Standar"),
        ("Enter dimensions within the range", "Masukkan dimensi dalam rentang yang diizinkan"),
        ("Aspect ratio", "Rasio aspek"),
        ("Available resolutions", "Resolusi yang tersedia"),
        ("System scaling", "Skala sistem"),
        ("Recommended", "Disarankan"),
        ("System scaling is unavailable for this display or desktop environment.", "Skala sistem tidak tersedia untuk layar atau lingkungan desktop ini."),
        ("The system did not apply the requested scale. Refresh and try again.", "Sistem tidak menerapkan skala yang diminta. Segarkan dan coba lagi."),
        ("Select a scaling level supported by the display.", "Pilih tingkat skala yang didukung layar."),
        ("No permission to change display settings.", "Tidak ada izin untuk mengubah pengaturan tampilan."),
        ("Invalid display scaling request.", "Permintaan skala tampilan tidak valid."),
        ...
        ("Failed to toggle macOS virtual display", "Gagal mengaktifkan atau menonaktifkan layar virtual macOS"),
        ("Failed to start macOS virtual display worker", "Gagal memulai proses pekerja layar virtual macOS"),
        ("Virtual display dimensions must be between 320 and 4096", "Dimensi layar virtual harus antara 320 dan 4096"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "Skala layar virtual harus 1 atau 2 dan kedua dimensi piksel harus habis dibagi skala tersebut"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "Dimensi layar virtual harus antara 1 dan 4096 piksel logis"),
        ("Display configuration response is too large.", "Respons konfigurasi tampilan terlalu besar."),
        ("Invalid display scaling response", "Respons skala tampilan tidak valid"),
        ("Invalid display scaling levels", "Tingkat skala tampilan tidak valid"),
        ("Invalid display scaling range", "Rentang skala tampilan tidak valid"),
        ("Interface size", "Ukuran antarmuka"),
        ("Current interface size", "Ukuran antarmuka saat ini"),
    ].iter().cloned().collect();
}
