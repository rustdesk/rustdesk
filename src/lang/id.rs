...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Menghubungkan ke TeamDesk..."),
        ...
        ("install_tip", "Karena UAC, TeamDesk tidak dapat bekerja dengan baik sebagai sisi remote dalam beberapa kasus. Untuk menghindari UAC, silakan klik tombol di bawah ini untuk menginstal TeamDesk ke sistem."),
        ("Click to upgrade", "Klik untuk upgrade"),
        ("Configure", "Konfigurasi"),
        ("config_acc", "Agar bisa mengontrol Desktopmu dari jarak jauh, Kamu harus memberikan izin \"Aksesibilitas\" untuk TeamDesk."),
        ("config_screen", "Agar bisa mengakses Desktopmu dari jarak jauh, kamu harus memberikan izin \"Perekaman Layar\" untuk TeamDesk."),
        ...
        ("android_input_permission_tip1", "Agar perangkat jarak jauh dapat mengontrol perangkat Android melalui mouse atau sentuhan, Kamu harus memberikan izin/permission kd TeamDesk untuk menggunakan layanan \"Aksesibilitas\"."),
        ("android_input_permission_tip2", "Silakan buka halaman pengaturan sistem berikutnya, temukan dan masuk ke [Layanan Terinstal], aktifkan layanan [Input TeamDesk]."),
        ...
        ("Language", "Bahasa"),
        ("Keep TeamDesk background service", "Pertahankan TeamDesk berjalan pada service background"),
        ...
        ("Show TeamDesk", "Tampilkan TeamDesk"),
        ("This PC", "PC ini"),
        ("or", "atau"),
        ("Elevate", "Elevasi"),
        ...
        ("config_input", "Untuk menggunakan input keyboard remote, anda perlu memberikan izin \"Pemantauan Input\" pada TeamDesk"),
        ("config_microphone", "Untuk berbicara secara remote, anda perlu memberikan izin \"Rekam Audio\" pada TeamDesk"),
        ...
        ("still_click_uac_tip", "Masih memerlukan persetujuan pihak pengguna remote untuk mengklik OK pada jendela UAC TeamDesk yang sedang berjalan"),
        ...
        ("verify_teamdesk_password_tip", "Verifikasi Kata Sandi TeamDesk"),
        ...
        ("scam_text1", "Jika anda sedang berbicara di telepon dengan seseorang yang TIDAK dikenal dan mereka meminta anda untuk menggunakan TeamDesk, jangan lanjutkan dan segera tutup panggilan."),
        ...
        ("upgrade_teamdesk_server_pro_to_{}_tip", "Silahkan perbarui TeamDesk Server Pro ke versi {} atau yang lebih baru!"),
        ...
        ("selinux_tip", "pada perangkat anda, SELinux sedang aktif, yang mana itu dapat mencegah TeamDesk berfungsi dengan baik sebagai sisi yang dikontrol."),
        ...
        ("powered_by_me", "Didukung oleh TeamDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Koneksi hanya diperbolehkan jika jendela TeamDesk sedang terbuka."),
        ...
        ("floating_window_tip", "Untuk menjaga layanan/service TeamDesk agar tetap aktif"),
        ...
        ("About TeamDesk", "Tentang TeamDesk"),
        ...
        ("upgrade_remote_teamdesk_client_to_{}_tip", "Silahkan perbarui aplikasi TeamDesk ke versi {} atau yang lebih baru pada komputer yang akan terhubung!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Secara default, TeamDesk memverifikasi sertifikat server untuk protokol yang menggunakan TLS.\nDengan opsi ini diaktifkan, TeamDesk akan kembali melewati langkah verifikasi dan melanjutkan jika verifikasi gagal."),
        ("Disable UDP", "Nonaktifkan UDP"),
        ("disable-udp-tip", "Mengontrol apakah hanya menggunakan TCP.\nSaat opsi ini diaktifkan, TeamDesk tidak akan menggunakan UDP 21116 lagi, TCP 21116 akan digunakan sebagai gantinya."),
        ("server-oss-not-support-tip", "CATATAN: TeamDesk server OSS tidak menyertakan fitur ini."),
        ...
        ("TeamDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that TeamDesk can use it", "TeamDesk tidak dapat mengakses sesi desktop di perangkat jarak jauh, pastikan sesi desktop berjalan dan dapat digunakan oleh TeamDesk"),
        ...
        ("TeamDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "TeamDesk tidak mendapatkan layar yang dapat digunakan dari XDG Desktop Portal, pustaka PipeWire mungkin terlalu lama"),
        ("TeamDesk could not load a GStreamer component needed for screen capture ({})", "TeamDesk tidak dapat memuat komponen GStreamer yang diperlukan untuk merekam layar ({})"),
    ].iter().cloned().collect();
}
