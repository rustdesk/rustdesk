...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Menghubungkan ke jaringan StarDesk..."),
        ...
        ("install_tip", "Karena UAC, StarDesk tidak dapat bekerja dengan baik sebagai sisi remote dalam beberapa kasus. Untuk menghindari UAC, silakan klik tombol di bawah ini untuk menginstal StarDesk ke sistem."),
        ("Click to upgrade", "Klik untuk upgrade"),
        ("Click to download", "Klik untuk unduh"),
        ("Click to update", "Klik untuk memperbarui"),
        ("Configure", "Konfigurasi"),
        ("config_acc", "Untuk mengontrol Desktop Anda dari jarak jauh, Anda perlu memberikan izin \"Aksesibilitas\" StarDesk."),
        ("config_screen", "Untuk mengakses Desktop Anda dari jarak jauh, Anda perlu memberikan izin \"Perekaman Layar\" StarDesk."),
        ...
        ("android_input_permission_tip1", "Agar perangkat jarak jauh dapat mengontrol perangkat Android Anda melalui mouse atau sentuhan, Anda harus mengizinkan StarDesk untuk menggunakan layanan \"Aksesibilitas\"."),
        ("android_input_permission_tip2", "Silakan buka halaman pengaturan sistem berikutnya, temukan dan masuk ke [Layanan Terinstal], aktifkan layanan [Input StarDesk]."),
        ...
        ("Language", "Bahasa"),
        ("Keep StarDesk background service", "Pertahankan StarDesk berjalan pada service background"),
        ...
        ("Show StarDesk", "Tampilkan StarDesk"),
        ("This PC", "PC ini"),
        ("or", "atau"),
        ...
        ("config_input", "Untuk menggunakan input keyboard remote, anda perlu memberikan izin \"Pemantauan Input\" pada StarDesk"),
        ("config_microphone", "Untuk berbicara secara remote, anda perlu memberikan izin \"Rekam Audio\" pada StarDesk"),
        ...
        ("still_click_uac_tip", "Masih memerlukan persetujuan pihak pengguna remote untuk mengklik OK pada jendela UAC StarDesk yang sedang berjalan"),
        ...
        ("install_cert_tip", "Install sertifikat StarDesk"),
        ("confirm_install_cert_tip", "Ini adalah sertifikat pengujian StarDesk, yang dapat dipercaya. Sertifikat ini akan digunakan untuk menginstal driver StarDesk saat diperlukan"),
        ...
        ("verify_StarDesk_password_tip", "Verifikasi Kata Sandi StarDesk"),
        ...
        ("scam_text1", "Jika anda sedang berbicara di telepon dengan seseorang yang TIDAK dikenal dan mereka meminta anda untuk menggunakan StarDesk, jangan lanjutkan dan segera tutup panggilan."),
        ...
        ("upgrade_StarDesk_server_pro_to_{}_tip", "Silahkan perbarui StarDesk Server Pro ke versi {} atau yang lebih baru!"),
        ...
        ("selinux_tip", "pada perangkat anda, SELinux sedang aktif, yang mana itu dapat mencegah StarDesk berfungsi dengan baik sebagai sisi yang dikontrol."),
