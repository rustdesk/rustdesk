...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Rendering quality", ""),
        ("Standard", ""),
        ("Enter dimensions within the range", ""),
        ("Aspect ratio", ""),
        ...
        ("No permission to change display settings.", ""),
        ("Invalid display scaling request.", ""),
        ("Display settings are busy. Try again.", ""),
        ("Display settings timed out. Refresh and try again.", ""),
        ("Use nearest supported scale", ""),
        ...
        ("Failed to toggle macOS virtual display", ""),
        ("Failed to start macOS virtual display worker", ""),
        ("Virtual display dimensions must be between 320 and 4096", ""),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", ""),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", ""),
        ("Display configuration response is too large.", ""),
        ("Invalid display scaling response", ""),
        ("Invalid display scaling levels", ""),
