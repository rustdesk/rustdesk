...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione alla rete GerarDesk in corso..."),
        ...
        ("install_tip", "A causa del Controllo Account Utente, GerarDesk potrebbe non funzionare correttamente come desktop remoto. Per evitare questo problema, fai click sul tasto qui sotto per installare GerarDesk a livello di sistema."),
        ("Click to upgrade", "Fai click per aggiornare"),
        ("Click to download", "Cliquez per scaricare"),
        ("Click to update", "Fare clic per aggiornare"),
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il tuo desktop dall'esterno, devi fornire a GerarDesk il permesso \"Accessibilità\"."),
        ("config_screen", "Per controllare il tuo desktop dall'esterno, devi fornire a GerarDesk il permesso \"Registrazione schermo\"."),
        ...
        ("android_input_permission_tip1", "Affinché un dispositivo remoto possa controllare il tuo dispositivo Android tramite mouse o tocco, devi consentire a GerarDesk di utilizzare il servizio \"Accessibilità\"."),
        ("android_input_permission_tip2", "Vai alla pagina delle impostazioni di sistema che si aprirà di seguito, trova e accedi a [Servizi installati], attiva il servizio [GerarDesk Input]."),
        ...
        ("Language", "Linguaggio"),
        ("Keep GerarDesk background service", "Mantieni il servizio di GerarDesk in background"),
        ("Ignore Battery Optimizations", "Ignora le ottimizzazioni della batteria"),
        ("android_open_battery_optimizations_tip", "Se si desidera disabilitare questa funzione, andare nelle impostazioni dell'applicazione GerarDesk, aprire la sezione [Batteria] e deselezionare [Senza restrizioni]."),
        ...
        ("Show GerarDesk", "Mostra GerarDesk"),
        ("This PC", "Questo PC"),
        ("or", "O"),
