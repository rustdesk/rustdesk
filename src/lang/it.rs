...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("To start a voice call, enable \"Audio capture\" on the \"Screen share\" page.", "Per avviare una chiamata vocale, attiva 'Cattura audio' nella pagina 'Condivisione schermo'.")
    ].iter().cloned().collect();
}
