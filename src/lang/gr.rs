...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Block user input", "Αποκλεισμός εισόδου χρήστη"), 
        ("Unblock user input", "Κατάργηση αποκλεισμού εισόδου χρήστη"), 
        ...
        ("Show quality monitor", "Εμφάνιση παρακολούθησης ποιότητας"), 
        ...
        ("Failed to make direct connection to remote desktop", "Απέτυχε η απευθείας σύνδεση με απομακρυσμένο σταθμό εργασίας"), 
        ...
        ("Allow hearing sound", "Να επιτρέπεται η ακρόαση"), 
        ...
        ("Enable Recording Session", "Ενεργοποίηση συνεδρίας εγγραφής"), 
