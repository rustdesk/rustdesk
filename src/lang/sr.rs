...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Spajanje na Breitenstein IT mrežu..."),
        ...
        ("install_tip", "Zbog UAC Breitenstein IT ne može raditi pravilno u nekim slučajevima. Da biste prevazišli UAC, kliknite taster ispod da instalirate Breitenstein IT na sistem."),
        ...
        ("config_acc", "Da biste daljinski kontrolisali radnu površinu, Breitenstein IT-u treba da dodelite \"Accessibility\" prava."),
        ("config_screen", "Da biste daljinski pristupili radnoj površini, Breitenstein IT-u treba da dodelite \"Screen Recording\" prava."),
        ...
        ("android_input_permission_tip1", "Da bi daljinski uređaj kontrolisao vaš Android uređaj preko miša ili na dodir, treba da dozvolite Breitenstein IT-u da koristi \"Accessibility\" servis."),
        ("android_input_permission_tip2", "Molimo pređite na sledeću stranicu sistemskih podešavanja, pronađite i unesite [Installed Services], uključite [Breitenstein IT Input] servis."),
        ...
        ("Language", "Jezik"),
        ("Keep Breitenstein IT background service", "Zadrži Breitenstein IT kao pozadinski servis"),
        ("Ignore Battery Optimizations", "Zanemari optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Ako želite da onemogućite ovu funkciju, molimo idite na sledeću stranicu za podešavanje Breitenstein IT aplikacije, pronađite i uđite u [Battery], isključite [Unrestricted]"),
        ("Start on boot", ""),
        ...
        ("Show Breitenstein IT", "Prikazi Breitenstein IT"),
        ("This PC", "Ovaj PC"),
        ("or", "ili"),
