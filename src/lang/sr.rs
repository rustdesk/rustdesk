...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Width", "Širina"),
        ("Height", "Visina"),
        ("Swap width and height", "Zameni širinu i visinu"),
        ("Current resolution", "Trenutna rezolucija"),
        ("Reset changes", "Poništi izmene"),
        ("Select a resolution supported by the display", "Izaberite rezoluciju koju ekran podržava"),
        ("Display settings changed. Reopen the resolution menu and try again.", "Postavke prikaza su promenjene. Ponovo otvorite meni rezolucije i pokušajte ponovo."),
        ("Closest supported resolution", "Najbliža podržana rezolucija"),
        ("Adjusted to display limits", "Prilagođeno ograničenjima ekrana"),
        ("Local resolution is unavailable or unsupported", "Lokalna rezolucija nije dostupna ili nije podržana"),
        ("Looks like", "Izgleda kao"),
        ("Rendering quality", "Kvalitet iscrtavanja"),
        ("Standard", "Standardni"),
        ("Enter dimensions within the range", "Unesite dimenzije u dozvoljenom opsegu"),
        ("Aspect ratio", "Odnos stranica"),
        ("Available resolutions", "Dostupne rezolucije"),
        ("System scaling", "Sistemsko skaliranje"),
        ("Recommended", "Preporučeno"),
        ("System scaling is unavailable for this display or desktop environment.", "Sistemsko skaliranje nije dostupno za ovaj ekran ili okruženje radne površine."),
        ("The system did not apply the requested scale. Refresh and try again.", "Sistem nije primenio traženu razmeru. Osvežite i pokušajte ponovo."),
        ("Select a scaling level supported by the display.", "Izaberite nivo skaliranja koji ekran podržava."),
        ("No permission to change display settings.", "Nemate dozvolu za promenu postavki prikaza."),
        ("Invalid display scaling request.", "Nevažeći zahtev za skaliranje ekrana."),
        ("Display settings are busy. Try again.", "Postavke prikaza su zauzete. Pokušajte ponovo."),
        ("Display settings timed out. Refresh and try again.", "Isteklo je vreme čekanja na postavke prikaza. Osvežite i pokušajte ponovo."),
        ("Use nearest supported scale", "Koristi najbližu podržanu razmeru"),
        ("Scaling was applied, but the resolution request failed.", "Razmera je primenjena, ali zahtev za rezoluciju nije uspeo."),
        ("Failed to change display settings", "Promena postavki prikaza nije uspela"),
        ("Remote connection has closed", "Udaljena veza je zatvorena"),
        ("Failed to resize macOS virtual display", "Promena veličine virtuelnog ekrana macOS nije uspela"),
        ("Failed to toggle macOS virtual display", "Uključivanje ili isključivanje virtuelnog ekrana macOS nije uspelo"),
        ("Failed to start macOS virtual display worker", "Pokretanje radnog procesa za virtuelne ekrane macOS nije uspelo"),
        ("Virtual display dimensions must be between 320 and 4096", "Dimenzije virtuelnog ekrana moraju biti između 320 i 4096"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "Faktor skaliranja virtuelnog ekrana mora biti 1 ili 2 i mora deliti obe dimenzije u pikselima bez ostatka"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "Dimenzije virtuelnog ekrana moraju biti između 1 i 4096 logičkih piksela"),
        ("Display configuration response is too large.", "Odgovor sa konfiguracijom ekrana je prevelik."),
        ("Invalid display scaling response", "Nevažeći odgovor o skaliranju ekrana"),
        ("Invalid display scaling levels", "Nevažeći nivoi skaliranja ekrana"),
