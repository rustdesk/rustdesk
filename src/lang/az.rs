...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Hazır"),
        ("Established", "Quruldu"),
        ("connecting_status", "TeamDesk şəbəkəsinə qoşulur..."),
        ...
        ("install_tip", "UAC səbəbindən TeamDesk bəzi hallarda uzaq tərəf kimi düzgün işləyə bilmir. UAC-dan yayınmaq üçün aşağıdakı düyməyə basaraq TeamDesk-i sistemə quraşdırın."),
        ("Click to upgrade", "Yeniləmək üçün klikləyin"),
        ("Configure", "Konfiqurasiya et"),
        ("config_acc", "Masaüstünüzü uzaqdan idarə etmək üçün TeamDesk-ə \"Əlçatanlıq\" icazələrini verməlisiniz."),
        ("config_screen", "Masaüstünüzə uzaqdan giriş üçün TeamDesk-ə \"Ekran Yazısı\" icazələrini verməlisiniz."),
        ...
        ("android_input_permission_tip1", "Uzaq cihazın siçan və ya toxunuşla Android cihazınızı idarə etməsi üçün TeamDesk-ə \"Əlçatanlıq\" xidmətindən istifadə icazəsi verməlisiniz."),
        ("android_input_permission_tip2", "Növbəti sistem parametrləri səhifəsinə keçin, [Quraşdırılmış xidmətlər] bölməsini tapıb açın və [TeamDesk Input] xidmətini işə salın."),
        ...
        ("Language", "Dil"),
        ("Keep TeamDesk background service", "TeamDesk fon xidmətini işlək saxla"),
        ("Ignore Battery Optimizations", "Batareya optimallaşdırmalarını nəzərə alma"),
        ("android_open_battery_optimizations_tip", "Bu funksiyanı söndürmək istəyirsinizsə, növbəti TeamDesk tətbiq parametrləri səhifəsinə keçin, [Batareya] bölməsini tapıb açın və [Məhdudiyyətsiz] seçimini götürün"),
        ...
        ("Show TeamDesk", "TeamDesk-i göstər"),
        ("This PC", "Bu kompüter"),
        ("or", "və ya"),
        ...
        ("config_input", "Uzaq masaüstünü klaviatura ilə idarə etmək üçün TeamDesk-ə \"Giriş Monitorinqi\" icazələrini verməlisiniz."),
        ("config_microphone", "Uzaqdan danışmaq üçün TeamDesk-ə \"Audio Yazısı\" icazələrini verməlisiniz."),
        ...
        ("still_click_uac_tip", "Yenə də uzaq istifadəçinin işləyən TeamDesk-in UAC pəncərəsində OK düyməsini basması tələb olunur."),
        ...
        ("verify_teamdesk_password_tip", "TeamDesk parolunu doğrula"),
        ...
        ("scam_text1", "Tanımadığınız və ETİBAR ETMƏDİYİNİZ biri telefonda sizdən TeamDesk işlətməyi və xidməti başlatmağı xahiş edirsə, davam etməyin və dərhal telefonu bağlayın."),
        ...
        ("upgrade_teamdesk_server_pro_to_{}_tip", "TeamDesk Server Pro-nu {} və ya daha yeni versiyaya yüksəldin!"),
        ...
        ("selinux_tip", "Cihazınızda SELinux aktivdir, bu, TeamDesk-in idarə olunan tərəf kimi düzgün işləməsinə mane ola bilər."),
        ...
        ("powered_by_me", "TeamDesk ilə işləyir"),
        ...
        ("allow-only-conn-window-open-tip", "Əlaqəyə yalnız TeamDesk pəncərəsi açıq olduqda icazə ver"),
        ...
        ("floating_window_tip", "TeamDesk fon xidmətini işlək saxlamağa kömək edir"),
        ...
        ("About TeamDesk", "TeamDesk haqqında"),
        ...
        ("upgrade_remote_teamdesk_client_to_{}_tip", "Uzaq tərəfdə TeamDesk klientini {} və ya daha yeni versiyaya yüksəldin!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Standart olaraq TeamDesk TLS işlədən protokollar üçün server sertifikatını yoxlayır.\nBu seçim aktiv olduqda, yoxlama alınmadığı halda TeamDesk yoxlama addımını keçib davam edəcək."),
        ("Disable UDP", "UDP-ni söndür"),
        ("disable-udp-tip", "Yalnız TCP işlədilib işlədilməyəcəyini idarə edir.\nBu seçim aktiv olduqda TeamDesk artıq UDP 21116 işlətməyəcək, əvəzində TCP 21116 işlədiləcək."),
        ("server-oss-not-support-tip", "QEYD: TeamDesk server OSS bu funksiyanı əhatə etmir."),
