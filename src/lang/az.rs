...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Width", "En"),
        ("Height", "Hündürlük"),
        ("Swap width and height", "Eni və hündürlüyü dəyişdir"),
        ("Current resolution", "Cari ayırdetmə"),
        ("Reset changes", "Dəyişiklikləri sıfırla"),
        ("Select a resolution supported by the display", "Ekranın dəstəklədiyi ayırdetməni seçin"),
        ("Display settings changed. Reopen the resolution menu and try again.", "Ekran parametrləri dəyişib. Ayırdetmə menyusunu yenidən açın və təkrar cəhd edin."),
        ("Closest supported resolution", "Dəstəklənən ən yaxın ayırdetmə"),
        ("Adjusted to display limits", "Ekranın məhdudiyyətlərinə uyğunlaşdırılıb"),
        ("Local resolution is unavailable or unsupported", "Yerli ayırdetmə əlçatan deyil və ya dəstəklənmir"),
        ("Looks like", "Belə görünür"),
        ("Rendering quality", "Görüntüləmə keyfiyyəti"),
        ("Standard", "Standart"),
        ("Enter dimensions within the range", "İcazə verilən aralıqda ölçülər daxil edin"),
        ("Aspect ratio", "Tərəflər nisbəti"),
        ("Available resolutions", "Mövcud ayırdetmələr"),
        ("System scaling", "Sistem miqyaslaması"),
        ("Recommended", "Tövsiyə olunur"),
        ("System scaling is unavailable for this display or desktop environment.", "Bu ekran və ya iş masası mühiti üçün sistem miqyaslaması əlçatan deyil."),
        ("The system did not apply the requested scale. Refresh and try again.", "Sistem tələb olunan miqyası tətbiq etmədi. Yeniləyin və təkrar cəhd edin."),
        ("Select a scaling level supported by the display.", "Ekranın dəstəklədiyi miqyaslama səviyyəsini seçin."),
        ("No permission to change display settings.", "Ekran parametrlərini dəyişdirməyə icazə yoxdur."),
        ("Invalid display scaling request.", "Yanlış ekran miqyaslama sorğusu."),
        ...
        ("Failed to toggle macOS virtual display", "macOS virtual ekranını aktivləşdirmək və ya söndürmək alınmadı"),
        ("Failed to start macOS virtual display worker", "macOS virtual ekranlarının işçi prosesini başlatmaq alınmadı"),
        ("Virtual display dimensions must be between 320 and 4096", "Virtual ekranın ölçüləri 320 ilə 4096 arasında olmalıdır"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "Virtual ekranın miqyası 1 və ya 2 olmalı və hər iki piksel ölçüsünü qalıqsız bölməlidir"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "Virtual ekranın ölçüləri 1 ilə 4096 məntiqi piksel arasında olmalıdır"),
        ("Display configuration response is too large.", "Ekran konfiqurasiyasının cavabı çox böyükdür."),
        ("Invalid display scaling response", "Yanlış ekran miqyaslama cavabı"),
        ("Invalid display scaling levels", "Yanlış ekran miqyaslama səviyyələri"),
