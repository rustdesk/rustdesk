...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("To start a voice call, enable \"Audio capture\" on the \"Screen share\" page.", "Чтобы начать голосовой вызов, включите \"Захват аудио\" на странице настроек \"Демонстрация экрана\"."),
        ("Enable USB forwarding", "Включить проброс USB"),
        ("USB forwarding", "Проброс USB"),
        ("Loading...", "Загрузка..."),
        ("No USB devices", "Нет USB-устройств"),
        ("Share", "Открыть доступ"),
        ("Unshare", "Закрыть доступ"),
        ("Attach", "Подключить"),
        ("Detach", "Отключить"),
        ("My local devices", "Мои локальные устройства"),
        ("Peer's devices", "Устройства собеседника"),
        ("Push", "Отправить"),
        ("Unpush", "Отменить отправку")
    ].iter().cloned().collect();
}
