...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Width", "Ширина"),
        ("Height", "Высота"),
        ("Swap width and height", "Поменять ширину и высоту"),
        ("Current resolution", "Текущее разрешение"),
        ("Reset changes", "Сбросить изменения"),
        ("Select a resolution supported by the display", "Выберите разрешение, поддерживаемое дисплеем"),
        ("Display settings changed. Reopen the resolution menu and try again.", "Настройки дисплея изменились. Откройте меню разрешения заново и повторите попытку."),
        ("Closest supported resolution", "Ближайшее поддерживаемое разрешение"),
        ("Adjusted to display limits", "Подогнано под ограничения дисплея"),
        ("Local resolution is unavailable or unsupported", "Локальное разрешение недоступно или не поддерживается"),
        ("Looks like", "Выглядит как"),
        ("Rendering quality", "Качество отрисовки"),
        ("Standard", "Стандартное"),
        ("Enter dimensions within the range", "Введите размеры в допустимом диапазоне"),
        ("Aspect ratio", "Соотношение сторон"),
        ("Available resolutions", "Доступные разрешения"),
        ("System scaling", "Системный масштаб"),
        ("Recommended", "Рекомендуется"),
        ("System scaling is unavailable for this display or desktop environment.", "Системное масштабирование недоступно для этого дисплея или окружения рабочего стола."),
        ("The system did not apply the requested scale. Refresh and try again.", "Система не применила запрошенный масштаб. Обновите данные и повторите попытку."),
        ("Select a scaling level supported by the display.", "Выберите уровень масштабирования, поддерживаемый дисплеем."),
        ("No permission to change display settings.", "Нет разрешения на изменение настроек дисплея."),
        ("Invalid display scaling request.", "Недопустимый запрос масштабирования дисплея."),
        ("Display settings are busy. Try again.", "Настройки дисплея заняты. Повторите попытку."),
        ("Display settings timed out. Refresh and try again.", "Время ожидания настроек дисплея истекло. Обновите данные и повторите попытку."),
        ("Use nearest supported scale", "Использовать ближайший поддерживаемый масштаб"),
        ("Scaling was applied, but the resolution request failed.", "Масштаб применён, но запрос изменения разрешения завершился ошибкой."),
        ("Failed to change display settings", "Не удалось изменить настройки дисплея"),
        ("Remote connection has closed", "Удалённое соединение закрыто"),
        ("Failed to resize macOS virtual display", "Не удалось изменить размер виртуального дисплея macOS"),
        ("Failed to toggle macOS virtual display", "Не удалось включить или отключить виртуальный дисплей macOS"),
        ("Failed to start macOS virtual display worker", "Не удалось запустить рабочий процесс виртуальных дисплеев macOS"),
        ("Virtual display dimensions must be between 320 and 4096", "Размеры виртуального дисплея должны быть в диапазоне от 320 до 4096"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "Масштаб виртуального дисплея должен быть равен 1 или 2, а оба размера в пикселях должны делиться на него без остатка"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "Размеры виртуального дисплея должны быть в диапазоне от 1 до 4096 логических пикселей"),
        ("Display configuration response is too large.", "Ответ с конфигурацией дисплея слишком большой."),
