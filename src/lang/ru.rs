...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("drm_capture_tip", "Доступен прямой захват DRM/KMS — согласие через портал не требуется. Поддерживается доступ без присутствия пользователя и захват экрана входа в систему."),
