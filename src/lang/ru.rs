...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("enable-bot-tip", "Если функция включена, можно получить код двухфакторной аутентификации от бота. Он также может выполнять функцию уведомления о подключении."),
