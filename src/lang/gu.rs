...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Output resolution", "આઉટપુટ રિઝોલ્યુશન"),
        ("Width", "પહોળાઈ"),
        ("Height", "ઊંચાઈ"),
        ("Swap width and height", "પહોળાઈ અને ઊંચાઈ બદલો"),
        ("Current resolution", "વર્તમાન રિઝોલ્યુશન"),
        ("Reset changes", "ફેરફારો રીસેટ કરો"),
        ("Select a resolution supported by the display", "ડિસ્પ્લે દ્વારા સમર્થિત રિઝોલ્યુશન પસંદ કરો"),
        ("Display settings changed. Reopen the resolution menu and try again.", "ડિસ્પ્લે સેટિંગ્સ બદલાઈ ગઈ છે. રિઝોલ્યુશન મેનુ ફરી ખોલો અને ફરી પ્રયાસ કરો."),
        ("Closest supported resolution", "સૌથી નજીકનું સમર્થિત રિઝોલ્યુશન"),
        ("Adjusted to display limits", "ડિસ્પ્લેની મર્યાદાઓ મુજબ ગોઠવ્યું"),
        ("Local resolution is unavailable or unsupported", "સ્થાનિક રિઝોલ્યુશન ઉપલબ્ધ નથી અથવા સમર્થિત નથી"),
        ("Looks like", "આવું દેખાય છે"),
        ("Rendering quality", "રેન્ડરિંગ ગુણવત્તા"),
        ("Standard", "પ્રમાણભૂત"),
        ("Enter dimensions within the range", "માન્ય મર્યાદામાં પરિમાણો દાખલ કરો"),
        ("Aspect ratio", "પહોળાઈ-ઊંચાઈનો ગુણોત્તર"),
        ("Available resolutions", "ઉપલબ્ધ રિઝોલ્યુશન"),
        ("System scaling", "સિસ્ટમ સ્કેલિંગ"),
        ("Recommended", "ભલામણ કરેલ"),
        ("System scaling is unavailable for this display or desktop environment.", "આ ડિસ્પ્લે અથવા ડેસ્કટોપ વાતાવરણ માટે સિસ્ટમ સ્કેલિંગ ઉપલબ્ધ નથી."),
        ("The system did not apply the requested scale. Refresh and try again.", "સિસ્ટમે વિનંતી કરેલ સ્કેલ લાગુ કર્યો નથી. રીફ્રેશ કરો અને ફરી પ્રયાસ કરો."),
        ("Select a scaling level supported by the display.", "ડિસ્પ્લે દ્વારા સમર્થિત સ્કેલિંગ સ્તર પસંદ કરો."),
        ("No permission to change display settings.", "ડિસ્પ્લે સેટિંગ્સ બદલવાની પરવાનગી નથી."),
        ("Invalid display scaling request.", "ડિસ્પ્લે સ્કેલિંગની વિનંતી અમાન્ય છે."),
        ("Display settings are busy. Try again.", "ડિસ્પ્લે સેટિંગ્સ વ્યસ્ત છે. ફરી પ્રયાસ કરો."),
        ("Display settings timed out. Refresh and try again.", "ડિસ્પ્લે સેટિંગ્સનો સમય સમાપ્ત થયો. રીફ્રેશ કરો અને ફરી પ્રયાસ કરો."),
        ("Use nearest supported scale", "સૌથી નજીકનો સમર્થિત સ્કેલ વાપરો"),
        ("Scaling was applied, but the resolution request failed.", "સ્કેલ લાગુ થયો, પરંતુ રિઝોલ્યુશનની વિનંતી નિષ્ફળ ગઈ."),
        ("Failed to change display settings", "ડિસ્પ્લે સેટિંગ્સ બદલી શકાઈ નથી"),
        ("Remote connection has closed", "રિમોટ કનેક્શન બંધ થઈ ગયું છે"),
        ("Failed to resize macOS virtual display", "macOS વર્ચ્યુઅલ ડિસ્પ્લેનું કદ બદલી શકાયું નથી"),
        ("Failed to toggle macOS virtual display", "macOS વર્ચ્યુઅલ ડિસ્પ્લે ચાલુ અથવા બંધ કરી શકાયું નથી"),
        ("Failed to start macOS virtual display worker", "macOS વર્ચ્યુઅલ ડિસ્પ્લેનો કાર્ય થ્રેડ શરૂ કરી શકાયો નથી"),
        ("Virtual display dimensions must be between 320 and 4096", "વર્ચ્યુઅલ ડિસ્પ્લેનાં પરિમાણો 320 થી 4096 વચ્ચે હોવાં જોઈએ"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "વર્ચ્યુઅલ ડિસ્પ્લેનો સ્કેલ 1 અથવા 2 હોવો જોઈએ અને બંને પિક્સેલ પરિમાણો તેનાથી નિઃશેષ ભાગી શકાય તેવાં હોવાં જોઈએ"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "વર્ચ્યુઅલ ડિસ્પ્લેનાં પરિમાણો 1 થી 4096 તાર્કિક પિક્સેલ વચ્ચે હોવાં જોઈએ"),
        ("Display configuration response is too large.", "ડિસ્પ્લે ગોઠવણીનો પ્રતિસાદ ખૂબ મોટો છે."),
        ("Invalid display scaling response", "ડિસ્પ્લે સ્કેલિંગનો પ્રતિસાદ અમાન્ય છે"),
        ("Invalid display scaling levels", "ડિસ્પ્લે સ્કેલિંગનાં સ્તરો અમાન્ય છે"),
