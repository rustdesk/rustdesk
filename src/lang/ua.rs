...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Підключення до мережі StarDesk..."),
        ...
        ("install_tip", "Через UAC в деяких випадках StarDesk може працювати некоректно на віддаленому вузлі. Щоб уникнути UAC, натисніть кнопку нижче для встановлення StarDesk в системі"),
        ...
        ("config_acc", "Для віддаленого керування вашою стільницею, вам необхідно надати StarDesk дозволи \"Доступності\""),
        ("config_screen", "Для віддаленого доступу до вашої стільниці,вам необхідно надати StarDesk дозволи на \"Запис екрану\""),
        ...
        ("android_input_permission_tip1", "Для того, щоб віддалений пристрій міг керувати вашим Android-пристроєм за допомогою миші або торкання, вам необхідно дозволити StarDesk використовувати службу \"Спеціальні можливості\"."),
        ("android_input_permission_tip2", "Перейдіть на наступну сторінку системних налаштувань, знайдіть та увійдіть у [Встановлені служби], увімкніть службу [StarDesk Input]."),
        ...
        ("Language", "Мова"),
        ("Keep StarDesk background service", "Зберегти фонову службу StarDesk"),
        ...
        ("Show StarDesk", "Показати StarDesk"),
        ("This PC", "Цей ПК"),
        ("or", "чи"),
        ...
        ("config_input", "Для віддаленого керування віддаленою стільницею з клавіатури, вам необхідно надати StarDesk дозволи на \"Відстеження введення\""),
        ("config_microphone", "Для можливості віддаленої розмови, вам необхідно надати StarDesk дозвіл на \"Запис аудіо\""),
        ...
        ("install_cert_tip", "Додати сертифікат StarDesk"),
        ("confirm_install_cert_tip", "Це сертифікат тестування StarDesk, якому можна довіряти. За потреби сертифікат буде використано для погодження та встановлення драйверів StarDesk."),
        ...
        ("scam_text1", "Якщо ви розмовляєте по телефону з кимось, кого НЕ ЗНАЄТЕ чи кому НЕ ДОВІРЯЄТЕ, і ця особа хоче, щоб ви використали StarDesk та запустили службу, не робіть цього та негайно завершіть дзвінок."),
        ...
        ("upgrade_StarDesk_server_pro_to_{}_tip", "Будь ласка, оновіть StarDesk Server Pro до версії {} чи більш актуальної!"),
        ...
        ("selinux_tip", "SELinux увімкнено на вашому пристрої, що може ускладнити для іншої сторони віддалене керування за допомогою StarDesk."),
