...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Підключення до мережі GerarDesk..."),
        ...
        ("install_tip", "У деяких випадках через UAC GerarDesk може працювати некоректно на віддаленому вузлі. Щоб уникнути UAC, натисніть кнопку нижче, щоб встановити GerarDesk у системі"),
        ...
        ("config_acc", "Щоб віддалено керувати своїм робочим столом, ви повинні надати GerarDesk права \"доступу\""),
        ("config_screen", "Для віддаленого доступу до робочого столу ви повинні надати GerarDesk права \"знімок екрану\""),
        ...
        ("android_input_permission_tip1", "Щоб віддалений пристрій міг керувати вашим Android-пристроєм за допомогою миші або торкання, вам необхідно дозволити GerarDesk використовувати службу \"Спеціальні можливості\"."),
        ("android_input_permission_tip2", "Перейдіть на наступну сторінку системних налаштувань, знайдіть і увійдіть у [Встановлені служби], увімкніть службу [GerarDesk Input]."),
        ...
        ("Language", "Мова"),
        ("Keep GerarDesk background service", "Зберегти фонову службу GerarDesk"),
