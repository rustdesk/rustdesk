...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Click to upgrade", "Noklikšķiniet, lai jauninātu"),
        ("Click to download", "Noklikšķiniet, lai lejupielādētu"),
        ("Click to update", "Noklikšķiniet, lai atjauninātu"),
        ...
        ("Your installation is lower version.", "Jūsu instalācijai ir veca versija."),
