...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Width", "Platums"),
        ("Height", "Augstums"),
        ("Swap width and height", "Samainīt platumu un augstumu"),
        ("Current resolution", "Pašreizējā izšķirtspēja"),
        ("Reset changes", "Atiestatīt izmaiņas"),
        ("Select a resolution supported by the display", "Atlasiet displeja atbalstītu izšķirtspēju"),
        ("Display settings changed. Reopen the resolution menu and try again.", "Displeja iestatījumi ir mainījušies. Atveriet izšķirtspējas izvēlni vēlreiz un mēģiniet no jauna."),
        ("Closest supported resolution", "Tuvākā atbalstītā izšķirtspēja"),
        ("Adjusted to display limits", "Pielāgots displeja ierobežojumiem"),
        ("Local resolution is unavailable or unsupported", "Lokālā izšķirtspēja nav pieejama vai netiek atbalstīta"),
        ("Looks like", "Izskatās kā"),
        ("Rendering quality", "Renderēšanas kvalitāte"),
        ("Standard", "Standarta"),
        ("Enter dimensions within the range", "Ievadiet izmērus atļautajā diapazonā"),
        ("Aspect ratio", "Malu attiecība"),
        ("Available resolutions", "Pieejamās izšķirtspējas"),
        ("System scaling", "Sistēmas mērogošana"),
        ("Recommended", "Ieteicams"),
        ("System scaling is unavailable for this display or desktop environment.", "Sistēmas mērogošana šim displejam vai darbvirsmas videi nav pieejama."),
        ("The system did not apply the requested scale. Refresh and try again.", "Sistēma nepiemēroja pieprasīto mērogu. Atsvaidziniet un mēģiniet vēlreiz."),
        ("Select a scaling level supported by the display.", "Atlasiet displeja atbalstītu mērogošanas līmeni."),
        ("No permission to change display settings.", "Nav atļaujas mainīt displeja iestatījumus."),
        ("Invalid display scaling request.", "Nederīgs displeja mērogošanas pieprasījums."),
        ...
        ("Failed to toggle macOS virtual display", "Neizdevās ieslēgt vai izslēgt macOS virtuālo displeju"),
        ("Failed to start macOS virtual display worker", "Neizdevās sākt macOS virtuālo displeju darba procesu"),
        ("Virtual display dimensions must be between 320 and 4096", "Virtuālā displeja izmēriem jābūt no 320 līdz 4096"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "Virtuālā displeja mērogam jābūt 1 vai 2, un abiem izmēriem pikseļos jādalās ar to bez atlikuma"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "Virtuālā displeja izmēriem jābūt no 1 līdz 4096 loģiskajiem pikseļiem"),
        ("Display configuration response is too large.", "Displeja konfigurācijas atbilde ir pārāk liela."),
        ("Invalid display scaling response", "Nederīga displeja mērogošanas atbilde"),
        ("Invalid display scaling levels", "Nederīgi displeja mērogošanas līmeņi"),
