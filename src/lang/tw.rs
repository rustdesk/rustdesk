...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Direct", "直連"),
        ("Relay", "中繼"),
        ("No saved device matches. Enter an ID above.", "沒有符合的已儲存裝置，請在上方輸入 ID。"),
        ("The RustDesk session is not end-to-end encrypted.", "RustDesk 工作階段未啟用端對端加密。"),
        ("Legacy forwarding is active. TCP payload leaves the RustDesk encrypted session after login.", "目前使用舊版轉送模式。登入完成後，TCP 資料將離開 RustDesk 加密工作階段。"),
        ("Unable to open", "無法開啟"),
        ("No port forwards configured", "尚未設定連接埠轉送"),
        ("Start Tunnel", "啟動隧道"),
        ("Stop Tunnel", "停止隧道"),
        ("Open in Browser", "在瀏覽器中開啟"),
        ("Copy Local URL", "複製本機網址"),
        ("Local URL copied", "已複製本機網址"),
        ...
        ("Legacy", "舊版"),
        ("Port mappings", "連接埠映射"),
        ("Range: 1024-65535", "範圍：1024-65535"),
        ("Range: 1-65535", "範圍：1-65535"),
        ("Local port must be between 1024 and 65535.", "本機連接埠必須介於 1024 到 65535 之間。"),
        ("Remote port must be between 1 and 65535.", "遠端連接埠必須介於 1 到 65535 之間。"),
        ("Remote host is required.", "遠端主機不能為空。"),
        ("Local port is already configured", "本機連接埠已設定"),
        ("Save", "儲存"),
        ("RustDesk ID is required.", "請輸入 RustDesk ID。"),
        ("Add at least one port forward.", "請至少新增一個連接埠轉送。"),
        ("Tunnel started", "隧道已啟動"),
        ("Failed to start tunnel", "啟動隧道失敗"),
