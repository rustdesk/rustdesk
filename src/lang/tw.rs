...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Printer", "印表機"),
        ("printer-os-requirement-tip", "使用印表機需要相容的作業系統版本。"),
        ("printer-requires-installed-{}-client-tip", "使用印表機需要安裝 {} 客戶端。"),
        ("printer-{}-not-installed-tip", "尚未安裝 {} 印表機。"),
        ("printer-{}-ready-tip", "{} 印表機已準備就緒。"),
        ("Install {} Printer", "安裝 {} 印表機"),
        ("Outgoing Print Jobs", "外發列印工作"),
        ("Incomming Print Jobs", "內送列印工作"),
        ("Incoming Print Job", "內送列印任務"),
        ("use-the-default-printer-tip", "使用預設印表機。"),
        ("use-the-selected-printer-tip", "使用選定的印表機。"),
        ("auto-print-tip", "自動列印接收到的任務。"),
        ("print-incoming-job-confirm-tip", "確認列印內送任務。"),
        ("remote-printing-disallowed-tile-tip", "不允許遠端列印。"),
        ("remote-printing-disallowed-text-tip", "管理員已禁止遠端列印功能。"),
