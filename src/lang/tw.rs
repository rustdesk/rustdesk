...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Current resolution", "目前解析度"),
        ("Reset changes", "重設變更"),
        ("Select a resolution supported by the display", "請選擇此螢幕支援的解析度"),
        ("Display settings changed. Reopen the resolution menu and try again.", "顯示設定已變更。請重新開啟解析度選單後再試。"),
        ("Closest supported resolution", "最接近的支援解析度"),
        ("Adjusted to display limits", "已依螢幕限制調整"),
        ("Local resolution is unavailable or unsupported", "無法取得本機解析度，或沒有支援的模式"),
        ("Looks like", "看起來像"),
        ("Rendering quality", "繪製品質"),
        ("Standard", "標準"),
        ("Enter dimensions within the range", "請輸入範圍內的寬度與高度"),
        ("Aspect ratio", "長寬比"),
        ("Available resolutions", "可用解析度"),
        ("System scaling", "系統縮放"),
        ("Recommended", "建議"),
        ("System scaling is unavailable for this display or desktop environment.", "此螢幕或桌面環境不支援系統縮放。"),
        ("The system did not apply the requested scale. Refresh and try again.", "系統未套用要求的縮放比例。請重新整理後再試。"),
        ("Select a scaling level supported by the display.", "請選擇此螢幕支援的縮放比例。"),
        ("No permission to change display settings.", "沒有變更顯示設定的權限。"),
        ("Invalid display scaling request.", "顯示縮放要求無效。"),
        ("Display settings are busy. Try again.", "正在處理顯示設定。請稍後再試。"),
        ("Display settings timed out. Refresh and try again.", "顯示設定要求逾時。請重新整理後再試。"),
        ("Use nearest supported scale", "使用最接近的支援縮放值"),
        ("Scaling was applied, but the resolution request failed.", "已套用縮放，但解析度要求失敗。"),
        ("Failed to change display settings", "無法變更顯示設定"),
        ("Remote connection has closed", "遠端連線已關閉"),
        ("Failed to resize macOS virtual display", "無法調整 macOS 虛擬螢幕的大小"),
        ("Failed to toggle macOS virtual display", "無法啟用或停用 macOS 虛擬螢幕"),
        ("Failed to start macOS virtual display worker", "無法啟動 macOS 虛擬螢幕工作執行緒"),
        ("Virtual display dimensions must be between 320 and 4096", "虛擬螢幕的寬度與高度必須介於 320 和 4096 之間"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "虛擬螢幕縮放倍率必須為 1 或 2，且像素寬度與高度都必須能被此倍率整除"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "虛擬螢幕的寬度與高度必須介於 1 和 4096 個邏輯像素之間"),
        ("Display configuration response is too large.", "顯示設定回應過大。"),
        ("Invalid display scaling response", "顯示縮放回應無效"),
        ("Invalid display scaling levels", "顯示縮放等級無效"),
