...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("another_user_login_text_tip", "another_user_login_text_tip"),
        ...
        ("input_source_1_tip", "input_source_1_tip"),
        ("input_source_2_tip", "input_source_2_tip"),
        ...
        ("one-way-file-transfer-tip", "one-way-file-transfer-tip"),
        ("Authentication Required", "توثیق کی ضرورت ہے"),
        ("Authenticate", "توثیق کریں"),
        ("web_id_input_tip", "web_id_input_tip"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "upgrade_remote_rustdesk_client_to_{}_tip"),
        ("d3d_render_tip", "d3d_render_tip"),
        ("Use D3D rendering", "D3D رینڈرنگ کا استعمال کریں"),
        ("Printer", "پرنٹر"),
        ("printer-os-requirement-tip", "printer-os-requirement-tip"),
        ("printer-requires-installed-{}-client-tip", "printer-requires-installed-{}-client-tip"),
        ("printer-{}-not-installed-tip", "printer-{}-not-installed-tip"),
        ...
        ("auto-print-tip", "auto-print-tip"),
        ("print-incoming-job-confirm-tip", "print-incoming-job-confirm-tip"),
        ("remote-printing-disallowed-tile-tip", "remote-printing-disallowed-tile-tip"),
        ...
        ("terminal-admin-login-tip", "terminal-admin-login-tip"),
        ...
        ("allow-insecure-tls-fallback-tip", "allow-insecure-tls-fallback-tip"),
        ...
        ("rel-mouse-not-supported-peer-tip", "rel-mouse-not-supported-peer-tip"),
        ("rel-mouse-not-ready-tip", "rel-mouse-not-ready-tip"),
        ("rel-mouse-lock-failed-tip", "rel-mouse-lock-failed-tip"),
        ("rel-mouse-exit-{}-tip", "rel-mouse-exit-{}-tip"),
        ("rel-mouse-permission-lost-tip", "rel-mouse-permission-lost-tip"),
        ("Changelog", "changelog"),
