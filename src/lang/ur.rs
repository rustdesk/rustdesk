...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Output resolution", "آؤٹ پٹ ریزولیشن"),
        ("Width", "چوڑائی"),
        ("Height", "اونچائی"),
        ("Swap width and height", "چوڑائی اور اونچائی تبدیل کریں"),
        ("Current resolution", "موجودہ ریزولیشن"),
        ("Reset changes", "تبدیلیاں ری سیٹ کریں"),
        ("Select a resolution supported by the display", "ڈسپلے کی معاونت یافتہ ریزولیشن منتخب کریں"),
        ("Display settings changed. Reopen the resolution menu and try again.", "ڈسپلے کی ترتیبات بدل گئی ہیں۔ ریزولیشن کا مینو دوبارہ کھولیں اور پھر کوشش کریں۔"),
        ("Closest supported resolution", "قریب ترین معاونت یافتہ ریزولیشن"),
        ("Adjusted to display limits", "ڈسپلے کی حدود کے مطابق ایڈجسٹ کیا گیا"),
        ("Local resolution is unavailable or unsupported", "مقامی ریزولیشن دستیاب نہیں یا اس کی معاونت نہیں ہے"),
        ("Looks like", "ایسا دکھائی دیتا ہے"),
        ("Rendering quality", "رینڈرنگ کا معیار"),
        ("Standard", "معیاری"),
        ("Enter dimensions within the range", "مقررہ حد کے اندر جہتیں درج کریں"),
        ("Aspect ratio", "چوڑائی اور اونچائی کا تناسب"),
        ("Available resolutions", "دستیاب ریزولیشنز"),
        ("System scaling", "سسٹم اسکیلنگ"),
        ("Recommended", "تجویز کردہ"),
        ("System scaling is unavailable for this display or desktop environment.", "اس ڈسپلے یا ڈیسک ٹاپ ماحول کے لیے سسٹم اسکیلنگ دستیاب نہیں ہے۔"),
        ("The system did not apply the requested scale. Refresh and try again.", "سسٹم نے مطلوبہ پیمانہ لاگو نہیں کیا۔ ریفریش کریں اور دوبارہ کوشش کریں۔"),
        ("Select a scaling level supported by the display.", "ڈسپلے کی معاونت یافتہ اسکیلنگ کی سطح منتخب کریں۔"),
        ("No permission to change display settings.", "ڈسپلے کی ترتیبات تبدیل کرنے کی اجازت نہیں ہے۔"),
        ("Invalid display scaling request.", "ڈسپلے اسکیلنگ کی درخواست درست نہیں ہے۔"),
        ("Display settings are busy. Try again.", "ڈسپلے کی ترتیبات مصروف ہیں۔ دوبارہ کوشش کریں۔"),
        ("Display settings timed out. Refresh and try again.", "ڈسپلے کی ترتیبات کا انتظار ختم ہو گیا۔ ریفریش کریں اور دوبارہ کوشش کریں۔"),
        ("Use nearest supported scale", "قریب ترین معاونت یافتہ پیمانہ استعمال کریں"),
        ("Scaling was applied, but the resolution request failed.", "پیمانہ لاگو ہو گیا، لیکن ریزولیشن کی درخواست ناکام رہی۔"),
        ("Failed to change display settings", "ڈسپلے کی ترتیبات تبدیل نہیں ہو سکیں"),
        ("Remote connection has closed", "ریموٹ کنکشن بند ہو گیا ہے"),
        ("Failed to resize macOS virtual display", "macOS کے ورچوئل ڈسپلے کا سائز تبدیل نہیں ہو سکا"),
        ("Failed to toggle macOS virtual display", "macOS کا ورچوئل ڈسپلے فعال یا غیر فعال نہیں ہو سکا"),
        ("Failed to start macOS virtual display worker", "macOS کے ورچوئل ڈسپلے کا ورک تھریڈ شروع نہیں ہو سکا"),
        ("Virtual display dimensions must be between 320 and 4096", "ورچوئل ڈسپلے کی جہتیں 320 اور 4096 کے درمیان ہونی چاہئیں"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "ورچوئل ڈسپلے کا پیمانہ 1 یا 2 ہونا چاہیے اور پکسل میں دونوں جہتیں اس پر پورا تقسیم ہونی چاہئیں"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "ورچوئل ڈسپلے کی جہتیں 1 اور 4096 منطقی پکسلز کے درمیان ہونی چاہئیں"),
        ("Display configuration response is too large.", "ڈسپلے کی ترتیب کا جواب بہت بڑا ہے۔"),
        ("Invalid display scaling response", "ڈسپلے اسکیلنگ کا جواب درست نہیں ہے"),
        ("Invalid display scaling levels", "ڈسپلے اسکیلنگ کی سطحیں درست نہیں ہیں"),
