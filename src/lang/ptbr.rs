...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("desk_tip", "O seu computador pode ser acedido através deste ID e password."),
        ("Password", "Password"),
        ("Ready", "Pronto"),
        ...
        ("Control Remote Desktop", "Controle um equipamento"),
        ("Transfer file", "Transferir"),
        ("Connect", "Conectar"),
        ...
        ("Enable keyboard/mouse", "Ativar teclado/mouse"),
        ("Enable clipboard", "Ativar Área de Transferência"),
        ("Enable file transfer", "Ativar Transferência de Arquivos"),
        ("Enable TCP tunneling", "Ativar Tunelamento TCP"),
        ...
        ("Change ID", "Alterar ID - Indisponível"),
        ...
        ("Do you want to enter again?", "Pretende conectar novamente?"),
        ...
        ("Receive", "Receber"),
        ("Send", "Enviar"),
        ("Refresh File", "Atualizar Ficheiro"),
        ("Local", "Local"),
        ("Remote", "Remoto"),
        ...
        ("Are you sure you want to delete the file of this directory?", "Tem certeza que deseja apagar este ficheiro desta localização?"),
        ...
        ("Enter Remote ID", "Introduza o ID"),
        ("Enter your password", "Informe sua password"),
        ("Logging in...", "Fazendo Login..."),
        ("Enable RDP session sharing", "Ativar sessões através de RDP"),
        ...
        ("Trust this device", "Confiar neste equipamento"),
        ("Verification code", "Código de verificação"),
        ("verification_tip", "Um novo equipamento foi detectado e um código de verificação foi enviado para o endereço de e-mail registrado, insira o código de verificação para continuar o login."),
        ("Logout", "Sair"),
        ("Tags", "Tags"),
        ...
        ("Username missed", "Faltou preencher o nome de utilizador..."),
        ("Password missed", "Faltou preencher a password..."),
        ...
        ("One-time Password", "Password única"),
        ("Use one-time password", "Usar password única"),
        ...
        ("empty_recent_tip", "Não existem conexões recentes!\nPretende iniciar uma conexão?"),
        ...
        ("empty_lan_tip", "Não identificamos nenhum equipamento na sua rede."),
        ("empty_address_book_tip", "Não identificamos nenhum equipamento na sua lista de contactos.."),
        ("eg: admin", "ex. admin"),
        ("Empty Username", "Nome de utilizador vazio"),
        ("Empty Password", "Password vazio"),
        ("Me", "Eu"),
        ("identical_file_tip", "Este ficheiro é idêntico ao do parceiro."),
        ("show_monitors_tip", "Mostrar monitores na barra de ferramentas"),
        ("View Mode", "Modo de Visualização"),
        ("login_linux_tip", "Você precisa fazer login na conta Linux remota para ativar uma sessão de desktop X"),
        ("verify_rustdesk_password_tip", "Verifique a password do HushDesk"),
        ("remember_account_tip", "Lembrar desta conta"),
        ("os_account_desk_tip", "Esta conta é utilizada para fazer login no Sistema operativo remoto e ativar a sessão da área de trabalho em headless"),
        ("OS Account", "Conta do Sistema Operativo"),
        ("another_user_login_title_tip", "Outro utilizador já está logado"),
        ...
        ("2FA code", "Código 2FA"),
        ("More", "Mais"),
        ("enable-2fa-title", "Ativar autenticação em duas etapas"),
        ...
        ("Set PIN", "Definir PIN"),
        ("Enable trusted devices", "Ativar equipamentos de confiança"),
        ("Manage trusted devices", "Gerir equipamentos de confiança"),
        ("Platform", "Plataforma"),
        ("Days remaining", "Dias restantes"),
        ("enable-trusted-devices-tip", "Ignore a verificação de dois fatores em equipamentos confiáveis"),
        ("Parent directory", "Diretório pai"),
        ("Resume", "Continuar"),
        ("Invalid file name", "Nome do ficheiro inválido"),
