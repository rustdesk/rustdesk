...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conectando à rede do bitdesk..."),
        ...
        ("install_tip", "Devido ao UAC, o  não funciona corretamente como o lado remoto em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o  no sistema."),
        ...
        ("config_acc", "Para controlar seu computador remotamente, você precisa conceder ao  permissões de \"Acessibilidade\"."),
        ("config_screen", "Para acessar seu computador remotamente, você precisa conceder ao  permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle seu dispositivo Android via mouse ou toque, você precisa permitir que o  use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], HABILITE o serviço [ Input]."),
        ...
        ("Quit", "Sair"),
        ("doc_mac_permission", "https://bitdesk.com/docs/en/manual/mac/#enable-permissions"),
        ("Help", "Ajuda"),
        ("Failed", "Falhou"),
        ("Succeeded", "Sucesso"),
        ...
        ("Language", "Idioma"),
        ("Keep bitdesk background service", "Manter o serviço do bitdesk executando em segundo plano"),
        ...
        ("config_input", "Para controlar a área de trabalho remota com teclado, você precisa conceder a permissão \"Monitoramento de entrada\" do bitdesk."),
        ("config_microphone", "Para falar remotamente, você precisa conceder a permissão \"Gravar áudio\" do bitdesk."),
        ...
        ("still_click_uac_tip", "Ainda requer que o usuário remoto clique em OK na janela UAC da execução do bitdesk."),
        ...
        ("verify_bitdesk_password_tip", "Verifique a senha do bitdesk"),
        ...
        ("upgrade_bitdesk_server_pro_to_{}_tip", ""),
