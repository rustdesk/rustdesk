...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conectando à rede TotalCAD..."),
        ...
        ("Show RustDesk", "Exibir TotalCAD Viewer"),
        ...
        ("powered_by_me", "Desenvolvido por TotalCAD"),
        ...
        ("About RustDesk", "Sobre TotalCAD Viewer"),
