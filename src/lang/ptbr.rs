...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("desk_tip", "Informe Este Código ao Atendente."),
        ("Password", "Senha"),
        ("Ready", "Pronto"),
        ("Established", "Estabelecido"),
        ("connecting_status", "Conectando aos servidores RizzoDesk..."),
        ...
        ("Control Remote Desktop", "Utilizar Somente se Solicitado"),
        ...
        ("Website", "Website"),
        ("About", "Sobre"),
        ("Slogan_tip", "Obrigado Cliente RizzoTec!"),
        ...
        ("Failed to connect to rendezvous server", "Falha ao conectar aos Servidores "),
        ...
        ("install_tip", "Devido ao UAC, o RizzoDesk não funciona corretamente como o lado remoto em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o RustDesk no sistema."),
        ...
        ("Quit", "Sair"),
        ("doc_mac_permission", "https://rizzotec.com.br"),
        ("Help", "Ajuda"),
        ("Failed", "Falhou"),
        ("Succeeded", "Sucesso"),
        ...
        ("Language", "Idioma"),
        ("Keep RustDesk background service", "Manter o serviço do RizzoDesk executando em segundo plano"),
