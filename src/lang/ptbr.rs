...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Select a resolution supported by the display", "Selecione uma resolução compatível com a tela"),
        ("Display settings changed. Reopen the resolution menu and try again.", "As configurações de exibição mudaram. Reabra o menu de resolução e tente novamente."),
        ("Closest supported resolution", "Resolução compatível mais próxima"),
        ("Adjusted to display limits", "Ajustado aos limites da tela"),
        ("Local resolution is unavailable or unsupported", "A resolução local está indisponível ou não é compatível"),
        ("Looks like", "Parece com"),
        ("Rendering quality", "Qualidade de renderização"),
        ("Standard", "Padrão"),
        ("Enter dimensions within the range", "Insira dimensões dentro do intervalo"),
        ("Aspect ratio", "Proporção da tela"),
        ("Available resolutions", "Resoluções disponíveis"),
        ("System scaling", "Escala do sistema"),
        ("Recommended", "Recomendado"),
        ("System scaling is unavailable for this display or desktop environment.", "A escala do sistema está indisponível para esta tela ou ambiente de área de trabalho."),
        ("The system did not apply the requested scale. Refresh and try again.", "O sistema não aplicou a escala solicitada. Atualize e tente novamente."),
        ("Select a scaling level supported by the display.", "Selecione um nível de escala compatível com a tela."),
        ("No permission to change display settings.", "Sem permissão para alterar as configurações de exibição."),
        ("Invalid display scaling request.", "Solicitação de escala de exibição inválida."),
        ("Display settings are busy. Try again.", "As configurações de exibição estão ocupadas. Tente novamente."),
        ("Display settings timed out. Refresh and try again.", "O tempo de espera das configurações de exibição expirou. Atualize e tente novamente."),
        ("Use nearest supported scale", "Usar a escala compatível mais próxima"),
        ("Scaling was applied, but the resolution request failed.", "A escala foi aplicada, mas a solicitação de resolução falhou."),
        ("Failed to change display settings", "Não foi possível alterar as configurações de exibição"),
        ("Remote connection has closed", "A conexão remota foi encerrada"),
        ("Failed to resize macOS virtual display", "Não foi possível redimensionar a tela virtual do macOS"),
        ("Failed to toggle macOS virtual display", "Não foi possível ativar ou desativar a tela virtual do macOS"),
        ("Failed to start macOS virtual display worker", "Não foi possível iniciar o processo de telas virtuais do macOS"),
        ("Virtual display dimensions must be between 320 and 4096", "As dimensões da tela virtual devem estar entre 320 e 4096"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "A escala da tela virtual deve ser 1 ou 2 e dividir exatamente ambas as dimensões em pixels"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "As dimensões da tela virtual devem estar entre 1 e 4096 pixels lógicos"),
        ("Display configuration response is too large.", "A resposta de configuração de exibição é muito grande."),
        ("Invalid display scaling response", "Resposta de escala de exibição inválida"),
        ("Invalid display scaling levels", "Níveis de escala de exibição inválidos"),
