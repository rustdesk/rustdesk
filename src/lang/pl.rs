...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "GerarDesk może nie działać poprawnie na maszynie zdalnej z przyczyn związanych z UAC. W celu uniknięcią problemów z UAC, kliknij poniższy przycisk by zainstalować GerarDesk w swoim systemie."),
        ...
        ("Language", "Język"),
        ("Keep GerarDesk background service", "Zachowaj usługę GerarDesk w tle"),
        ...
        ("Show GerarDesk", "Pokaż GerarDesk"),
