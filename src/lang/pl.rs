...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Width", "Szerokość"),
        ("Height", "Wysokość"),
        ("Swap width and height", "Zamień szerokość i wysokość"),
        ("Current resolution", "Bieżąca rozdzielczość"),
        ("Reset changes", "Zresetuj zmiany"),
        ("Select a resolution supported by the display", "Wybierz rozdzielczość obsługiwaną przez ekran"),
        ("Display settings changed. Reopen the resolution menu and try again.", "Ustawienia ekranu uległy zmianie. Otwórz ponownie menu rozdzielczości i spróbuj jeszcze raz."),
        ("Closest supported resolution", "Najbliższa obsługiwana rozdzielczość"),
        ("Adjusted to display limits", "Dostosowano do ograniczeń ekranu"),
        ("Local resolution is unavailable or unsupported", "Lokalna rozdzielczość jest niedostępna lub nieobsługiwana"),
        ("Looks like", "Wygląda jak"),
        ("Rendering quality", "Jakość renderowania"),
        ("Standard", "Standardowa"),
        ("Enter dimensions within the range", "Wprowadź wymiary z dozwolonego zakresu"),
        ("Aspect ratio", "Proporcje obrazu"),
        ("Available resolutions", "Dostępne rozdzielczości"),
        ("System scaling", "Skalowanie systemowe"),
        ("Recommended", "Zalecane"),
        ("System scaling is unavailable for this display or desktop environment.", "Skalowanie systemowe jest niedostępne dla tego ekranu lub środowiska pulpitu."),
        ("The system did not apply the requested scale. Refresh and try again.", "System nie zastosował żądanej skali. Odśwież i spróbuj ponownie."),
        ("Select a scaling level supported by the display.", "Wybierz poziom skalowania obsługiwany przez ekran."),
        ("No permission to change display settings.", "Brak uprawnień do zmiany ustawień ekranu."),
        ("Invalid display scaling request.", "Nieprawidłowe żądanie skalowania ekranu."),
        ("Display settings are busy. Try again.", "Ustawienia ekranu są zajęte. Spróbuj ponownie."),
        ("Display settings timed out. Refresh and try again.", "Przekroczono limit czasu ustawień ekranu. Odśwież i spróbuj ponownie."),
        ("Use nearest supported scale", "Użyj najbliższej obsługiwanej skali"),
        ("Scaling was applied, but the resolution request failed.", "Skala została zastosowana, ale żądanie zmiany rozdzielczości nie powiodło się."),
        ("Failed to change display settings", "Nie udało się zmienić ustawień ekranu"),
        ("Remote connection has closed", "Połączenie zdalne zostało zamknięte"),
        ("Failed to resize macOS virtual display", "Nie udało się zmienić rozmiaru wirtualnego ekranu macOS"),
        ("Failed to toggle macOS virtual display", "Nie udało się włączyć lub wyłączyć wirtualnego ekranu macOS"),
        ("Failed to start macOS virtual display worker", "Nie udało się uruchomić procesu roboczego wirtualnych ekranów macOS"),
        ("Virtual display dimensions must be between 320 and 4096", "Wymiary wirtualnego ekranu muszą mieścić się w zakresie od 320 do 4096"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "Skala wirtualnego ekranu musi wynosić 1 lub 2 i dzielić oba wymiary w pikselach bez reszty"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "Wymiary wirtualnego ekranu muszą mieścić się w zakresie od 1 do 4096 pikseli logicznych"),
        ("Display configuration response is too large.", "Odpowiedź z konfiguracją ekranu jest zbyt duża."),
        ("Invalid display scaling response", "Nieprawidłowa odpowiedź dotycząca skalowania ekranu"),
        ("Invalid display scaling levels", "Nieprawidłowe poziomy skalowania ekranu"),
