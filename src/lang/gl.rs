...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Width", "Largura"),
        ("Height", "Altura"),
        ("Swap width and height", "Intercambiar largura e altura"),
        ("Current resolution", "Resolución actual"),
        ("Reset changes", "Restablecer cambios"),
        ("Select a resolution supported by the display", "Seleccione unha resolución compatible coa pantalla"),
        ("Display settings changed. Reopen the resolution menu and try again.", "Os axustes de pantalla cambiaron. Abra de novo o menú de resolución e ténteo outra vez."),
        ("Closest supported resolution", "Resolución compatible máis próxima"),
        ("Adjusted to display limits", "Axustado aos límites da pantalla"),
        ("Local resolution is unavailable or unsupported", "A resolución local non está dispoñible ou non é compatible"),
        ("Looks like", "Parece como"),
        ("Rendering quality", "Calidade de renderización"),
        ("Standard", "Estándar"),
        ("Enter dimensions within the range", "Introduza dimensións dentro do intervalo"),
        ("Aspect ratio", "Relación de aspecto"),
        ("Available resolutions", "Resolucións dispoñibles"),
        ("System scaling", "Escala do sistema"),
        ("Recommended", "Recomendado"),
        ("System scaling is unavailable for this display or desktop environment.", "A escala do sistema non está dispoñible para esta pantalla ou contorno de escritorio."),
        ("The system did not apply the requested scale. Refresh and try again.", "O sistema non aplicou a escala solicitada. Actualice e ténteo de novo."),
        ("Select a scaling level supported by the display.", "Seleccione un nivel de escala compatible coa pantalla."),
        ("No permission to change display settings.", "Non ten permiso para cambiar os axustes de pantalla."),
        ("Invalid display scaling request.", "Solicitude de escala de pantalla non válida."),
        ("Display settings are busy. Try again.", "Os axustes de pantalla están ocupados. Ténteo de novo."),
        ("Display settings timed out. Refresh and try again.", "Esgotouse o tempo de espera dos axustes de pantalla. Actualice e ténteo de novo."),
        ("Use nearest supported scale", "Usar a escala compatible máis próxima"),
        ("Scaling was applied, but the resolution request failed.", "Aplicouse a escala, pero fallou a solicitude de resolución."),
        ("Failed to change display settings", "Non se puideron cambiar os axustes de pantalla"),
        ("Remote connection has closed", "Pechouse a conexión remota"),
        ("Failed to resize macOS virtual display", "Non se puido cambiar o tamaño da pantalla virtual de macOS"),
        ("Failed to toggle macOS virtual display", "Non se puido activar ou desactivar a pantalla virtual de macOS"),
        ("Failed to start macOS virtual display worker", "Non se puido iniciar o proceso de pantallas virtuais de macOS"),
        ("Virtual display dimensions must be between 320 and 4096", "As dimensións da pantalla virtual deben estar entre 320 e 4096"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "A escala da pantalla virtual debe ser 1 ou 2 e dividir exactamente ambas as dimensións en píxeles"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "As dimensións da pantalla virtual deben estar entre 1 e 4096 píxeles lóxicos"),
        ("Display configuration response is too large.", "A resposta de configuración de pantalla é demasiado grande."),
        ("Invalid display scaling response", "Resposta de escala de pantalla non válida"),
        ("Invalid display scaling levels", "Niveis de escala de pantalla non válidos"),
