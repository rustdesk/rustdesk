...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("agreement_tip", "A telepítés folytatásával automatikusan elfogadásra kerül a licence szerződés."),
        ("Accept and Install", "Elfogadás és telepítés"),
        ("End-user license agreement", "Végfelhasználói licence szerződés"),
