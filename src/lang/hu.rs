...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Not an empty directory", "A könyvtár nem üres!"),
        ...
        ("The verification code is incorrect or has expired", "A hitelesítési kód hibás vagy lejárt"),
        ...
        ("No need to elevate", "Nem szükséges emeltszintű jog"),
