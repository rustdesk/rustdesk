...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Hardware Codec", "Hardveres codec"),
        ...
        ("Failed to connect via relay server", "Nem sikerült kapcsolódni az továbbító-kiszolgálón keresztül"),
        ...
        ("agreement_tip", "A telepítés folytatásával automatikusan elfogadásra kerül a license szerződés."),
        ("Accept and Install", "Elfogadás és telepítés"),
        ("End-user license agreement", "Végfelhasználói license szerződés"),
        ...
        ("Relayed and encrypted connection", "Átjátszott, és titkosított kapcsolat"),
        ("Direct and unencrypted connection", "Közvetlen, és nem titkosított kapcsolat"),
        ("Relayed and unencrypted connection", "Átjátszott, és nem titkosított kapcsolat"),
        ...
        ("Enable hardware codec", "Hardveres codec engedélyezése"),
        ...
        ("Default Codec", "Alapértelmezett codec"),
        ("Bitrate", "Bitsebesség"),
        ("FPS", "FPS"),
        ("Auto", "Automatikus"),
