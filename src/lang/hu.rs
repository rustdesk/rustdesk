...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("TCP tunneling", "TCP alagútképzés"),
        ("Remove", "Eltávolítás"),
        ...
        ("Enable TCP tunneling", "TCP alagútképzés engedélyezése"),
        ...
        ("not_close_tcp_tip", "Ne zárja be ezt az ablakot amíg TCP alagútképzést használ"),
        ("Listening ...", "Figyelés…"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Frissítse a RustDesk kliens {} vagy újabb verziójára a távoli oldalon!"),
        ("view_camera_unsupported_tip", "A kamera megtekintése nem támogatott"),
        ...
        ("printer-requires-installed-{}-client-tip", "A nyomtatóhoz telepített kliens szükséges "),
        ("printer-{}-not-installed-tip", "A nyomtató nincs telepítve"),
        ("printer-{}-ready-tip", "A nyomtató készen áll"),
        ("Install {} Printer", "Nyomtató telepítése"),
