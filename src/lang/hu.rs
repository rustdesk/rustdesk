...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("drm_capture_tip", "A DRM/KMS közvetlen rögzítés elérhető — nincs szükség portál-hozzájárulásra. Támogatja a felügyelet nélküli hozzáférést és a bejelentkezési képernyő rögzítését."),
