...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Width", "Szélesség"),
        ("Height", "Magasság"),
        ("Swap width and height", "Szélesség és magasság felcserélése"),
        ("Current resolution", "Jelenlegi felbontás"),
        ("Reset changes", "Módosítások visszaállítása"),
        ("Select a resolution supported by the display", "Válasszon a kijelző által támogatott felbontást"),
        ("Display settings changed. Reopen the resolution menu and try again.", "A kijelző beállításai megváltoztak. Nyissa meg újra a felbontásmenüt, és próbálja újra."),
        ("Closest supported resolution", "Legközelebbi támogatott felbontás"),
        ("Adjusted to display limits", "A kijelző korlátaihoz igazítva"),
        ("Local resolution is unavailable or unsupported", "A helyi felbontás nem érhető el vagy nem támogatott"),
        ("Looks like", "Így néz ki"),
        ("Rendering quality", "Megjelenítés minősége"),
        ("Standard", "Normál"),
        ("Enter dimensions within the range", "Adjon meg a tartományba eső méreteket"),
        ("Aspect ratio", "Képarány"),
        ("Available resolutions", "Elérhető felbontások"),
        ("System scaling", "Rendszerszintű méretezés"),
        ("Recommended", "Ajánlott"),
        ("System scaling is unavailable for this display or desktop environment.", "A rendszerszintű méretezés nem érhető el ezen a kijelzőn vagy asztali környezetben."),
        ("The system did not apply the requested scale. Refresh and try again.", "A rendszer nem alkalmazta a kért méretezést. Frissítsen, és próbálja újra."),
        ("Select a scaling level supported by the display.", "Válasszon a kijelző által támogatott méretezési szintet."),
        ("No permission to change display settings.", "Nincs jogosultság a kijelző beállításainak módosításához."),
        ("Invalid display scaling request.", "Érvénytelen kijelzőméretezési kérés."),
        ("Display settings are busy. Try again.", "A kijelző beállításai foglaltak. Próbálja újra."),
        ("Display settings timed out. Refresh and try again.", "A kijelző beállításainak időkorlátja lejárt. Frissítsen, és próbálja újra."),
        ("Use nearest supported scale", "Legközelebbi támogatott méretezés használata"),
        ("Scaling was applied, but the resolution request failed.", "A méretezés alkalmazva lett, de a felbontásra vonatkozó kérés sikertelen."),
        ("Failed to change display settings", "Nem sikerült módosítani a kijelző beállításait"),
        ("Remote connection has closed", "A távoli kapcsolat lezárult"),
        ("Failed to resize macOS virtual display", "Nem sikerült átméretezni a macOS virtuális kijelzőjét"),
        ("Failed to toggle macOS virtual display", "Nem sikerült be- vagy kikapcsolni a macOS virtuális kijelzőjét"),
        ("Failed to start macOS virtual display worker", "Nem sikerült elindítani a macOS virtuális kijelzőinek munkafolyamatát"),
        ("Virtual display dimensions must be between 320 and 4096", "A virtuális kijelző méreteinek 320 és 4096 közé kell esniük"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "A virtuális kijelző méretezési tényezője 1 vagy 2 lehet, és mindkét pixelméretnek maradék nélkül oszthatónak kell lennie vele"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "A virtuális kijelző méreteinek 1 és 4096 logikai képpont közé kell esniük"),
        ("Display configuration response is too large.", "A kijelzőkonfiguráció válasza túl nagy."),
        ("Invalid display scaling response", "Érvénytelen kijelzőméretezési válasz"),
        ("Invalid display scaling levels", "Érvénytelen kijelzőméretezési szintek"),
