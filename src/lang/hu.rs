lazy_static::lazy_static! {
    pub static ref T: std::collections::HashMap<&'static str, &'static str> =
        [
            ...
            ("Service is running", "Szolgáltatás működik"),
            ("Service is not running", "Szolgáltatás nem működik"),
            ...
            ("length %min% to %max%", "hosszúsága %min% és %max% között"),
            ...
            ("server_not_support", "Nem támogatott a kiszolgáló által"),
            ...
            ("Failed to connect to rendezvous server", "Nem sikerült csatlakozni a találkozási kiszolgálóhoz"),
            ...
            ("Timeout", "Időtúllépés"),
            ("Failed to connect to relay server", "Nem sikerült csatlakozni a közvetítő kiszolgálóhoz"),
            ("Failed to connect via rendezvous server", "Nem sikerült csatlakozni a találkozási kiszolgálón keresztül"),
            ("Failed to connect via relay server", "Nem sikerült csatlakozni a közvetítő kiszolgálón keresztül"),
            ...
            ("The confirmation is not identical.", "A megerősítés nem azonos"),
            ...
            ("web_id_input_tip", "Azonos kiszolgálón lévő azonosítót adhat meg, a közvetlen IP elérés nem támogatott a webkliensben.\nHa egy másik kiszolgálón lévő eszközhöz szeretne hozzáférni, kérjük, adja meg a kiszolgáló címét (<id>@<szerver_cím>?key=<key_value>), például\n9123456234@192.168.16.1:21117?key=5Qbwsde3unUcJBtrx9ZkvUmwFNoExHzpryHuPUdqlWM=.\nHa egy nyilvános kiszolgálón lévő eszközhöz szeretne hozzáférni, kérjük, adja meg a \"<id>@public\" betűt. A kulcsra nincs szükség a nyilvános kiszolgálók esetében."),
            ("Download", "Letöltés"),
            ...
            ("new-version-of-{}-tip", "{} verzió frissítése"),
        ].iter().cloned().collect();
    }
