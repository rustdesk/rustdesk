...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("drm_capture_tip", "La captura directa DRM/KMS està disponible — no cal cap consentiment del portal. Admet l'accés desatès i la captura de la pantalla d'inici de sessió."),
