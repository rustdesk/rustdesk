...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Width", "Amplada"),
        ("Height", "Alçada"),
        ("Swap width and height", "Intercanvia l’amplada i l’alçada"),
        ("Current resolution", "Resolució actual"),
        ("Reset changes", "Restableix els canvis"),
        ("Select a resolution supported by the display", "Seleccioneu una resolució compatible amb la pantalla"),
        ("Display settings changed. Reopen the resolution menu and try again.", "La configuració de pantalla ha canviat. Torneu a obrir el menú de resolució i torneu-ho a provar."),
        ("Closest supported resolution", "Resolució compatible més propera"),
        ("Adjusted to display limits", "Ajustat als límits de la pantalla"),
        ("Local resolution is unavailable or unsupported", "La resolució local no està disponible o no és compatible"),
        ("Looks like", "Sembla com"),
        ("Rendering quality", "Qualitat de renderització"),
        ("Standard", "Estàndard"),
        ("Enter dimensions within the range", "Introduïu dimensions dins de l’interval"),
        ("Aspect ratio", "Relació d’aspecte"),
        ("Available resolutions", "Resolucions disponibles"),
        ("System scaling", "Escala del sistema"),
        ("Recommended", "Recomanat"),
        ("System scaling is unavailable for this display or desktop environment.", "L’escala del sistema no està disponible per a aquesta pantalla o entorn d’escriptori."),
        ("The system did not apply the requested scale. Refresh and try again.", "El sistema no ha aplicat l’escala sol·licitada. Actualitzeu i torneu-ho a provar."),
        ("Select a scaling level supported by the display.", "Seleccioneu un nivell d’escala compatible amb la pantalla."),
        ("No permission to change display settings.", "No teniu permís per canviar la configuració de pantalla."),
        ("Invalid display scaling request.", "La sol·licitud d’escala de pantalla no és vàlida."),
        ("Display settings are busy. Try again.", "La configuració de pantalla està ocupada. Torneu-ho a provar."),
        ("Display settings timed out. Refresh and try again.", "S’ha esgotat el temps d’espera de la configuració de pantalla. Actualitzeu i torneu-ho a provar."),
        ("Use nearest supported scale", "Utilitza l’escala compatible més propera"),
        ("Scaling was applied, but the resolution request failed.", "S’ha aplicat l’escala, però la sol·licitud de resolució ha fallat."),
        ("Failed to change display settings", "No s’ha pogut canviar la configuració de pantalla"),
        ("Remote connection has closed", "La connexió remota s’ha tancat"),
        ("Failed to resize macOS virtual display", "No s’ha pogut canviar la mida de la pantalla virtual del macOS"),
        ("Failed to toggle macOS virtual display", "No s’ha pogut activar o desactivar la pantalla virtual del macOS"),
        ("Failed to start macOS virtual display worker", "No s’ha pogut iniciar el procés de pantalles virtuals del macOS"),
        ("Virtual display dimensions must be between 320 and 4096", "Les dimensions de la pantalla virtual han d’estar entre 320 i 4096"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "L’escala de la pantalla virtual ha de ser 1 o 2 i dividir exactament les dues dimensions en píxels"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "Les dimensions de la pantalla virtual han d’estar entre 1 i 4096 píxels lògics"),
        ("Display configuration response is too large.", "La resposta de configuració de pantalla és massa gran."),
