...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("headless_display_tip", "Quan no hi ha cap monitor connectat, força una sortida de vídeo desconnectada perquè hi hagi una pantalla per capturar. Es llibera tan bon punt es connecta un monitor en una altra sortida."),
