...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Output resolution", "Шығыс ажыратымдылығы"),
        ("Width", "Ені"),
        ("Height", "Биіктігі"),
        ("Swap width and height", "Ені мен биіктігін ауыстыру"),
        ("Current resolution", "Ағымдағы ажыратымдылық"),
        ("Reset changes", "Өзгерістерді қалпына келтіру"),
        ("Select a resolution supported by the display", "Дисплей қолдайтын ажыратымдылықты таңдаңыз"),
        ("Display settings changed. Reopen the resolution menu and try again.", "Дисплей параметрлері өзгерді. Ажыратымдылық мәзірін қайта ашып, әрекетті қайталаңыз."),
        ("Closest supported resolution", "Ең жақын қолдау көрсетілетін ажыратымдылық"),
        ("Adjusted to display limits", "Дисплей шектеулеріне бейімделді"),
        ("Local resolution is unavailable or unsupported", "Жергілікті ажыратымдылық қолжетімсіз немесе оған қолдау көрсетілмейді"),
        ("Looks like", "Мынадай көрінеді"),
        ("Rendering quality", "Бейнелеу сапасы"),
        ("Standard", "Стандартты"),
        ("Enter dimensions within the range", "Рұқсат етілген ауқымдағы өлшемдерді енгізіңіз"),
        ("Aspect ratio", "Тараптар арақатынасы"),
        ("Available resolutions", "Қолжетімді ажыратымдылықтар"),
        ("System scaling", "Жүйелік масштабтау"),
        ("Recommended", "Ұсынылады"),
        ("System scaling is unavailable for this display or desktop environment.", "Бұл дисплей немесе жұмыс үстелі ортасы үшін жүйелік масштабтау қолжетімсіз."),
        ("The system did not apply the requested scale. Refresh and try again.", "Жүйе сұралған масштабты қолданбады. Жаңартып, әрекетті қайталаңыз."),
        ("Select a scaling level supported by the display.", "Дисплей қолдайтын масштабтау деңгейін таңдаңыз."),
        ("No permission to change display settings.", "Дисплей параметрлерін өзгертуге рұқсат жоқ."),
        ("Invalid display scaling request.", "Дисплейді масштабтау сұрауы жарамсыз."),
        ("Display settings are busy. Try again.", "Дисплей параметрлері бос емес. Әрекетті қайталаңыз."),
        ("Display settings timed out. Refresh and try again.", "Дисплей параметрлерін күту уақыты аяқталды. Жаңартып, әрекетті қайталаңыз."),
        ("Use nearest supported scale", "Ең жақын қолдау көрсетілетін масштабты пайдалану"),
        ("Scaling was applied, but the resolution request failed.", "Масштаб қолданылды, бірақ ажыратымдылық сұрауы орындалмады."),
        ("Failed to change display settings", "Дисплей параметрлерін өзгерту мүмкін болмады"),
        ("Remote connection has closed", "Қашықтағы қосылым жабылды"),
        ("Failed to resize macOS virtual display", "macOS виртуалды дисплейінің өлшемін өзгерту мүмкін болмады"),
        ("Failed to toggle macOS virtual display", "macOS виртуалды дисплейін қосу немесе өшіру мүмкін болмады"),
        ("Failed to start macOS virtual display worker", "macOS виртуалды дисплейлерінің жұмыс процесін бастау мүмкін болмады"),
        ("Virtual display dimensions must be between 320 and 4096", "Виртуалды дисплейдің өлшемдері 320 мен 4096 аралығында болуы керек"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "Виртуалды дисплейдің масштабы 1 немесе 2 болуы және екі пиксель өлшемін де қалдықсыз бөлуі керек"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "Виртуалды дисплейдің өлшемдері 1 мен 4096 логикалық пиксель аралығында болуы керек"),
        ("Display configuration response is too large.", "Дисплей конфигурациясының жауабы тым үлкен."),
        ("Invalid display scaling response", "Дисплейді масштабтау жауабы жарамсыз"),
        ("Invalid display scaling levels", "Дисплейді масштабтау деңгейлері жарамсыз"),
        ("Invalid display scaling range", "Дисплейді масштабтау ауқымы жарамсыз"),
        ("Interface size", "Интерфейс өлшемі"),
        ("Current interface size", "Ағымдағы интерфейс өлшемі"),
    ].iter().cloned().collect();
}
