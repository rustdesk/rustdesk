...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Width", "Plotis"),
        ("Height", "Aukštis"),
        ("Swap width and height", "Sukeisti plotį ir aukštį"),
        ("Current resolution", "Dabartinė raiška"),
        ("Reset changes", "Atkurti pakeitimus"),
        ("Select a resolution supported by the display", "Pasirinkite ekrano palaikomą raišką"),
        ("Display settings changed. Reopen the resolution menu and try again.", "Ekrano nustatymai pasikeitė. Iš naujo atverkite raiškos meniu ir bandykite dar kartą."),
        ("Closest supported resolution", "Artimiausia palaikoma raiška"),
        ("Adjusted to display limits", "Pritaikyta prie ekrano apribojimų"),
        ("Local resolution is unavailable or unsupported", "Vietinė raiška nepasiekiama arba nepalaikoma"),
        ("Looks like", "Atrodo kaip"),
        ("Rendering quality", "Atvaizdavimo kokybė"),
        ("Standard", "Standartinė"),
        ("Enter dimensions within the range", "Įveskite matmenis leistiname intervale"),
        ("Aspect ratio", "Kraštinių santykis"),
        ("Available resolutions", "Galimos raiškos"),
        ("System scaling", "Sistemos mastelis"),
        ("Recommended", "Rekomenduojama"),
        ("System scaling is unavailable for this display or desktop environment.", "Sistemos mastelio keitimas šiam ekranui ar darbalaukio aplinkai nepasiekiamas."),
        ("The system did not apply the requested scale. Refresh and try again.", "Sistema nepritaikė prašomo mastelio. Atnaujinkite ir bandykite dar kartą."),
        ("Select a scaling level supported by the display.", "Pasirinkite ekrano palaikomą mastelio lygį."),
        ("No permission to change display settings.", "Nėra leidimo keisti ekrano nustatymus."),
        ("Invalid display scaling request.", "Netinkama ekrano mastelio užklausa."),
        ("Display settings are busy. Try again.", "Ekrano nustatymai užimti. Bandykite dar kartą."),
        ("Display settings timed out. Refresh and try again.", "Baigėsi ekrano nustatymų laukimo laikas. Atnaujinkite ir bandykite dar kartą."),
        ("Use nearest supported scale", "Naudoti artimiausią palaikomą mastelį"),
        ("Scaling was applied, but the resolution request failed.", "Mastelis pritaikytas, bet raiškos užklausa nepavyko."),
        ("Failed to change display settings", "Nepavyko pakeisti ekrano nustatymų"),
        ("Remote connection has closed", "Nuotolinis ryšys uždarytas"),
        ("Failed to resize macOS virtual display", "Nepavyko pakeisti virtualiojo macOS ekrano dydžio"),
        ("Failed to toggle macOS virtual display", "Nepavyko įjungti arba išjungti virtualiojo macOS ekrano"),
        ("Failed to start macOS virtual display worker", "Nepavyko paleisti virtualiųjų macOS ekranų darbo proceso"),
        ("Virtual display dimensions must be between 320 and 4096", "Virtualiojo ekrano matmenys turi būti nuo 320 iki 4096"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "Virtualiojo ekrano mastelis turi būti 1 arba 2, o abu matmenys pikseliais turi iš jo dalytis be liekanos"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "Virtualiojo ekrano matmenys turi būti nuo 1 iki 4096 loginių pikselių"),
        ("Display configuration response is too large.", "Ekrano konfigūracijos atsakymas per didelis."),
