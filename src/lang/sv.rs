...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Width", "Bredd"),
        ("Height", "Höjd"),
        ("Swap width and height", "Byt bredd och höjd"),
        ("Current resolution", "Aktuell upplösning"),
        ("Reset changes", "Återställ ändringar"),
        ("Select a resolution supported by the display", "Välj en upplösning som skärmen stöder"),
        ("Display settings changed. Reopen the resolution menu and try again.", "Skärminställningarna har ändrats. Öppna upplösningsmenyn igen och försök på nytt."),
        ("Closest supported resolution", "Närmaste upplösning som stöds"),
        ("Adjusted to display limits", "Anpassad till skärmens gränser"),
        ("Local resolution is unavailable or unsupported", "Lokal upplösning är inte tillgänglig eller stöds inte"),
        ("Looks like", "Ser ut som"),
        ("Rendering quality", "Renderingskvalitet"),
        ("Standard", "Standard"),
        ("Enter dimensions within the range", "Ange dimensioner inom intervallet"),
        ("Aspect ratio", "Bildförhållande"),
        ("Available resolutions", "Tillgängliga upplösningar"),
        ("System scaling", "Systemskalning"),
        ("Recommended", "Rekommenderad"),
        ("System scaling is unavailable for this display or desktop environment.", "Systemskalning är inte tillgänglig för denna skärm eller skrivbordsmiljö."),
        ("The system did not apply the requested scale. Refresh and try again.", "Systemet tillämpade inte den begärda skalningen. Uppdatera och försök igen."),
        ("Select a scaling level supported by the display.", "Välj en skalningsnivå som skärmen stöder."),
        ("No permission to change display settings.", "Behörighet att ändra skärminställningar saknas."),
        ("Invalid display scaling request.", "Ogiltig begäran om skärmskalning."),
        ("Display settings are busy. Try again.", "Skärminställningarna är upptagna. Försök igen."),
        ("Display settings timed out. Refresh and try again.", "Tidsgränsen för skärminställningarna överskreds. Uppdatera och försök igen."),
        ("Use nearest supported scale", "Använd närmaste skalning som stöds"),
        ("Scaling was applied, but the resolution request failed.", "Skalningen tillämpades, men begäran om upplösning misslyckades."),
        ("Failed to change display settings", "Kunde inte ändra skärminställningarna"),
        ("Remote connection has closed", "Fjärranslutningen har stängts"),
        ("Failed to resize macOS virtual display", "Kunde inte ändra storleken på den virtuella macOS-skärmen"),
        ("Failed to toggle macOS virtual display", "Kunde inte slå på eller av den virtuella macOS-skärmen"),
        ("Failed to start macOS virtual display worker", "Kunde inte starta arbetsprocessen för virtuella macOS-skärmar"),
        ("Virtual display dimensions must be between 320 and 4096", "Den virtuella skärmens dimensioner måste vara mellan 320 och 4096"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "Den virtuella skärmens skalning måste vara 1 eller 2 och dela båda pixeldimensionerna utan rest"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "Den virtuella skärmens dimensioner måste vara mellan 1 och 4096 logiska pixlar"),
        ("Display configuration response is too large.", "Svaret med skärmkonfigurationen är för stort."),
        ("Invalid display scaling response", "Ogiltigt svar om skärmskalning"),
        ("Invalid display scaling levels", "Ogiltiga nivåer för skärmskalning"),
