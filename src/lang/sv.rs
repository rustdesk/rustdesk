...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till GerarDesk..."),
        ...
        ("install_tip", "På grund av UAC, kan inte GerarDesk fungera ordentligt på klientsidan. För att undvika UAC, tryck på knappen nedan för att installera GerarDesk på systemet."),
        ...
        ("config_acc", "För att kontrollera din dator på distans måste du ge GerarDesk \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge GerarDesk \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [GerarDesk Input] tjänsten."),
        ...
        ("Language", "Språk"),
        ("Keep GerarDesk background service", "Behåll GerarDesk i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa GerarDesk programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
