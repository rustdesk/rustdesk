...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Enable TCP tunneling", "Aktivera TCP-tunnel"),
        ("IP Whitelisting", "IP-tillåtelselista"),
        ("ID/Relay Server", "ID-/reläserver"),
        ("Import server config", "Importera serverkonfiguration"),
        ("Export Server Config", "Exportera serverkonfiguration"),
        ...
        ("Invalid server configuration", "Ogiltig serverkonfiguration"),
        ...
        ("id_change_tip", "Endast tecknen a-z, A-Z, 0-9, - (bindestreck) och _ (understreck) är tillåtna. Det första tecknet måste vara a-z eller A-Z. Längden ska vara mellan 6 och 16."),
        ("Website", "Hemsida"),
        ("About", "Om"),
        ...
        ("Reset by the peer", "Återställd av motparten"),
        ("Connecting...", "Ansluter..."),
        ...
        ("Block user input", "Blockera användarinmatning"),
        ...
        ("Insert Ctrl + Alt + Del", "Skicka Ctrl + Alt + Del"),
        ("Insert Lock", "Skicka Lock"),
        ("Refresh", "Uppdatera"),
        ("ID does not exist", "Det här ID:t finns inte"),
        ("Failed to connect to rendezvous server", "Det gick inte att ansluta till rendezvousservern"),
        ("Please try later", "Försök igen senare"),
        ("Remote desktop is offline", "Fjärrskrivbordet är offline"),
        ("Key mismatch", "Nycklarna matchar inte"),
        ("Timeout", "Timeout"),
        ("Failed to connect to relay server", "Lyckades inte ansluta till relay servern"),
        ("Failed to connect via rendezvous server", "Det gick inte att ansluta via rendezvousservern"),
        ...
        ("OS Password", "Operativsystemets lösenord"),
        ...
        ("Click to upgrade", "Klicka för att uppgradera"),
        ("Configure", "Konfigurera"),
        ("config_acc", "För att fjärrstyra din dator måste du ge RustDesk behörigheten \"Hjälpmedel\"."),
        ("config_screen", "För att fjärrstyra din dator måste du ge RustDesk behörigheten \"Skärminspelning\"."),
        ("Installing ...", "Installerar..."),
        ("Install", "Installera"),
        ("Installation", "Installation"),
        ("Installation Path", "Installationsplats"),
        ("Create start menu shortcuts", "Skapa genvägar i Start-menyn"),
        ...
        ("Your installation is lower version.", "Din installation har en äldre version."),
        ("not_close_tcp_tip", "Stäng inte det här fönstret när du använder tunneln"),
        ("Listening ...", "Lyssnar..."),
