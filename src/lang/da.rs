...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Output resolution", "Outputopløsning"),
        ("Width", "Bredde"),
        ("Height", "Højde"),
        ("Swap width and height", "Byt bredde og højde"),
        ("Current resolution", "Aktuel opløsning"),
        ("Reset changes", "Nulstil ændringer"),
        ("Select a resolution supported by the display", "Vælg en opløsning, som skærmen understøtter"),
        ("Display settings changed. Reopen the resolution menu and try again.", "Skærmindstillingerne er ændret. Åbn opløsningsmenuen igen, og prøv igen."),
        ("Closest supported resolution", "Nærmeste understøttede opløsning"),
        ("Adjusted to display limits", "Tilpasset skærmens grænser"),
        ("Local resolution is unavailable or unsupported", "Den lokale opløsning er utilgængelig eller understøttes ikke"),
        ("Looks like", "Ser ud som"),
        ("Rendering quality", "Gengivelseskvalitet"),
        ("Standard", "Standard"),
        ("Enter dimensions within the range", "Angiv dimensioner inden for intervallet"),
        ("Aspect ratio", "Billedformat"),
        ("Available resolutions", "Tilgængelige opløsninger"),
        ("System scaling", "Systemskalering"),
        ("Recommended", "Anbefalet"),
        ("System scaling is unavailable for this display or desktop environment.", "Systemskalering er ikke tilgængelig for denne skærm eller dette skrivebordsmiljø."),
        ("The system did not apply the requested scale. Refresh and try again.", "Systemet anvendte ikke den ønskede skalering. Opdater, og prøv igen."),
        ("Select a scaling level supported by the display.", "Vælg et skaleringsniveau, som skærmen understøtter."),
        ("No permission to change display settings.", "Ingen tilladelse til at ændre skærmindstillinger."),
        ("Invalid display scaling request.", "Ugyldig anmodning om skærmskalering."),
        ("Display settings are busy. Try again.", "Skærmindstillingerne er optaget. Prøv igen."),
        ("Display settings timed out. Refresh and try again.", "Skærmindstillingerne fik timeout. Opdater, og prøv igen."),
        ("Use nearest supported scale", "Brug nærmeste understøttede skalering"),
        ("Scaling was applied, but the resolution request failed.", "Skaleringen blev anvendt, men anmodningen om opløsning mislykkedes."),
        ("Failed to change display settings", "Kunne ikke ændre skærmindstillingerne"),
        ("Remote connection has closed", "Fjernforbindelsen er lukket"),
        ("Failed to resize macOS virtual display", "Kunne ikke ændre størrelsen på den virtuelle macOS-skærm"),
        ("Failed to toggle macOS virtual display", "Kunne ikke slå den virtuelle macOS-skærm til eller fra"),
        ("Failed to start macOS virtual display worker", "Kunne ikke starte arbejdsprocessen for virtuelle macOS-skærme"),
        ("Virtual display dimensions must be between 320 and 4096", "Den virtuelle skærms dimensioner skal være mellem 320 og 4096"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "Den virtuelle skærms skalering skal være 1 eller 2 og dele begge pixeldimensioner uden rest"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "Den virtuelle skærms dimensioner skal være mellem 1 og 4096 logiske pixels"),
        ("Display configuration response is too large.", "Svaret med skærmkonfigurationen er for stort."),
        ("Invalid display scaling response", "Ugyldigt svar om skærmskalering"),
        ("Invalid display scaling levels", "Ugyldige niveauer for skærmskalering"),
        ("Invalid display scaling range", "Ugyldigt interval for skærmskalering"),
        ("Interface size", "Grænsefladestørrelse"),
        ("Current interface size", "Aktuel grænsefladestørrelse"),
    ].iter().cloned().collect();
}
