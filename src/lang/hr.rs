...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Spajanje na TeamDesk mrežu..."),
        ...
        ("install_tip", "Zbog UAC-a TeamDesk ne može u nekim slučajevima raditi pravilno. Da biste prevazišli UAC, kliknite na tipku ispod da instalirate TeamDesk na sustav."),
        ("Click to upgrade", "Klik za nadogradnju"),
        ("Configure", "Konfiguracija"),
        ("config_acc", "Da biste daljinski kontrolirali radnu površinu, TeamDesk-u trebate dodijeliti prava za \"Pristupačnost\"."),
        ("config_screen", "Da biste daljinski pristupili radnoj površini, TeamDesk-u trebate dodijeliti prava za \"Snimanje zaslona\"."),
        ...
        ("android_input_permission_tip1", "Da bi ste daljinski uređaj kontrolirali vašim Android uređajem preko miša ili na dodir, trebate dopustiti TeamDesk-u da koristi servis \"Pristupačnost\"."),
        ("android_input_permission_tip2", "Molimo prijeđite na sljedeću stranicu podešavanja sustava, pronađite i unesite [Instalirani servisi], uključite servis [TeamDesk Input]."),
        ...
        ("Language", "Jezik"),
        ("Keep TeamDesk background service", "Zadrži TeamDesk kao pozadinski servis"),
        ("Ignore Battery Optimizations", "Zanemari optimizaciju baterije"),
        ("android_open_battery_optimizations_tip", "Ako želite onemogućiti ovu funkciju, molimo idite na sljedeću stranicu za podešavanje TeamDesk aplikacije, pronađite i uđite u [Baterija], onemogućite [Neograničeno]"),
        ...
        ("Show TeamDesk", "Prikaži TeamDesk"),
        ...
        ("config_input", "Za upravljanje udaljenom radnom površinom pomoću tipkovnice, morate dodijeliti TeamDesku dopuštenje \"Nadzor unosa\"."),
        ("config_microphone", "Da biste razgovarali na daljinu, morate dopustiti TeamDesku \"Snimanje zvuka\"."),
        ...
        ("still_click_uac_tip", "Još uvijek zahtijeva da udaljeni korisnik klikne OK u UAC prozoru pokrenutog TeamDeska."),
        ...
        ("verify_teamdesk_password_tip", "Provjera lozinke za TeamDesk"),
        ...
        ("scam_text1", "Ako razgovarate telefonom s nekim koga NE POZNAJETE i NE VJERUJETE tko vas je zamolio da koristite i pokrenete TeamDesk, nemojte nastavljati razgovor i odmah spustite slušalicu."),
        ...
        ("upgrade_teamdesk_server_pro_to_{}_tip", "Ažurirajte TeamDesk Server Pro na verziju {} ili noviju!"),
        ...
        ("selinux_tip", "Na vašem uređaju je omogućen SELinux, što može spriječiti TeamDesk da pravilno radi kao upravljana strana."),
        ...
        ("powered_by_me", "Pokreće TeamDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Dopusti vezu samo ako je prozor TeamDeska otvoren"),
        ...
        ("floating_window_tip", "Pomaže u održavanju pozadinskog servisa TeamDeska"),
        ...
        ("upgrade_remote_teamdesk_client_to_{}_tip", "Molimo ažurirajte TeamDesk klijent na verziju {} ili noviju na udaljenoj strani!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Prema zadanim postavkama, TeamDesk provjerava certifikat poslužitelja za protokole koji koriste TLS.\nKada je ova opcija omogućena, TeamDesk će u slučaju neuspjele provjere preskočiti korak provjere i nastaviti."),
        ("Disable UDP", "Onemogući UDP"),
        ("disable-udp-tip", "Određuje hoće li se koristiti samo TCP.\nKada je ova opcija omogućena, TeamDesk više neće koristiti UDP 21116, već će umjesto toga koristiti TCP 21116."),
        ("server-oss-not-support-tip", "NAPOMENA: TeamDesk poslužitelj OSS ne uključuje ovu značajku."),
        ...
        ("TeamDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that TeamDesk can use it", "TeamDesk ne može pristupiti sesiji radne površine na udaljenom uređaju, provjerite radi li sesija i može li je TeamDesk koristiti"),
        ...
        ("TeamDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "TeamDesk nije mogao dobiti upotrebljiv zaslon od XDG Desktop Portala, PipeWire biblioteka je možda prestara"),
        ("TeamDesk could not load a GStreamer component needed for screen capture ({})", "TeamDesk nije mogao učitati GStreamer komponentu potrebnu za snimanje zaslona ({})"),
    ].iter().cloned().collect();
}
