...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Width", "Širina"),
        ("Height", "Visina"),
        ("Swap width and height", "Zamijeni širinu i visinu"),
        ("Current resolution", "Trenutna razlučivost"),
        ("Reset changes", "Poništi promjene"),
        ("Select a resolution supported by the display", "Odaberite razlučivost koju zaslon podržava"),
        ("Display settings changed. Reopen the resolution menu and try again.", "Postavke prikaza su promijenjene. Ponovno otvorite izbornik razlučivosti i pokušajte ponovno."),
        ("Closest supported resolution", "Najbliža podržana razlučivost"),
        ("Adjusted to display limits", "Prilagođeno ograničenjima zaslona"),
        ("Local resolution is unavailable or unsupported", "Lokalna razlučivost nije dostupna ili nije podržana"),
        ("Looks like", "Izgleda kao"),
        ("Rendering quality", "Kvaliteta iscrtavanja"),
        ("Standard", "Standardna"),
        ("Enter dimensions within the range", "Unesite dimenzije unutar dopuštenog raspona"),
        ("Aspect ratio", "Omjer stranica"),
        ("Available resolutions", "Dostupne razlučivosti"),
        ("System scaling", "Sistemsko skaliranje"),
        ("Recommended", "Preporučeno"),
        ("System scaling is unavailable for this display or desktop environment.", "Sistemsko skaliranje nije dostupno za ovaj zaslon ili radno okruženje."),
        ("The system did not apply the requested scale. Refresh and try again.", "Sustav nije primijenio traženi omjer skaliranja. Osvježite i pokušajte ponovno."),
        ("Select a scaling level supported by the display.", "Odaberite razinu skaliranja koju zaslon podržava."),
        ("No permission to change display settings.", "Nemate dopuštenje za promjenu postavki prikaza."),
        ("Invalid display scaling request.", "Nevaljan zahtjev za skaliranje zaslona."),
        ("Display settings are busy. Try again.", "Postavke prikaza su zauzete. Pokušajte ponovno."),
        ("Display settings timed out. Refresh and try again.", "Isteklo je vrijeme čekanja na postavke prikaza. Osvježite i pokušajte ponovno."),
        ("Use nearest supported scale", "Koristi najbliži podržani omjer skaliranja"),
        ("Scaling was applied, but the resolution request failed.", "Skaliranje je primijenjeno, ali zahtjev za razlučivost nije uspio."),
        ("Failed to change display settings", "Promjena postavki prikaza nije uspjela"),
        ("Remote connection has closed", "Udaljena veza je zatvorena"),
        ("Failed to resize macOS virtual display", "Promjena veličine virtualnog zaslona macOS nije uspjela"),
        ("Failed to toggle macOS virtual display", "Uključivanje ili isključivanje virtualnog zaslona macOS nije uspjelo"),
        ("Failed to start macOS virtual display worker", "Pokretanje radnog procesa za virtualne zaslone macOS nije uspjelo"),
        ("Virtual display dimensions must be between 320 and 4096", "Dimenzije virtualnog zaslona moraju biti između 320 i 4096"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "Faktor skaliranja virtualnog zaslona mora biti 1 ili 2 i mora dijeliti obje dimenzije u pikselima bez ostatka"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "Dimenzije virtualnog zaslona moraju biti između 1 i 4096 logičkih piksela"),
        ("Display configuration response is too large.", "Odgovor s konfiguracijom zaslona je prevelik."),
        ("Invalid display scaling response", "Nevaljan odgovor o skaliranju zaslona"),
        ("Invalid display scaling levels", "Nevaljane razine skaliranja zaslona"),
