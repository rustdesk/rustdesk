...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Spajanje na TechDesk mrežu..."),
        ...
        ("install_tip", "Zbog UAC-a TechDesk ne može u nekim slučajevima raditi pravilno. Da biste prevazišli UAC, kliknite na tipku ispod da instalirate TechDesk na sustav."),
        ...
        ("config_acc", "Da biste daljinski kontrolirali radnu površinu, TechDesk-u trebate dodijeliti prava za \"Pristupačnost\"."),
        ("config_screen", "Da biste daljinski pristupili radnoj površini, TechDesk-u trebate dodijeliti prava za \"Snimanje zaslona\"."),
        ...
        ("android_input_permission_tip1", "Da bi ste daljinski uređaj kontrolirali vašim Android uređajem preko miša ili na dodir, trebate dopustiti TechDesk-u da koristi servis \"Pristupačnost\"."),
        ("android_input_permission_tip2", "Molimo prijeđite na sljedeću stranicu podešavanja sustava, pronađite i unesite [Instalirani servisi], uključite servis [TechDesk Input]."),
        ...
        ("Language", "Jezik"),
        ("Keep TechDesk background service", "Zadrži TechDesk kao pozadinski servis"),
        ("Ignore Battery Optimizations", "Zanemari optimizaciju baterije"),
        ("android_open_battery_optimizations_tip", "Ako želite onemogućiti ovu funkciju, molimo idite na sljedeću stranicu za podešavanje TechDesk aplikacije, pronađite i uđite u [Baterija], onemogućite [Neograničeno]"),
        ...
        ("Show TechDesk", "Prikaži TechDesk"),
        ...
        ("config_input", "Za upravljanje udaljenom radnom površinom pomoću tipkovnice, morate dodijeliti TechDesku dopuštenje \"Nadzor unosa\"."),
        ("config_microphone", "Da biste razgovarali na daljinu, morate dopustiti TechDesku \"Snimanje zvuka\"."),
        ...
        ("still_click_uac_tip", "Još uvijek zahtijeva da udaljeni korisnik klikne OK u UAC prozoru pokrenutog TechDeska."),
        ...
        ("verify_techdesk_password_tip", "Provjera lozinke za TechDesk"),
        ...
        ("scam_text1", "Ako razgovarate telefonom s nekim koga NE POZNAJETE i NE VJERUJETE tko vas je zamolio da koristite i pokrenete TechDesk, nemojte nastavljati razgovor i odmah spustite slušalicu."),
        ...
        ("upgrade_techdesk_server_pro_to_{}_tip", "Ažurirajte TechDesk Server Pro na verziju {} ili noviju!"),
        ...
        ("selinux_tip", "Na vašem uređaju je omogućen SELinux, što može spriječiti TechDesk da pravilno radi kao upravljana strana."),
        ...
        ("powered_by_me", "Pokreće TechDesk"),
        ...
        ("upgrade_remote_techdesk_client_to_{}_tip", "Molimo ažurirajte TechDesk klijent na verziju {} ili noviju na udaljenoj strani!"),
