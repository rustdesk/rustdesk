...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Width", "ความกว้าง"),
        ("Height", "ความสูง"),
        ("Swap width and height", "สลับความกว้างและความสูง"),
        ("Current resolution", "ความละเอียดปัจจุบัน"),
        ("Reset changes", "รีเซ็ตการเปลี่ยนแปลง"),
        ("Select a resolution supported by the display", "เลือกความละเอียดที่จอแสดงผลรองรับ"),
        ("Display settings changed. Reopen the resolution menu and try again.", "การตั้งค่าแสดงผลเปลี่ยนไปแล้ว โปรดเปิดเมนูความละเอียดอีกครั้งแล้วลองใหม่"),
        ("Closest supported resolution", "ความละเอียดที่รองรับใกล้เคียงที่สุด"),
        ("Adjusted to display limits", "ปรับตามข้อจำกัดของจอแสดงผลแล้ว"),
        ("Local resolution is unavailable or unsupported", "ไม่สามารถใช้ความละเอียดของเครื่องนี้ได้ หรือไม่รองรับ"),
        ("Looks like", "แสดงผลเสมือน"),
        ("Rendering quality", "คุณภาพการเรนเดอร์"),
        ("Standard", "มาตรฐาน"),
        ("Enter dimensions within the range", "ป้อนขนาดภายในช่วงที่กำหนด"),
        ("Aspect ratio", "อัตราส่วนภาพ"),
        ("Available resolutions", "ความละเอียดที่ใช้ได้"),
        ("System scaling", "มาตราส่วนระบบ"),
        ("Recommended", "แนะนำ"),
        ("System scaling is unavailable for this display or desktop environment.", "ไม่สามารถใช้มาตราส่วนระบบกับจอแสดงผลหรือสภาพแวดล้อมเดสก์ท็อปนี้ได้"),
        ("The system did not apply the requested scale. Refresh and try again.", "ระบบไม่ได้ใช้มาตราส่วนที่ร้องขอ โปรดรีเฟรชแล้วลองอีกครั้ง"),
        ("Select a scaling level supported by the display.", "เลือกระดับมาตราส่วนที่จอแสดงผลรองรับ"),
        ("No permission to change display settings.", "ไม่มีสิทธิ์เปลี่ยนการตั้งค่าแสดงผล"),
        ("Invalid display scaling request.", "คำขอมาตราส่วนจอแสดงผลไม่ถูกต้อง"),
        ("Display settings are busy. Try again.", "การตั้งค่าแสดงผลกำลังทำงานอยู่ โปรดลองอีกครั้ง"),
        ("Display settings timed out. Refresh and try again.", "การตั้งค่าแสดงผลหมดเวลารอ โปรดรีเฟรชแล้วลองอีกครั้ง"),
        ("Use nearest supported scale", "ใช้มาตราส่วนที่รองรับใกล้เคียงที่สุด"),
        ("Scaling was applied, but the resolution request failed.", "ใช้มาตราส่วนแล้ว แต่คำขอความละเอียดล้มเหลว"),
        ("Failed to change display settings", "เปลี่ยนการตั้งค่าแสดงผลไม่สำเร็จ"),
        ("Remote connection has closed", "การเชื่อมต่อระยะไกลถูกปิดแล้ว"),
        ("Failed to resize macOS virtual display", "ปรับขนาดจอแสดงผลเสมือน macOS ไม่สำเร็จ"),
        ("Failed to toggle macOS virtual display", "เปิดหรือปิดจอแสดงผลเสมือน macOS ไม่สำเร็จ"),
        ("Failed to start macOS virtual display worker", "เริ่มเธรดทำงานของจอแสดงผลเสมือน macOS ไม่สำเร็จ"),
        ("Virtual display dimensions must be between 320 and 4096", "ขนาดจอแสดงผลเสมือนต้องอยู่ระหว่าง 320 ถึง 4096"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "มาตราส่วนจอแสดงผลเสมือนต้องเป็น 1 หรือ 2 และต้องหารขนาดพิกเซลทั้งสองด้านได้ลงตัว"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "ขนาดจอแสดงผลเสมือนต้องอยู่ระหว่าง 1 ถึง 4096 พิกเซลเชิงตรรกะ"),
        ("Display configuration response is too large.", "การตอบกลับการกำหนดค่าจอแสดงผลมีขนาดใหญ่เกินไป"),
        ("Invalid display scaling response", "การตอบกลับมาตราส่วนจอแสดงผลไม่ถูกต้อง"),
        ("Invalid display scaling levels", "ระดับมาตราส่วนจอแสดงผลไม่ถูกต้อง"),
