...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Σύνδεση στο δίκτυο TechDesk..."),
        ...
        ("install_tip", "Λόγω UAC, το TechDesk ενδέχεται να μην λειτουργεί σωστά σε ορισμένες περιπτώσεις. Για να αποφύγετε το UAC, κάντε κλικ στο κουμπί παρακάτω για να εγκαταστήσετε το TechDesk στο σύστημα"),
        ("Click to upgrade", "Αναβάθμιση τώρα"),
        ("Click to download", "Λήψη τώρα"),
        ("Click to update", "Ενημέρωση τώρα"),
        ("Configure", "Διαμόρφωση"),
        ("config_acc", "Για τον απομακρυσμένο έλεγχο του υπολογιστή σας, πρέπει να εκχωρήσετε δικαιώματα πρόσβασης στο TechDesk."),
        ("config_screen", "Για να αποκτήσετε απομακρυσμένη πρόσβαση στον υπολογιστή σας, πρέπει να εκχωρήσετε το δικαίωμα TechDesk \"Screen Capture\"."),
        ...
        ("android_input_permission_tip1", "Για να μπορεί μία απομακρυσμένη συσκευή να ελέγχει τη συσκευή σας Android, πρέπει να επιτρέψετε στο TechDesk να χρησιμοποιεί την υπηρεσία \"Προσβασιμότητα\"."),
        ("android_input_permission_tip2", "Παρακαλώ μεταβείτε στην επόμενη σελίδα ρυθμίσεων συστήματος, βρείτε και πληκτρολογήστε [Εγκατεστημένες υπηρεσίες], ενεργοποιήστε την υπηρεσία [Είσοδος TechDesk]."),
        ...
        ("Language", "Γλώσσα"),
        ("Keep TechDesk background service", "Εκτέλεση του TechDesk στο παρασκήνιο"),
        ...
        ("Show TechDesk", "Εμφάνιση TechDesk"),
        ...
        ("config_input", "Για να ελέγξετε την απομακρυσμένη επιφάνεια εργασίας με πληκτρολόγιο, πρέπει να εκχωρήσετε δικαιώματα στο TechDesk"),
        ...
        ("still_click_uac_tip", "Εξακολουθεί να απαιτεί από τον απομακρυσμένο χρήστη να κάνει κλικ στο OK στο παράθυρο UAC όπου εκτελείται το TechDesk."),
        ...
        ("verify_techdesk_password_tip", "Επιβεβαιώστε τον κωδικό του TechDesk"),
        ...
        ("scam_text1", "Αν σας καλέσει κάποιος τον οποίο ΔΕΝ γνωρίζεται και ΔΕΝ ΕΜΠΙΣΤΕΥΕΣΤΕ, και σας ζητήσει να ανοίξετε το TechDesk, και να του πείτε τα στοιχεία που εμφανίζει, ΜΗΝ συνεχίσετε και κλείστε το τηλέφωνο ΑΜΕΣΩΣ."),
        ...
        ("upgrade_techdesk_server_pro_to_{}_tip", "Παρακαλώ ενημερώστε τον TechDesk Server Pro στην έκδοση {} ή νεότερη!"),
        ...
        ("selinux_tip", "Έχετε ενεργοποιημένο το SELinux, το οποίο πιθανόν εμποδίζει την ορθή λειτουργία του TechDesk."),
        ...
        ("powered_by_me", "Με την υποστήριξη της TechDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Να επιτρέπεται η σύνδεση μόνο εάν το παράθυρο TechDesk είναι ανοιχτό"),
        ...
        ("During service is on", "Κατα την εκκίνηση της υπηρεσίας Techdesk"),
        ...
        ("About TechDesk", "Πληροφορίες για το TechDesk"),
        ...
        ("upgrade_remote_techdesk_client_to_{}_tip", "Αναβαθμίστε τον πελάτη TechDesk στην έκδοση {} ή νεότερη στην απομακρυσμένη πλευρά!"),
