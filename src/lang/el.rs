...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Output resolution", "Ανάλυση εξόδου"),
        ("Width", "Πλάτος"),
        ("Height", "Ύψος"),
        ("Swap width and height", "Εναλλαγή πλάτους και ύψους"),
        ("Current resolution", "Τρέχουσα ανάλυση"),
        ("Reset changes", "Επαναφορά αλλαγών"),
        ("Select a resolution supported by the display", "Επιλέξτε ανάλυση που υποστηρίζεται από την οθόνη"),
        ("Display settings changed. Reopen the resolution menu and try again.", "Οι ρυθμίσεις οθόνης άλλαξαν. Ανοίξτε ξανά το μενού ανάλυσης και δοκιμάστε ξανά."),
        ("Closest supported resolution", "Πλησιέστερη υποστηριζόμενη ανάλυση"),
        ("Adjusted to display limits", "Προσαρμόστηκε στα όρια της οθόνης"),
        ("Local resolution is unavailable or unsupported", "Η τοπική ανάλυση δεν είναι διαθέσιμη ή δεν υποστηρίζεται"),
        ("Looks like", "Μοιάζει με"),
        ("Rendering quality", "Ποιότητα απόδοσης"),
        ("Standard", "Τυπική"),
        ("Enter dimensions within the range", "Εισαγάγετε διαστάσεις εντός του εύρους"),
        ("Aspect ratio", "Αναλογία διαστάσεων"),
        ("Available resolutions", "Διαθέσιμες αναλύσεις"),
        ("System scaling", "Κλιμάκωση συστήματος"),
        ("Recommended", "Προτείνεται"),
        ("System scaling is unavailable for this display or desktop environment.", "Η κλιμάκωση συστήματος δεν είναι διαθέσιμη για αυτή την οθόνη ή το περιβάλλον επιφάνειας εργασίας."),
        ("The system did not apply the requested scale. Refresh and try again.", "Το σύστημα δεν εφάρμοσε την κλίμακα που ζητήθηκε. Ανανεώστε και δοκιμάστε ξανά."),
        ("Select a scaling level supported by the display.", "Επιλέξτε επίπεδο κλιμάκωσης που υποστηρίζεται από την οθόνη."),
        ("No permission to change display settings.", "Δεν έχετε άδεια αλλαγής των ρυθμίσεων οθόνης."),
        ("Invalid display scaling request.", "Μη έγκυρο αίτημα κλιμάκωσης οθόνης."),
        ("Display settings are busy. Try again.", "Οι ρυθμίσεις οθόνης είναι απασχολημένες. Δοκιμάστε ξανά."),
        ("Display settings timed out. Refresh and try again.", "Έληξε το χρονικό όριο των ρυθμίσεων οθόνης. Ανανεώστε και δοκιμάστε ξανά."),
        ("Use nearest supported scale", "Χρήση της πλησιέστερης υποστηριζόμενης κλίμακας"),
        ("Scaling was applied, but the resolution request failed.", "Η κλίμακα εφαρμόστηκε, αλλά το αίτημα ανάλυσης απέτυχε."),
        ("Failed to change display settings", "Αποτυχία αλλαγής των ρυθμίσεων οθόνης"),
        ("Remote connection has closed", "Η απομακρυσμένη σύνδεση έκλεισε"),
        ("Failed to resize macOS virtual display", "Αποτυχία αλλαγής μεγέθους της εικονικής οθόνης macOS"),
        ("Failed to toggle macOS virtual display", "Αποτυχία ενεργοποίησης ή απενεργοποίησης της εικονικής οθόνης macOS"),
        ("Failed to start macOS virtual display worker", "Αποτυχία εκκίνησης της διεργασίας εικονικών οθονών macOS"),
        ("Virtual display dimensions must be between 320 and 4096", "Οι διαστάσεις της εικονικής οθόνης πρέπει να είναι μεταξύ 320 και 4096"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "Η κλίμακα της εικονικής οθόνης πρέπει να είναι 1 ή 2 και να διαιρεί ακριβώς και τις δύο διαστάσεις σε εικονοστοιχεία"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "Οι διαστάσεις της εικονικής οθόνης πρέπει να είναι μεταξύ 1 και 4096 λογικών εικονοστοιχείων"),
        ("Display configuration response is too large.", "Η απόκριση διαμόρφωσης οθόνης είναι πολύ μεγάλη."),
        ("Invalid display scaling response", "Μη έγκυρη απόκριση κλιμάκωσης οθόνης"),
        ("Invalid display scaling levels", "Μη έγκυρα επίπεδα κλιμάκωσης οθόνης"),
        ("Invalid display scaling range", "Μη έγκυρο εύρος κλιμάκωσης οθόνης"),
        ("Interface size", "Μέγεθος διεπαφής"),
        ("Current interface size", "Τρέχον μέγεθος διεπαφής"),
    ].iter().cloned().collect();
}
