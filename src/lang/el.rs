...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("drm_capture_tip", "Η άμεση λήψη DRM/KMS είναι διαθέσιμη — δεν απαιτείται συγκατάθεση πύλης. Υποστηρίζει πρόσβαση χωρίς επιτήρηση και λήψη της οθόνης σύνδεσης."),
