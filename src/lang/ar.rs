...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Width", "العرض"),
        ("Height", "الارتفاع"),
        ("Swap width and height", "تبديل العرض والارتفاع"),
        ("Current resolution", "الدقة الحالية"),
        ("Reset changes", "إعادة تعيين التغييرات"),
        ("Select a resolution supported by the display", "اختر دقة تدعمها الشاشة"),
        ("Display settings changed. Reopen the resolution menu and try again.", "تغيرت إعدادات العرض. أعد فتح قائمة الدقة وحاول مرة أخرى."),
        ("Closest supported resolution", "أقرب دقة مدعومة"),
        ("Adjusted to display limits", "تم الضبط وفق حدود الشاشة"),
        ("Local resolution is unavailable or unsupported", "الدقة المحلية غير متاحة أو غير مدعومة"),
        ("Looks like", "يبدو مثل"),
        ("Rendering quality", "جودة التصيير"),
        ("Standard", "قياسية"),
        ("Enter dimensions within the range", "أدخل أبعادًا ضمن النطاق"),
        ("Aspect ratio", "نسبة العرض إلى الارتفاع"),
        ("Available resolutions", "الدقات المتاحة"),
        ("System scaling", "تحجيم النظام"),
        ("Recommended", "موصى به"),
        ("System scaling is unavailable for this display or desktop environment.", "تحجيم النظام غير متاح لهذه الشاشة أو بيئة سطح المكتب."),
        ("The system did not apply the requested scale. Refresh and try again.", "لم يطبّق النظام المقياس المطلوب. حدّث وحاول مرة أخرى."),
        ("Select a scaling level supported by the display.", "اختر مستوى تحجيم تدعمه الشاشة."),
        ("No permission to change display settings.", "ليس لديك إذن لتغيير إعدادات العرض."),
        ("Invalid display scaling request.", "طلب تحجيم العرض غير صالح."),
        ("Display settings are busy. Try again.", "إعدادات العرض مشغولة. حاول مرة أخرى."),
        ("Display settings timed out. Refresh and try again.", "انتهت مهلة إعدادات العرض. حدّث وحاول مرة أخرى."),
        ("Use nearest supported scale", "استخدام أقرب مقياس مدعوم"),
        ("Scaling was applied, but the resolution request failed.", "تم تطبيق المقياس، لكن طلب الدقة فشل."),
        ("Failed to change display settings", "تعذر تغيير إعدادات العرض"),
        ("Remote connection has closed", "تم إغلاق الاتصال البعيد"),
        ("Failed to resize macOS virtual display", "تعذر تغيير حجم الشاشة الافتراضية في macOS"),
        ("Failed to toggle macOS virtual display", "تعذر تفعيل الشاشة الافتراضية في macOS أو تعطيلها"),
        ("Failed to start macOS virtual display worker", "تعذر بدء خيط العمل للشاشات الافتراضية في macOS"),
        ("Virtual display dimensions must be between 320 and 4096", "يجب أن تكون أبعاد الشاشة الافتراضية بين 320 و4096"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "يجب أن يكون مقياس الشاشة الافتراضية 1 أو 2 وأن يقسم كلا البعدين بالبكسل دون باقٍ"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "يجب أن تكون أبعاد الشاشة الافتراضية بين 1 و4096 بكسل منطقي"),
        ("Display configuration response is too large.", "استجابة إعداد العرض كبيرة جدًا."),
        ("Invalid display scaling response", "استجابة تحجيم العرض غير صالحة"),
        ("Invalid display scaling levels", "مستويات تحجيم العرض غير صالحة"),
