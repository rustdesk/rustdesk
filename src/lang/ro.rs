...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "În curs de conectare la rețeaua TeamDesk..."),
        ...
        ("install_tip", "Din cauza restricțiilor CCU, este posibil ca TeamDesk să nu funcționeze corespunzător. Pentru a evita acest lucru, dă clic pe butonul de mai jos pentru a instala TeamDesk."),
        ("Click to upgrade", "Dă clic pentru a face upgrade"),
        ("Configure", "Configurează"),
        ("config_acc", "Pentru a controla desktopul la distanță, trebuie să permiți TeamDesk acces la setările de Accesibilitate."),
        ("config_screen", "Pentru a controla desktopul la distanță, trebuie să permiți TeamDesk acces la setările de Înregistrare ecran."),
        ...
        ("android_input_permission_tip1", "Pentru ca un dispozitiv la distanță să poată controla un dispozitiv Android folosind mouse-ul sau suportul tactil, trebuie să permiți TeamDesk să utilizeze serviciul „Accesibilitate\"."),
        ("android_input_permission_tip2", "Accesează următoarea pagină din Setări, deschide [Aplicații instalate] și pornește serviciul [TeamDesk Input]."),
        ...
        ("Turned off", "Închis"),
        ("Language", "Limbă"),
        ("Keep TeamDesk background service", "Rulează serviciul TeamDesk în fundal"),
        ("Ignore Battery Optimizations", "Ignoră optimizările de baterie"),
        ("android_open_battery_optimizations_tip", "Pentru dezactivarea acestei funcții, accesează setările aplicației TeamDesk, deschide secțiunea [Baterie] și deselectează [Fără restricții]."),
        ...
        ("Show TeamDesk", "Afișează TeamDesk"),
        ("This PC", "Acest PC"),
        ("or", "sau"),
        ...
        ("config_input", "Pentru a controla desktopul la distanță folosind tastatura, trebuie să acorzi TeamDesk permisiunea Monitorizare intrare"),
        ("config_microphone", "Pentru a desfășura un apel vocal, este nevoie să acorzi TeamDesk permisiunea Înregistrare audio."),
        ...
        ("still_click_uac_tip", "Este necesar ca utilizatorul la distanță să confirme în fereastra CCU din TeamDesk care rulează."),
        ...
        ("verify_teamdesk_password_tip", "Verifică parola TeamDesk"),
        ...
        ("scam_text1", "Escrocii se pot da drept angajați ai asistenței tehnice și îți pot solicita să instalezi sau să rulezi TeamDesk pentru a-ți accesa dispozitivul."),
        ...
        ("upgrade_teamdesk_server_pro_to_{}_tip", "Versiunea serverului TeamDesk Pro este mai mică decât {}. Te rugăm să o actualizezi."),
        ...
        ("input_source_2_tip", "Sursă de intrare 2 — folosește driver-ul TeamDesk pentru simulare la nivel de kernel"),
        ...
        ("powered_by_me", "Realizat cu TeamDesk"),
        ...
        ("ab_web_console_tip", "Gestionează agenda prin consola web TeamDesk Pro."),
        ...
        ("enable-bot-desc", "Configurează un bot Telegram pentru notificări TeamDesk. Introdu token-ul botului și ID-ul chat-ului."),
        ...
        ("About TeamDesk", "Despre TeamDesk"),
        ...
        ("web_id_input_tip", "Introdu ID-ul TeamDesk al dispozitivului la care vrei să te conectezi"),
        ("Download", "Descarcă"),
        ...
        ("upgrade_remote_teamdesk_client_to_{}_tip", "Versiunea clientului TeamDesk de la distanță este mai mică decât {}. Te rugăm să o actualizezi pentru o compatibilitate completă."),
        ...
        ("server-oss-not-support-tip", "Serverul open-source nu suportă această funcție. Folosește TeamDesk Pro pentru funcționalitate completă."),
        ...
        ("TeamDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that TeamDesk can use it", "TeamDesk nu poate accesa sesiunea de desktop de pe dispozitivul de la distanță, verificați dacă o sesiune rulează și dacă TeamDesk o poate folosi"),
        ...
        ("TeamDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "TeamDesk nu a putut obține un ecran utilizabil de la XDG Desktop Portal, biblioteca PipeWire poate fi prea veche"),
        ("TeamDesk could not load a GStreamer component needed for screen capture ({})", "TeamDesk nu a putut încărca o componentă GStreamer necesară pentru capturarea ecranului ({})"),
    ].iter().cloned().collect();
}
