...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("drm_capture_tip", "Captura directă DRM/KMS este activă — nu este necesar consimțământul portalului. Funcționează nesupravegheat și pe ecranul de autentificare."),
