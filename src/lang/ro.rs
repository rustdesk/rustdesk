...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Output resolution", "Rezoluție de ieșire"),
        ("Width", "Lățime"),
        ("Height", "Înălțime"),
        ("Swap width and height", "Inversează lățimea și înălțimea"),
        ("Current resolution", "Rezoluție curentă"),
        ("Reset changes", "Resetează modificările"),
        ("Select a resolution supported by the display", "Selectați o rezoluție acceptată de afișaj"),
        ("Display settings changed. Reopen the resolution menu and try again.", "Setările afișajului s-au schimbat. Redeschideți meniul de rezoluție și încercați din nou."),
        ("Closest supported resolution", "Cea mai apropiată rezoluție acceptată"),
        ("Adjusted to display limits", "Ajustat la limitele afișajului"),
        ("Local resolution is unavailable or unsupported", "Rezoluția locală nu este disponibilă sau nu este acceptată"),
        ("Looks like", "Arată ca"),
        ("Rendering quality", "Calitatea randării"),
        ("Standard", "Standard"),
        ("Enter dimensions within the range", "Introduceți dimensiuni în intervalul permis"),
        ("Aspect ratio", "Raport de aspect"),
        ("Available resolutions", "Rezoluții disponibile"),
        ("System scaling", "Scalare de sistem"),
        ("Recommended", "Recomandat"),
        ("System scaling is unavailable for this display or desktop environment.", "Scalarea de sistem nu este disponibilă pentru acest afișaj sau mediu desktop."),
        ("The system did not apply the requested scale. Refresh and try again.", "Sistemul nu a aplicat scala solicitată. Reîmprospătați și încercați din nou."),
        ("Select a scaling level supported by the display.", "Selectați un nivel de scalare acceptat de afișaj."),
        ("No permission to change display settings.", "Nu aveți permisiunea de a modifica setările afișajului."),
        ("Invalid display scaling request.", "Solicitare de scalare a afișajului nevalidă."),
        ("Display settings are busy. Try again.", "Setările afișajului sunt ocupate. Încercați din nou."),
        ("Display settings timed out. Refresh and try again.", "Timpul de așteptare pentru setările afișajului a expirat. Reîmprospătați și încercați din nou."),
        ("Use nearest supported scale", "Folosește cea mai apropiată scală acceptată"),
        ("Scaling was applied, but the resolution request failed.", "Scala a fost aplicată, dar solicitarea de rezoluție a eșuat."),
        ("Failed to change display settings", "Nu s-au putut modifica setările afișajului"),
        ("Remote connection has closed", "Conexiunea la distanță a fost închisă"),
        ("Failed to resize macOS virtual display", "Nu s-a putut redimensiona afișajul virtual macOS"),
        ("Failed to toggle macOS virtual display", "Nu s-a putut activa sau dezactiva afișajul virtual macOS"),
        ("Failed to start macOS virtual display worker", "Nu s-a putut porni procesul de lucru pentru afișajele virtuale macOS"),
        ("Virtual display dimensions must be between 320 and 4096", "Dimensiunile afișajului virtual trebuie să fie între 320 și 4096"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "Scala afișajului virtual trebuie să fie 1 sau 2 și să împartă exact ambele dimensiuni în pixeli"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "Dimensiunile afișajului virtual trebuie să fie între 1 și 4096 de pixeli logici"),
        ("Display configuration response is too large.", "Răspunsul cu configurația afișajului este prea mare."),
        ("Invalid display scaling response", "Răspuns de scalare a afișajului nevalid"),
        ("Invalid display scaling levels", "Niveluri de scalare a afișajului nevalide"),
        ("Invalid display scaling range", "Interval de scalare a afișajului nevalid"),
        ("Interface size", "Dimensiunea interfeței"),
        ("Current interface size", "Dimensiunea curentă a interfeței"),
    ].iter().cloned().collect();
}
