lazy_static::lazy_static! {
    pub static ref T: std::collections::HashMap<&'static str, &'static str> =
        [
            ...
            ("verification_tip", "Introduceți codul de verificare pentru a continua."),
            ...
            ("android_permission_may_not_change_tip", "Permisiunile Android s-ar putea să nu se schimbe după setare."),
            ("Account", "Cont"),
            ...
            ("Open connection in new tab", "Deschide conexiunea într-un filă nouă"),
            ...
            ("pull_ab_failed_tip", "Eroare la sincronizarea agendei."),
            ("push_ab_failed_tip", "Eroare la actualizarea agendei."),
            ("synced_peer_readded_tip", "Dispozitivul pereche sincronizat a fost adăugat din nou."),
            ...
            ("Reverse mouse wheel", "Inversează rotița mouse-ului"),
            ("{} sessions", "{} sesiuni"),
            ("scam_title", "Atenție la scamă!"),
            ("scam_text1", "Ați primit o solicitare suspectă de conectare."),
            ("scam_text2", "Verificați autenticitatea dispozitivului înainte de a continua."),
            ("Don't show again", "Nu mai afișa"),
            ("I Agree", "Sunt de acord"),
            ("Decline", "Respinge"),
            ("Timeout in minutes", "Timp de expirare în minute"),
            ("auto_disconnect_option_tip", "Opțiunea de deconectare automată va închide conexiunea după perioada specificată de inactivitate."),
            ...
            ("upgrade_rustdesk_server_pro_to_{}_tip", "Actualizează serverul RustDesk Pro la versiunea {} pentru funcționalități suplimentare."),
            ("pull_group_failed_tip", "Eroare la sincronizarea grupului."),
            ("Filter by intersection", "Filtrează după intersecție"),
            ("Remove wallpaper during incoming sessions", "Elimină fundalul ecranului în timpul sesiunilor de intrare"),
            ("Test", "Testează"),
            ("display_is_plugged_out_msg", "Display-ul este deconectat."),
            ("No displays", "Niciun display"),
            ("Open in new window", "Deschide într-o fereastră nouă"),
            ("Show displays as individual windows", "Afișează display-urile ca ferestre individuale"),
            ("Use all my displays for the remote session", "Folosește toate display-urile pentru sesiunea la distanță"),
            ("selinux_tip", "Asigurați-vă că SELinux este configurat corect pentru a permite conexiuni la distanță."),
            ...
            ("True color (4:4:4)", "Culoare reală (4:4:4)"),
            ("Enable blocking user input", "Activează blocarea introducerii utilizatorului"),
            ("id_input_tip", "Introduceți ID-ul dispozitivului pentru a stabili conexiunea."),
            ("privacy_mode_impl_mag_tip", "Modul de confidențialitate este implementat pentru a proteja datele utilizatorului."),
            ("privacy_mode_impl_virtual_display_tip", "Modul de confidențialitate utilizează un display virtual pentru a asigura securitatea datelor."),
            ("Enter privacy mode", "Intră în modul confidențialitate"),
            ("Exit privacy mode", "Ieşire din modul confidențialitate"),
            ("idd_not_support_under_win10_2004_tip", "IDD nu este suportat în versiunile Windows 10 anterioare versiunii 2004."),
            ("input_source_1_tip", "Sursa de intrare 1: Tastatură"),
            ("input_source_2_tip", "Sursa de intrare 2: Mouse"),
            ("Swap control-command key", "Inversează tastele Control și Command"),
            ("swap-left-right-mouse", "Inversează butoanele stânga-dreapta ale mouse-ului"),
            ("2FA code", "Cod 2FA"),
            ("More", "Mai multe"),
            ("enable-2fa-title", "Activează autentificarea cu doi factori"),
            ("enable-2fa-desc", "Adaugă un nivel suplimentar de securitate prin autentificare cu doi factori."),
            ("wrong-2fa-code", "Cod 2FA incorect."),
            ("enter-2fa-title", "Introdu codul 2FA"),
            ("Email verification code must be 6 characters.", "Codul de verificare prin email trebuie să aibă 6 caractere."),
            ("2FA code must be 6 digits.", "Codul 2FA trebuie să aibă 6 cifre."),
            ("Multiple Windows sessions found", "Au fost găsite mai multe sesiuni Windows"),
            ("Please select the session you want to connect to", "Selectează sesiunea la care dorești să te conectezi"),
            ("powered_by_me", "Propulsat de mine"),
            ("outgoing_only_desk_tip", "Sesiunile doar de ieșire sunt permise."),
            ("preset_password_warning", "Atenție: Parola presetată poate compromite securitatea."),
            ...
            ("share_warning_tip", "Atenție: Partajarea desktopului poate expune informații sensibile."),
            ("Everyone", "Toată lumea"),
            ("ab_web_console_tip", "Consola web a agendei permite gestionarea dispozitivelor dintr-o interfață online."),
            ("allow-only-conn-window-open-tip", "Permite deschiderea doar a ferestrei de conexiune."),
            ("no_need_privacy_mode_no_physical_displays_tip", "Nu este necesar modul de confidențialitate deoarece nu sunt display-uri fizice conectate."),
            ("Follow remote cursor", "Urmează cursorul la distanță"),
            ("Follow remote window focus", "Urmează focalizarea ferestrei la distanță"),
            ("default_proxy_tip", "Setează proxy-ul implicit pentru toate conexiunile."),
            ("no_audio_input_device_tip", "Niciun dispozitiv de intrare audio detectat."),
            ("Incoming", "Intrare"),
            ("Outgoing", "Ieșire"),
            ("Clear Wayland screen selection", "Curăță selecția ecranului Wayland"),
            ("clear_Wayland_screen_selection_tip", "Curăță selecția ecranului pentru Wayland pentru a reinițializa partajarea."),
            ("confirm_clear_Wayland_screen_selection_tip", "Ești sigur că dorești să cureți selecția ecranului Wayland?"),
            ("android_new_voice_call_tip", "Ai primit un apel vocal nou pe dispozitivul Android."),
            ("texture_render_tip", "Randarea texturilor îmbunătățește performanța grafică."),
            ("Use texture rendering", "Folosește randarea texturilor"),
            ("Floating window", "Fereastră plutitoare"),
            ("floating_window_tip", "Activând fereastra plutitoare, poți gestiona conexiunea într-o fereastră separată."),
            ("Keep screen on", "Păstrează ecranul pornit"),
            ("Never", "Niciodată"),
            ...
            ("enable-bot-tip", "Activează botul Telegram pentru notificări și control."),
            ("enable-bot-desc", "Integrează botul Telegram pentru a primi actualizări și a gestiona conexiunile."),
            ("cancel-2fa-confirm-tip", "Ești sigur că dorești să anulezi autentificarea cu doi factori?"),
            ("cancel-bot-confirm-tip", "Ești sigur că dorești să dezactivezi botul Telegram?"),
            ("About RustDesk", "Despre RustDesk"),
            ("Send clipboard keystrokes", "Trimite secvențe de taste din clipboard"),
            ("network_error_tip", "A apărut o eroare de rețea. Verifică conexiunea și încearcă din nou."),
            ...
            ("enable-trusted-devices-tip", "Activează dispozitivele de încredere pentru a permite conectări automate fără autentificare suplimentară."),
            ("Parent directory", "Director părinte"),
            ("Resume", "Relansează"),
            ("Invalid file name", "Nume de fișier nevalid"),
            ("one-way-file-transfer-tip", "Transferul de fișiere este unidirecțional. Fișierele vor fi trimise doar în această direcție."),
            ("Authentication Required", "Autentificare necesară"),
            ("Authenticate", "Autentifică-te"),
            ("web_id_input_tip", "Introduceți ID-ul web pentru a stabili conexiunea."),
            ("Download", "Descarcă"),
            ...
            ("Untagged", "Fără etichete"),
            ("new-version-of-{}-tip", "Este disponibilă o versiune nouă de {}. Actualizează pentru a beneficia de ultimele funcționalități."),
        ].iter().cloned().collect();
}
