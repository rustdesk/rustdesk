...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "În curs de conectare la rețeaua TechDesk..."),
        ...
        ("install_tip", "Din cauza restricțiilor CCU, este posibil ca TechDesk să nu funcționeze corespunzător. Pentru a evita acest lucru, dă clic pe butonul de mai jos pentru a instala TechDesk."),
        ...
        ("config_acc", "Pentru a controla desktopul la distanță, trebuie să permiți TechDesk acces la setările de Accesibilitate."),
        ("config_screen", "Pentru a controla desktopul la distanță, trebuie să permiți TechDesk acces la setările de Înregistrare ecran."),
        ...
        ("android_input_permission_tip1", "Pentru ca un dispozitiv la distanță să poată controla un dispozitiv Android folosind mouse-ul sau suportul tactil, trebuie să permiți TechDesk să utilize serviciul „Accesibilitate”."),
        ("android_input_permission_tip2", "Accesează următoarea pagină din Setări, deschide [Aplicații instalate] și pornește serviciul [TechDesk Input]."),
        ...
        ("Turned off", "Închis"),
        ("Language", "Limbă"),
        ("Keep TechDesk background service", "Rulează serviciul TechDesk în fundal"),
        ("Ignore Battery Optimizations", "Ignoră optimizările de baterie"),
        ("android_open_battery_optimizations_tip", "Pentru dezactivarea acestei funcții, accesează setările aplicației TechDesk, deschide secțiunea [Baterie] și deselectează [Fără restricții]."),
        ...
        ("Show TechDesk", "Afișează TechDesk"),
        ("This PC", "Acest PC"),
        ("or", "sau"),
        ...
        ("config_input", "Pentru a controla desktopul la distanță folosind tastatura, trebuie să acorzi TechDesk permisiunea Monitorizare intrare"),
        ("config_microphone", "Pentru a desfășura un apel vocal, este nevoie să acorzi TechDesk permisiunea Înregistrare audio."),
        ...
        ("still_click_uac_tip", "Este necesar ca utilizatorul la distanță să confirme în fereastra CCU din TechDesk care rulează."),
        ...
        ("verify_techdesk_password_tip", "Verifică parola TechDesk"),
        ...
        ("upgrade_techdesk_server_pro_to_{}_tip", ""),
        ...
        ("upgrade_remote_techdesk_client_to_{}_tip", ""),
