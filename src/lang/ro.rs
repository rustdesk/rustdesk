...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verification_tip", "Te rugăm să verifici informațiile introduse."),
        ...
        ("android_permission_may_not_change_tip", "Permisiunile Android ar putea să nu se poată modifica"),
        ("Account", "Cont"),
        ...
        ("Automatically record outgoing sessions", "Înregistrează automat sesiunile ieșite"),
        ("Change", "Modifică"),
        ...
        ("Start", "Începe"),
        ("Stop", "Oprește"),
        ("exceed_max_devices", "Depășește numărul maxim de dispozitive"),
        ("Sync with recent sessions", "Sincronizează cu sesiunile recente"),
        ("Sort tags", "Sortează etichetele"),
        ("Open connection in new tab", "Deschide conexiunea în tab nou"),
        ("Move tab to new window", "Mută tab-ul într-o fereastră nouă"),
        ("Can not be empty", "Nu poate fi gol"),
        ("Already exists", "Există deja"),
        ("Change Password", "Schimbă Parola"),
        ("Refresh Password", "Actualizează Parola"),
        ("ID", "ID"),
        ("Grid View", "Vizualizare Grilă"),
        ("List View", "Vizualizare Listă"),
        ("Select", "Selectează"),
        ("Toggle Tags", "Comută Etichetele"),
        ("pull_ab_failed_tip", "Eșec la extragerea adresei"),
        ("push_ab_failed_tip", "Eșec la trimiterea adresei"),
        ("synced_peer_readded_tip", "Perechea sincronizată a fost adăugată din nou"),
        ("Change Color", "Schimbă Culoarea"),
        ("Primary Color", "Culoare Primară"),
        ("HSV Color", "Culoare HSV"),
        ("Installation Successful!", "Instalare cu Succes!"),
        ("Installation failed!", "Instalare eșuată!"),
        ("Reverse mouse wheel", "Inversare rotiță mouse"),
        ("{} sessions", "{} sesiuni"),
        ("scam_title", "Titlu înșelătorie"),
        ("scam_text1", "Text înșelătorie 1"),
        ("scam_text2", "Text înșelătorie 2"),
        ("Don't show again", "Nu mai arăta"),
        ("I Agree", "Sunt de acord"),
        ("Decline", "Declină"),
        ("Timeout in minutes", "Timp de așteptare în minute"),
        ("auto_disconnect_option_tip", "Sfaturi pentru deconectarea automată"),
        ("Connection failed due to inactivity", "Conexiune eșuată din cauza inactivității"),
        ("Check for software update on startup", "Verifică actualizările software la pornire"),
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Actualizează serverul RustDesk Pro la {}"),
        ("pull_group_failed_tip", "Eșec la extragerea grupului"),
        ("Filter by intersection", "Filtrează după intersecție"),
        ("Remove wallpaper during incoming sessions", "Elimină fundalul în timpul sesiunilor primite"),
        ("Test", "Test"),
        ("display_is_plugged_out_msg", "Ecranul este deconectat"),
        ("No displays", "Fără ecrane"),
        ("Open in new window", "Deschide într-o fereastră nouă"),
        ("Show displays as individual windows", "Arată ecranele ca feronțe individuale"),
        ("Use all my displays for the remote session", "Folosește toate ecranele mele pentru sesiunea de la distanță"),
        ("selinux_tip", "Sfaturi SELinux"),
        ("Change view", "Schimbă vizualizarea"),
        ("Big tiles", "Plăci mari"),
        ("Small tiles", "Plăci mici"),
        ("List", "Listă"),
        ("Virtual display", "Ecran virtual"),
        ("Plug out all", "Deconectează toate"),
        ("True color (4:4:4)", "Culoare adevărată (4:4:4)"),
        ("Enable blocking user input", "Activează blocarea intrării utilizatorului"),
        ("id_input_tip", "Sfaturi pentru introducerea ID-ului"),
        ("privacy_mode_impl_mag_tip", "Sfaturi pentru activarea modului de confidențialitate"),
        ("privacy_mode_impl_virtual_display_tip", "Sfaturi pentru activarea modului de confidențialitate pe ecranul virtual"),
        ("Enter privacy mode", "Intră în modul de confidențialitate"),
        ("Exit privacy mode", "Ieși din modul de confidențialitate"),
        ("idd_not_support_under_win10_2004_tip", "ID-ul nu este compatibil cu Windows 10 versiunea 2004"),
        ("input_source_1_tip", "Sfaturi pentru sursa de intrare 1"),
        ("input_source_2_tip", "Sfaturi pentru sursa de intrare 2"),
        ("Swap control-command key", "Schimbă tasta de control cu comanda"),
        ("swap-left-right-mouse", "Schimbă butoanele stânga-dreapta ale mouse-ului"),
        ("2FA code", "Cod 2FA"),
        ("More", "Mai multe"),
        ("enable-2fa-title", "Activează 2FA"),
        ("enable-2fa-desc", "Permite autentificarea în doi pași"),
        ("wrong-2fa-code", "Cod 2FA greșit"),
        ("enter-2fa-title", "Introdu codul 2FA"),
        ("Email verification code must be 6 characters.", "Codul de verificare al e-mailului trebuie să fie de 6 caractere."),
        ("2FA code must be 6 digits.", "Codul 2FA trebuie să fie de 6 cifre."),
        ("Multiple Windows sessions found", "Sesiuni multiple de feronțe găsite"),
        ("Please select the session you want to connect to", "Selectați sesiunea la care doriți să vă conectați"),
        ("powered_by_me", "Acționat de mine"),
        ("outgoing_only_desk_tip", "Sfaturi pentru birou numai ieșire"),
        ("preset_password_warning", "Atenționare despre parola presetată"),
        ("Security Alert", "Alertă de Securitate"),
        ("My address book", "Cartea mea de adrese"),
        ("Personal", "Personal"),
        ("Owner", "Proprietar"),
        ...
        ("share_warning_tip", "Sfaturi pentru partajare"),
        ("Everyone", "Toată lumea"),
        ("ab_web_console_tip", "Sfaturi pentru consola web"),
        ("allow-only-conn-window-open-tip", "Permite doar deschiderea feronței de conexiune"),
        ("no_need_privacy_mode_no_physical_displays_tip", "Nu este nevoie de modul de confidențialitate, nu există ecrane fizice"),
        ("Follow remote cursor", "Urmărește cursorul de la distanță"),
        ("Follow remote window focus", "Urmărește focalizarea feronței de la distanță"),
        ("default_proxy_tip", "Sfaturi pentru proxy-ul implicit"),
        ("no_audio_input_device_tip", "Nu există dispozitive de intrare audio"),
        ("Incoming", "Intrare"),
        ("Outgoing", "Ieșire"),
        ("Clear Wayland screen selection", "Șterge selecția ecranului Wayland"),
        ("clear_Wayland_screen_selection_tip", "Sfaturi pentru ștergerea selecției ecranului Wayland"),
        ("confirm_clear_Wayland_screen_selection_tip", "Confirmați ștergerea selecției ecranului Wayland"),
        ("android_new_voice_call_tip", "Sfaturi pentru apeluri vocale noi Android"),
        ("texture_render_tip", "Sfaturi pentru redarea texturii"),
        ("Use texture rendering", "Folosește redarea texturii"),
        ("Floating window", "Fereastră flotantă"),
        ("floating_window_tip", "Sfaturi pentru fereastra flotantă"),
        ("Keep screen on", "Menține ecranul aprins"),
        ("Never", "Niciodată"),
        ("During controlled", "În timpul controlat"),
        ("During service is on", "În timpul funcționării serviciului"),
        ("Capture screen using DirectX", "Capturează ecranul folosind DirectX"),
        ("Back", "Înapoi"),
        ("Apps", "Aplicații"),
        ("Volume up", "Crește volumul"),
        ("Volume down", "Scade volumul"),
        ("Power", "Putere"),
        ("Telegram bot", "Bot Telegram"),
        ("enable-bot-tip", "Sfaturi pentru activarea botului"),
        ("enable-bot-desc", "Permite botul Telegram"),
        ("cancel-2fa-confirm-tip", "Confirmați anularea 2FA"),
        ("cancel-bot-confirm-tip", "Confirmați anularea botului"),
        ("About RustDesk", "Despre RustDesk"),
        ("Send clipboard keystrokes", "Trimite apăsări de taste din clipboard"),
        ("network_error_tip", "Sfaturi pentru eroare de rețea"),
        ("Unlock with PIN", "Dezblochează cu PIN"),
        ("Requires at least {} characters", "Necesar cel puțin {} caractere"),
        ("Wrong PIN", "PIN greșit"),
        ("Set PIN", "Setează PIN"),
        ("Enable trusted devices", "Activează dispozitivele de încredere"),
        ("Manage trusted devices", "Gestionează dispozitivele de încredere"),
        ("Platform", "Platformă"),
        ("Days remaining", "Zile rămase"),
        ("enable-trusted-devices-tip", "Sfaturi pentru activarea dispozitivelor de încredere"),
        ("Parent directory", "Director părinte"),
        ("Resume", "Continuă"),
        ("Invalid file name", "Nume fișier invalid"),
        ("one-way-file-transfer-tip", "Sfaturi pentru transferul fișierelor unidirecțional"),
        ("Authentication Required", "Autentificare necesară"),
        ("Authenticate", "Autentifică-te"),
        ("web_id_input_tip", "Sfaturi pentru introducerea ID-ului web"),
        ("Download", "Descarcă"),
        ("Upload folder", "Încarcă dosar"),
        ...
        ("Untagged", "Fără etichetă"),
        ("new-version-of-{}-tip", "Noua versiune de {}"),
        ("Accessible devices", "Dispozitive accesibile"),
        ("View camera", "Vezi camera"),
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Actualizează clientul RustDesk la {}"),
        ("view_camera_unsupported_tip", "Vizualizarea camerei nu este acceptată"),
        ("Enable camera", "Activează camera"),
        ("No cameras", "Fără camere"),
        ("d3d_render_tip", "Sfaturi pentru redarea D3D"),
        ("Use D3D rendering", "Folosește redarea D3D"),
        ("Printer", "Imprimantă"),
        ("printer-os-requirement-tip", "Sfaturi pentru cerințele OS ale imprimantei"),
        ("printer-requires-installed-{}-client-tip", "Imprimanta necesită clientul {} instalat"),
        ("printer-{}-not-installed-tip", "Imprimanta {} nu este instalată"),
        ("printer-{}-ready-tip", "Imprimanta {} este gata"),
        ("Install {} Printer", "Instalează imprimanta {}"),
        ("Outgoing Print Jobs", "Lucrări de imprimare ieșite"),
        ("Incomming Print Jobs", "Lucrări de imprimare intrate"),
        ("Incoming Print Job", "Lucrare de imprimare primită"),
        ("use-the-default-printer-tip", "Folosește imprimanta implicită"),
        ("use-the-selected-printer-tip", "Folosește imprimanta selectată"),
        ("auto-print-tip", "Sfaturi pentru imprimarea automată"),
        ("print-incoming-job-confirm-tip", "Confirmați imprimarea lucrării primite"),
        ("remote-printing-disallowed-tile-tip", "Imprimarea de la distanță nu este permisă"),
        ("remote-printing-disallowed-text-tip", "Imprimarea de la distanță este interzisă"),
        ("save-settings-tip", "Sfaturi pentru salvarea setărilor"),
        ("dont-show-again-tip", "Nu mai arăta din nou"),
    ].iter().cloned().collect();
}
