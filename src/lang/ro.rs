...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verification_tip", "Introduceți codul de verificare trimis la adresa dvs. de e-mail sau generat de aplicația de autentificare."),
        ...
        ("id_input_tip", "Introduceți ID-ul sau adresa IP a dispozitivului la distanță"),
        ...
        ("web_id_input_tip", "Introduceți ID-ul RustDesk al dispozitivului la care doriți să vă conectați"),
        ("Download", "Descarcă"),
        ...
        ("terminal-admin-login-tip", "Introduceți datele de autentificare ale administratorului pentru a rula terminalul cu privilegii sporite."),
        ...
        ("elevation_username_tip", "Introduceți numele de utilizator al contului de administrator pentru a solicita sporirea privilegiilor."),
        ...
        ("input note here", "Introduceți o notă aici"),
