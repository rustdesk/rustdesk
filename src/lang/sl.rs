...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem Breitenstein IT..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, Breitenstein IT v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ("Click to upgrade", "Klikni za nadgradnjo"),
        ("Click to download", "Klikni za prenos"),
        ("Click to update", "Klikni za posodobitev"),
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate Breitenstein ITu dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate Breitenstein ITu dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno Breitenstein ITu dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »Breitenstein IT Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep Breitenstein IT background service", "Ohrani Breitenstein ITovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije Breitenstein IT, poiščite »Baterija« in izklopite »Neomejeno«"),
        ("Start on boot", ""),
        ...
        ("Show Breitenstein IT", "Prikaži Breitenstein IT"),
