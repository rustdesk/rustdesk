...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem TeamDesk..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, TeamDesk v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ("Click to upgrade", "Klikni za nadgradnjo"),
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate TeamDesku dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate TeamDesku dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno TeamDesku dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »TeamDesk Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep TeamDesk background service", "Ohrani TeamDeskovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije TeamDesk, poiščite »Baterija« in izklopite »Neomejeno«"),
        ...
        ("config_input", "TeamDesk potrebuje pravico »Nadzor vnosa« za nadzor oddaljenega namizja s tipkovnico."),
        ("config_microphone", "TeamDesk potrebuje pravico »Snemanje zvoka« za zajemanje zvoka."),
        ...
        ("verify_teamdesk_password_tip", "Preveri geslo za TeamDesk"),
        ...
        ("scam_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite TeamDesk, prekinite klic in program zaprite."),
        ("scam_text2", "TeamDesk omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("upgrade_teamdesk_server_pro_to_{}_tip", "Prosimo, nadgradite TeamDesk Server Pro na različico {} ali novejšo."),
        ...
        ("powered_by_me", "Uporablja tehnologijo TeamDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Dovoli povezavo samo če je okno TeamDeska odprto"),
        ...
        ("floating_window_tip", "Pomaga pri TeamDesk storitvi v ozadju"),
        ...
        ("upgrade_remote_teamdesk_client_to_{}_tip", "Prosimo, nadgradite TeamDesk odjemalec na različico {} ali novejšo na oddaljeni strani."),
        ...
        ("allow-insecure-tls-fallback-tip", "Privzeto TeamDesk preverja strežniško potrdilo za protokole, ki uporabljajo TLS.\nKo je ta možnost omogočena, bo TeamDesk ob neuspelem preverjanju preskočil korak preverjanja in nadaljeval."),
        ("Disable UDP", "Onemogoči UDP"),
        ("disable-udp-tip", "Določa, ali naj se uporablja samo TCP.\nKo je ta možnost omogočena, TeamDesk ne bo več uporabljal UDP 21116, namesto tega bo uporabljen TCP 21116."),
        ("server-oss-not-support-tip", "OPOMBA: Strežnik TeamDesk OSS ne vključuje te funkcije."),
        ...
        ("TeamDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that TeamDesk can use it", "TeamDesk ne more dostopati do namizne seje na oddaljeni napravi, preverite, ali seja teče in ali jo TeamDesk lahko uporablja"),
        ...
        ("TeamDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "TeamDesk od XDG Desktop Portala ni dobil uporabnega zaslona, knjižnica PipeWire je morda prestara"),
        ("TeamDesk could not load a GStreamer component needed for screen capture ({})", "TeamDesk ni mogel naložiti komponente GStreamer, potrebne za zajem zaslona ({})"),
    ].iter().cloned().collect();
}
