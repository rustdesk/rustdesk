...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Width", "Širina"),
        ("Height", "Višina"),
        ("Swap width and height", "Zamenjaj širino in višino"),
        ("Current resolution", "Trenutna ločljivost"),
        ("Reset changes", "Ponastavi spremembe"),
        ("Select a resolution supported by the display", "Izberite ločljivost, ki jo zaslon podpira"),
        ("Display settings changed. Reopen the resolution menu and try again.", "Nastavitve zaslona so se spremenile. Znova odprite meni ločljivosti in poskusite znova."),
        ("Closest supported resolution", "Najbližja podprta ločljivost"),
        ("Adjusted to display limits", "Prilagojeno omejitvam zaslona"),
        ("Local resolution is unavailable or unsupported", "Lokalna ločljivost ni na voljo ali ni podprta"),
        ("Looks like", "Videti kot"),
        ("Rendering quality", "Kakovost izrisa"),
        ("Standard", "Standardna"),
        ("Enter dimensions within the range", "Vnesite mere znotraj dovoljenega razpona"),
        ("Aspect ratio", "Razmerje stranic"),
        ("Available resolutions", "Razpoložljive ločljivosti"),
        ("System scaling", "Sistemsko skaliranje"),
        ("Recommended", "Priporočeno"),
        ("System scaling is unavailable for this display or desktop environment.", "Sistemsko skaliranje ni na voljo za ta zaslon ali namizno okolje."),
        ("The system did not apply the requested scale. Refresh and try again.", "Sistem ni uveljavil zahtevane povečave. Osvežite in poskusite znova."),
        ("Select a scaling level supported by the display.", "Izberite raven skaliranja, ki jo zaslon podpira."),
        ("No permission to change display settings.", "Nimate dovoljenja za spreminjanje nastavitev zaslona."),
        ("Invalid display scaling request.", "Neveljavna zahteva za skaliranje zaslona."),
        ("Display settings are busy. Try again.", "Nastavitve zaslona so zasedene. Poskusite znova."),
        ("Display settings timed out. Refresh and try again.", "Čas za nastavitve zaslona je potekel. Osvežite in poskusite znova."),
        ("Use nearest supported scale", "Uporabi najbližjo podprto povečavo"),
        ("Scaling was applied, but the resolution request failed.", "Povečava je bila uveljavljena, vendar zahteva za ločljivost ni uspela."),
        ("Failed to change display settings", "Nastavitev zaslona ni bilo mogoče spremeniti"),
        ("Remote connection has closed", "Oddaljena povezava je zaprta"),
        ("Failed to resize macOS virtual display", "Velikosti navideznega zaslona macOS ni bilo mogoče spremeniti"),
        ("Failed to toggle macOS virtual display", "Navideznega zaslona macOS ni bilo mogoče vklopiti ali izklopiti"),
        ("Failed to start macOS virtual display worker", "Delovnega procesa za navidezne zaslone macOS ni bilo mogoče zagnati"),
        ("Virtual display dimensions must be between 320 and 4096", "Mere navideznega zaslona morajo biti med 320 in 4096"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "Faktor skaliranja navideznega zaslona mora biti 1 ali 2 in mora obe meri v slikovnih pikah deliti brez ostanka"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "Mere navideznega zaslona morajo biti med 1 in 4096 logičnimi slikovnimi pikami"),
        ("Display configuration response is too large.", "Odgovor s konfiguracijo zaslona je prevelik."),
        ("Invalid display scaling response", "Neveljaven odgovor o skaliranju zaslona"),
        ("Invalid display scaling levels", "Neveljavne ravni skaliranja zaslona"),
        ("Invalid display scaling range", "Neveljaven razpon skaliranja zaslona"),
        ("Interface size", "Velikost vmesnika"),
        ("Current interface size", "Trenutna velikost vmesnika"),
    ].iter().cloned().collect();
}
