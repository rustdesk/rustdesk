...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Enable Clipboard", "فعال سازی کلیپ بورد"),
        ...
        ("Your new ID", "جدید ID"),
        ("length %min% to %max%", " %max% تا %min% طول"),
        ("starts with a letter", "با یک حرف شروع می شود"),
        ...
        ("Website", "وب سایت"),
        ("About", "درباره"),
        ("Slogan_tip", "ساخته شده با قلب در این دنیای پر هرج و مرج!"),
        ...
        ("Adaptive Bitrate", "Bitrate سازگار"),
        ...
        ("Connect via relay", "با رله وصل شوید"),
