...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "لطفا برنامه را نصب کنید UAC و جلوگیری از خطای GerarDesk برای راحتی در استفاده از نرم افزار"),
        ("Click to upgrade", "برای ارتقا کلیک کنید"),
        ("Click to download", "برای دانلود کلیک کنید"),
        ("Click to update", "برای به روز رسانی کلیک کنید"),
        ("Configure", "تنظیم"),
        ("config_acc", "برای کنترل از راه دور دسکتاپ، باید به GerarDesk مجوز \"access\" بدهید"),
        ("config_screen", "برای دسترسی از راه دور به دسکتاپ خود، باید به GerarDesk مجوزهای \"screenshot\" بدهید."),
        ...
        ("android_input_permission_tip1", "برای اینکه یک دستگاه راه دور بتواند دستگاه Android شما را از طریق ماوس یا لمسی کنترل کند، باید به GerarDesk اجازه دهید از ویژگی \"Accessibility\" استفاده کند."),
        ("android_input_permission_tip2", "به صفحه تنظیمات سیستم زیر بروید، \"Installed Services\" را پیدا کرده و وارد کنید، سرویس \"GerarDesk Input\" را فعال کنید"),
        ...
        ("Language", "زبان"),
        ("Keep GerarDesk background service", "سرویس GerarDesk را در پس زمینه نگه دارید"),
        ...
        ("Show GerarDesk", "GerarDesk را نشان دهید"),
        ("This PC", "This PC"),
        ("or", "یا"),
