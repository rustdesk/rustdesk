...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Output resolution", "وضوح خروجی"),
        ("Width", "عرض"),
        ("Height", "ارتفاع"),
        ("Swap width and height", "جابه‌جایی عرض و ارتفاع"),
        ("Current resolution", "وضوح فعلی"),
        ("Reset changes", "بازنشانی تغییرات"),
        ("Select a resolution supported by the display", "وضوحی را انتخاب کنید که نمایشگر پشتیبانی می‌کند"),
        ("Display settings changed. Reopen the resolution menu and try again.", "تنظیمات نمایشگر تغییر کرده است. منوی وضوح را دوباره باز کنید و دوباره تلاش کنید."),
        ("Closest supported resolution", "نزدیک‌ترین وضوح پشتیبانی‌شده"),
        ("Adjusted to display limits", "متناسب با محدودیت‌های نمایشگر تنظیم شد"),
        ("Local resolution is unavailable or unsupported", "وضوح محلی در دسترس نیست یا پشتیبانی نمی‌شود"),
        ("Looks like", "به نظر می‌رسد مانند"),
        ("Rendering quality", "کیفیت رندر"),
        ("Standard", "استاندارد"),
        ("Enter dimensions within the range", "ابعادی در محدوده مجاز وارد کنید"),
        ("Aspect ratio", "نسبت تصویر"),
        ("Available resolutions", "وضوح‌های موجود"),
        ("System scaling", "مقیاس‌بندی سیستم"),
        ("Recommended", "پیشنهادی"),
        ("System scaling is unavailable for this display or desktop environment.", "مقیاس‌بندی سیستم برای این نمایشگر یا محیط دسکتاپ در دسترس نیست."),
        ("The system did not apply the requested scale. Refresh and try again.", "سیستم مقیاس درخواستی را اعمال نکرد. تازه‌سازی کنید و دوباره تلاش کنید."),
        ("Select a scaling level supported by the display.", "سطح مقیاس‌بندی پشتیبانی‌شده توسط نمایشگر را انتخاب کنید."),
        ("No permission to change display settings.", "اجازه تغییر تنظیمات نمایشگر را ندارید."),
        ("Invalid display scaling request.", "درخواست مقیاس‌بندی نمایشگر نامعتبر است."),
        ("Display settings are busy. Try again.", "تنظیمات نمایشگر مشغول است. دوباره تلاش کنید."),
        ("Display settings timed out. Refresh and try again.", "مهلت تنظیمات نمایشگر پایان یافت. تازه‌سازی کنید و دوباره تلاش کنید."),
        ("Use nearest supported scale", "استفاده از نزدیک‌ترین مقیاس پشتیبانی‌شده"),
        ("Scaling was applied, but the resolution request failed.", "مقیاس اعمال شد، اما درخواست وضوح ناموفق بود."),
        ("Failed to change display settings", "تغییر تنظیمات نمایشگر ناموفق بود"),
        ("Remote connection has closed", "اتصال راه دور بسته شده است"),
        ("Failed to resize macOS virtual display", "تغییر اندازه نمایشگر مجازی macOS ناموفق بود"),
        ("Failed to toggle macOS virtual display", "فعال یا غیرفعال کردن نمایشگر مجازی macOS ناموفق بود"),
        ("Failed to start macOS virtual display worker", "راه‌اندازی رشته کاری نمایشگرهای مجازی macOS ناموفق بود"),
        ("Virtual display dimensions must be between 320 and 4096", "ابعاد نمایشگر مجازی باید بین 320 و4096 باشد"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "مقیاس نمایشگر مجازی باید 1 یا 2 باشد و هر دو بعد پیکسلی بر آن بخش‌پذیر باشند"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "ابعاد نمایشگر مجازی باید بین 1 و4096 پیکسل منطقی باشد"),
        ("Display configuration response is too large.", "پاسخ پیکربندی نمایشگر بیش از حد بزرگ است."),
        ("Invalid display scaling response", "پاسخ مقیاس‌بندی نمایشگر نامعتبر است"),
        ("Invalid display scaling levels", "سطوح مقیاس‌بندی نمایشگر نامعتبر هستند"),
        ("Invalid display scaling range", "محدوده مقیاس‌بندی نمایشگر نامعتبر است"),
        ("Interface size", "اندازهٔ رابط کاربری"),
        ("Current interface size", "اندازهٔ فعلی رابط کاربری"),
    ].iter().cloned().collect();
}
