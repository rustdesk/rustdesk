...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Reverse mouse wheel", "معکوس کردن چرخش چرخ موس"),
        ("{} sessions", "{} جلسه"),
        ...
        ("Enter privacy mode", "استفاده از خالت خصوصی"),
        ("Exit privacy mode", "خروج از حالت خصوص"),
        ("idd_not_support_under_win10_2004_tip", ""),
        ("switch_display_elevated_connections_tip", ""),
        ("input_source_1_tip", "منبع ورودی 1"),
        ("input_source_2_tip", "منبع ورودی 2"),
        ("capture_display_elevated_connections_tip", "برای نصب درایور تصویر از ویندوز 10 نسخه 2004 به بالا استفاده کنید"),
        ...
        ("More", "بیشتر"),
        ("enable-2fa-title", "فعالسازی تائید هویت 2 مرحله ای"),
        ("enable-2fa-desc", "شما می توانید از برنامه های مایکروسافت یا گوگل یا نظیر آنها استفاده کنید.کافیست برنامه را روی تلفن همراه باز کنید و بارکد را اسکن کنید"),
        ("wrong-2fa-code", "کد قابل تایید نیست ، لطفا کد یا تنظیمات زمان منطقه خود را بررسی نمائید."),
        ("enter-2fa-title", "تائید هویت دو مرحله ای"),
        ("Email verification code must be 6 characters.", ""),
        ("2FA code must be 6 digits.", "کد نائید دو مرحله ای باید 6 رقم باشد"),
    ].iter().cloned().collect();
}
