...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Alias", "نام مستعار"),
        ("ScrollEdge", "لبهٔ اسکرول"),
        ("Allow insecure TLS fallback", "اجازهٔ استفاده از TLS غیرایمن"),
        ("allow-insecure-tls-fallback-tip", "در صورت بروز خطا در TLS امن، اجازهٔ استفاده از نسخهٔ غیرایمن را می‌دهد"),
        ("Disable UDP", "غیرفعال کردن UDP"),
        ("disable-udp-tip", "با فعال‌سازی این گزینه، ارتباط از طریق UDP انجام نخواهد شد"),
        ("server-oss-not-support-tip", "این قابلیت توسط نسخهٔ سرور شما پشتیبانی نمی‌شود"),
        ("input note here", "یادداشت را اینجا وارد کنید"),
        ("note-at-conn-end-tip", "این یادداشت در پایان اتصال نمایش داده می‌شود"),
    ].iter().cloned().collect();
}
