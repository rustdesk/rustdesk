...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Output resolution", "Výstupní rozlišení"),
        ("Width", "Šířka"),
        ("Height", "Výška"),
        ("Swap width and height", "Prohodit šířku a výšku"),
        ("Current resolution", "Aktuální rozlišení"),
        ("Reset changes", "Obnovit změny"),
        ("Select a resolution supported by the display", "Vyberte rozlišení podporované obrazovkou"),
        ("Display settings changed. Reopen the resolution menu and try again.", "Nastavení obrazovky se změnilo. Znovu otevřete nabídku rozlišení a zkuste to znovu."),
        ("Closest supported resolution", "Nejbližší podporované rozlišení"),
        ("Adjusted to display limits", "Přizpůsobeno limitům obrazovky"),
        ("Local resolution is unavailable or unsupported", "Místní rozlišení není dostupné nebo podporované"),
        ("Looks like", "Vypadá jako"),
        ("Rendering quality", "Kvalita vykreslování"),
        ("Standard", "Standardní"),
        ("Enter dimensions within the range", "Zadejte rozměry v povoleném rozsahu"),
        ("Aspect ratio", "Poměr stran"),
        ("Available resolutions", "Dostupná rozlišení"),
        ("System scaling", "Systémové měřítko"),
        ("Recommended", "Doporučeno"),
        ("System scaling is unavailable for this display or desktop environment.", "Systémové měřítko není pro tuto obrazovku nebo desktopové prostředí dostupné."),
        ("The system did not apply the requested scale. Refresh and try again.", "Systém nepoužil požadované měřítko. Obnovte údaje a zkuste to znovu."),
        ("Select a scaling level supported by the display.", "Vyberte úroveň měřítka podporovanou obrazovkou."),
        ("No permission to change display settings.", "Nemáte oprávnění měnit nastavení obrazovky."),
        ("Invalid display scaling request.", "Neplatný požadavek na měřítko obrazovky."),
        ("Display settings are busy. Try again.", "Nastavení obrazovky je zaneprázdněno. Zkuste to znovu."),
        ("Display settings timed out. Refresh and try again.", "Vypršel časový limit nastavení obrazovky. Obnovte údaje a zkuste to znovu."),
        ("Use nearest supported scale", "Použít nejbližší podporované měřítko"),
        ("Scaling was applied, but the resolution request failed.", "Měřítko bylo použito, ale požadavek na rozlišení selhal."),
        ("Failed to change display settings", "Nepodařilo se změnit nastavení obrazovky"),
        ("Remote connection has closed", "Vzdálené připojení bylo uzavřeno"),
        ("Failed to resize macOS virtual display", "Nepodařilo se změnit velikost virtuální obrazovky macOS"),
        ("Failed to toggle macOS virtual display", "Nepodařilo se zapnout nebo vypnout virtuální obrazovku macOS"),
        ("Failed to start macOS virtual display worker", "Nepodařilo se spustit pracovní proces virtuálních obrazovek macOS"),
        ("Virtual display dimensions must be between 320 and 4096", "Rozměry virtuální obrazovky musí být mezi 320 a 4096"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "Měřítko virtuální obrazovky musí být 1 nebo 2 a oba rozměry v pixelech jím musí být beze zbytku dělitelné"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "Rozměry virtuální obrazovky musí být mezi 1 a 4096 logickými pixely"),
        ("Display configuration response is too large.", "Odpověď s konfigurací obrazovky je příliš velká."),
