...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Output resolution", "வெளியீட்டுத் தெளிவுத்திறன்"),
        ("Width", "அகலம்"),
        ("Height", "உயரம்"),
        ("Swap width and height", "அகலத்தையும் உயரத்தையும் மாற்று"),
        ("Current resolution", "தற்போதைய தெளிவுத்திறன்"),
        ("Reset changes", "மாற்றங்களை மீட்டமை"),
        ("Select a resolution supported by the display", "திரை ஆதரிக்கும் தெளிவுத்திறனைத் தேர்ந்தெடுக்கவும்"),
        ("Display settings changed. Reopen the resolution menu and try again.", "திரை அமைப்புகள் மாறிவிட்டன. தெளிவுத்திறன் பட்டியை மீண்டும் திறந்து முயற்சிக்கவும்."),
        ("Closest supported resolution", "அருகிலுள்ள ஆதரிக்கப்படும் தெளிவுத்திறன்"),
        ("Adjusted to display limits", "திரையின் வரம்புகளுக்கு ஏற்ப சரிசெய்யப்பட்டது"),
        ("Local resolution is unavailable or unsupported", "உள்ளூர் தெளிவுத்திறன் கிடைக்கவில்லை அல்லது ஆதரிக்கப்படவில்லை"),
        ("Looks like", "இவ்வாறு தோன்றும்"),
        ("Rendering quality", "வரைதல் தரம்"),
        ("Standard", "நிலையானது"),
        ("Enter dimensions within the range", "அனுமதிக்கப்பட்ட வரம்பிற்குள் பரிமாணங்களை உள்ளிடவும்"),
        ("Aspect ratio", "அகல உயர விகிதம்"),
        ("Available resolutions", "கிடைக்கும் தெளிவுத்திறன்கள்"),
        ("System scaling", "கணினி அளவாக்கம்"),
        ("Recommended", "பரிந்துரைக்கப்பட்டது"),
        ("System scaling is unavailable for this display or desktop environment.", "இந்தத் திரை அல்லது பணிமேடைச் சூழலுக்குக் கணினி அளவாக்கம் கிடைக்கவில்லை."),
        ("The system did not apply the requested scale. Refresh and try again.", "கோரிய அளவை கணினி பயன்படுத்தவில்லை. புதுப்பித்து மீண்டும் முயற்சிக்கவும்."),
        ("Select a scaling level supported by the display.", "திரை ஆதரிக்கும் அளவாக்க நிலையைத் தேர்ந்தெடுக்கவும்."),
        ("No permission to change display settings.", "திரை அமைப்புகளை மாற்ற அனுமதி இல்லை."),
        ("Invalid display scaling request.", "திரை அளவாக்கக் கோரிக்கை செல்லாது."),
        ("Display settings are busy. Try again.", "திரை அமைப்புகள் பயன்பாட்டில் உள்ளன. மீண்டும் முயற்சிக்கவும்."),
        ("Display settings timed out. Refresh and try again.", "திரை அமைப்புகளுக்கான காத்திருப்பு நேரம் முடிந்தது. புதுப்பித்து மீண்டும் முயற்சிக்கவும்."),
        ("Use nearest supported scale", "அருகிலுள்ள ஆதரிக்கப்படும் அளவைப் பயன்படுத்து"),
        ("Scaling was applied, but the resolution request failed.", "அளவு பயன்படுத்தப்பட்டது, ஆனால் தெளிவுத்திறன் கோரிக்கை தோல்வியடைந்தது."),
        ("Failed to change display settings", "திரை அமைப்புகளை மாற்ற முடியவில்லை"),
        ("Remote connection has closed", "தொலைநிலை இணைப்பு மூடப்பட்டது"),
        ("Failed to resize macOS virtual display", "macOS மெய்நிகர் திரையின் அளவை மாற்ற முடியவில்லை"),
        ("Failed to toggle macOS virtual display", "macOS மெய்நிகர் திரையை இயக்கவோ முடக்கவோ முடியவில்லை"),
        ("Failed to start macOS virtual display worker", "macOS மெய்நிகர் திரையின் பணியிழையைத் தொடங்க முடியவில்லை"),
        ("Virtual display dimensions must be between 320 and 4096", "மெய்நிகர் திரையின் பரிமாணங்கள் 320 முதல் 4096 வரை இருக்க வேண்டும்"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "மெய்நிகர் திரையின் அளவுக் காரணி 1 அல்லது 2 ஆக இருக்க வேண்டும்; இரு பிக்சல் பரிமாணங்களும் அதனால் மீதமின்றி வகுபட வேண்டும்"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "மெய்நிகர் திரையின் பரிமாணங்கள் 1 முதல் 4096 தருக்க பிக்சல்கள் வரை இருக்க வேண்டும்"),
        ("Display configuration response is too large.", "திரைக் கட்டமைப்பின் பதில் மிகப் பெரியது."),
