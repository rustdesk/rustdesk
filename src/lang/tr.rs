...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Output resolution", "Çıkış çözünürlüğü"),
        ("Width", "Genişlik"),
        ("Height", "Yükseklik"),
        ("Swap width and height", "Genişlik ve yüksekliği değiştir"),
        ("Current resolution", "Geçerli çözünürlük"),
        ("Reset changes", "Değişiklikleri sıfırla"),
        ("Select a resolution supported by the display", "Ekranın desteklediği bir çözünürlük seçin"),
        ("Display settings changed. Reopen the resolution menu and try again.", "Görüntü ayarları değişti. Çözünürlük menüsünü yeniden açıp tekrar deneyin."),
        ("Closest supported resolution", "Desteklenen en yakın çözünürlük"),
        ("Adjusted to display limits", "Ekran sınırlarına uyarlandı"),
        ("Local resolution is unavailable or unsupported", "Yerel çözünürlük kullanılamıyor veya desteklenmiyor"),
        ("Looks like", "Şöyle görünür"),
        ("Rendering quality", "İşleme kalitesi"),
        ("Standard", "Standart"),
        ("Enter dimensions within the range", "Aralık içindeki boyutları girin"),
        ("Aspect ratio", "En boy oranı"),
        ("Available resolutions", "Kullanılabilir çözünürlükler"),
        ("System scaling", "Sistem ölçeklendirmesi"),
        ("Recommended", "Önerilen"),
        ("System scaling is unavailable for this display or desktop environment.", "Bu ekran veya masaüstü ortamı için sistem ölçeklendirmesi kullanılamıyor."),
        ("The system did not apply the requested scale. Refresh and try again.", "Sistem istenen ölçeği uygulamadı. Yenileyip tekrar deneyin."),
        ("Select a scaling level supported by the display.", "Ekranın desteklediği bir ölçeklendirme düzeyi seçin."),
        ("No permission to change display settings.", "Görüntü ayarlarını değiştirme izni yok."),
        ("Invalid display scaling request.", "Geçersiz ekran ölçeklendirme isteği."),
        ("Display settings are busy. Try again.", "Görüntü ayarları meşgul. Tekrar deneyin."),
        ("Display settings timed out. Refresh and try again.", "Görüntü ayarları zaman aşımına uğradı. Yenileyip tekrar deneyin."),
        ("Use nearest supported scale", "Desteklenen en yakın ölçeği kullan"),
        ("Scaling was applied, but the resolution request failed.", "Ölçek uygulandı ancak çözünürlük isteği başarısız oldu."),
        ("Failed to change display settings", "Görüntü ayarları değiştirilemedi"),
        ("Remote connection has closed", "Uzak bağlantı kapatıldı"),
        ("Failed to resize macOS virtual display", "macOS sanal ekranı yeniden boyutlandırılamadı"),
        ("Failed to toggle macOS virtual display", "macOS sanal ekranı açılıp kapatılamadı"),
        ("Failed to start macOS virtual display worker", "macOS sanal ekran iş parçacığı başlatılamadı"),
        ("Virtual display dimensions must be between 320 and 4096", "Sanal ekran boyutları 320 ile 4096 arasında olmalıdır"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "Sanal ekran ölçeği 1 veya 2 olmalı ve her iki piksel boyutunu da kalansız bölmelidir"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "Sanal ekran boyutları 1 ile 4096 mantıksal piksel arasında olmalıdır"),
        ("Display configuration response is too large.", "Ekran yapılandırma yanıtı çok büyük."),
        ("Invalid display scaling response", "Geçersiz ekran ölçeklendirme yanıtı"),
        ("Invalid display scaling levels", "Geçersiz ekran ölçeklendirme düzeyleri"),
