...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Kullanıcı Hesabı Denetimi nedeniyle, StarDesk bir uzak masaüstü olarak düzgün çalışmayabilir. Bu sorunu önlemek için, StarDesk'i sistem seviyesinde kurmak için aşağıdaki butona tıklayın."),
        ...
        ("Configure", "Ayarla"),
        ("config_acc", "Masaüstünüzü dışarıdan kontrol etmek için StarDesk'e \"Erişilebilirlik\""),
        ("config_screen", "Masaüstünüzü dışarıdan kontrol etmek için StarDesk'e \"Ekran Kaydı\" iznini vermeniz gerekir."),
        ...
        ("android_input_permission_tip1", "Uzak bir cihazın Android cihazınızı fare veya dokunma yoluyla kontrol edebilmesi için, StarDesk'in \"Erişilebilirlik\" özelliğini kullanmasına izin vermelisiniz."),
        ("android_input_permission_tip2", "Sonraki sistem ayarları sayfasına gidin, [Yüklü Hizmetler]'i bulun ve erişin, [StarDesk Girişi] hizmetini etkinleştirin."),
        ...
        ("Language", "Dil"),
        ("Keep StarDesk background service", "StarDesk arka plan hizmetini sürdürün"),
        ...
        ("Show StarDesk", "StarDesk'i Göster"),
        ("This PC", "Bu PC"),
        ("or", "veya"),
        ...
        ("config_input", "Uzaktaki masaüstünü klavye ile kontrol etmek için StarDesk'e \"Giriş İzleme\" izinleri vermelisiniz."),
        ("config_microphone", "Uzaktan konuşmak için StarDesk'e \"Ses Kaydı\" izinleri vermelisiniz."),
        ...
        ("still_click_uac_tip", "Uzaktaki kullanıcının çalışan StarDesk'in UAC penceresinde hala Tamam'ı tıklaması gerekmektedir."),
        ...
        ("install_cert_tip", "StarDesk sertifikasını yükleyin"),
        ("confirm_install_cert_tip", "Bu, güvenilir olabilecek bir StarDesk test sertifikasıdır. Sertifika, gerekli olduğunda StarDesk sürücülerini güvenilir ve yüklemek üzere kullanacaktır."),
        ...
        ("verify_stardesk_password_tip", "StarDesk parolasını doğrulayın"),
