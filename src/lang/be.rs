...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Output resolution", "Выхадная раздзяляльнасць"),
        ("Width", "Шырыня"),
        ("Height", "Вышыня"),
        ("Swap width and height", "Памяняць шырыню і вышыню"),
        ("Current resolution", "Бягучая раздзяляльнасць"),
        ("Reset changes", "Скінуць змены"),
        ("Select a resolution supported by the display", "Выберыце раздзяляльнасць, якую падтрымлівае дысплэй"),
        ("Display settings changed. Reopen the resolution menu and try again.", "Налады дысплэя змяніліся. Адкрыйце меню раздзяляльнасці нанова і паўтарыце спробу."),
        ("Closest supported resolution", "Найбліжэйшая раздзяляльнасць, якая падтрымліваецца"),
        ("Adjusted to display limits", "Прыстасавана да абмежаванняў дысплэя"),
        ("Local resolution is unavailable or unsupported", "Лакальная раздзяляльнасць недаступная або не падтрымліваецца"),
        ("Looks like", "Выглядае як"),
        ("Rendering quality", "Якасць адмалёўкі"),
        ("Standard", "Стандартная"),
        ("Enter dimensions within the range", "Увядзіце памеры ў дапушчальным дыяпазоне"),
        ("Aspect ratio", "Суадносіны бакоў"),
        ("Available resolutions", "Даступныя раздзяляльнасці"),
        ("System scaling", "Сістэмнае маштабаванне"),
        ("Recommended", "Рэкамендуецца"),
        ("System scaling is unavailable for this display or desktop environment.", "Сістэмнае маштабаванне недаступнае для гэтага дысплэя або асяроддзя працоўнага стала."),
        ("The system did not apply the requested scale. Refresh and try again.", "Сістэма не ўжыла запытаны маштаб. Абнавіце даныя і паўтарыце спробу."),
        ("Select a scaling level supported by the display.", "Выберыце ўзровень маштабавання, які падтрымлівае дысплэй."),
        ("No permission to change display settings.", "Няма дазволу на змяненне налад дысплэя."),
        ("Invalid display scaling request.", "Некарэктны запыт маштабавання дысплэя."),
        ("Display settings are busy. Try again.", "Налады дысплэя занятыя. Паўтарыце спробу."),
        ("Display settings timed out. Refresh and try again.", "Час чакання налад дысплэя скончыўся. Абнавіце даныя і паўтарыце спробу."),
        ("Use nearest supported scale", "Выкарыстаць найбліжэйшы маштаб, які падтрымліваецца"),
        ("Scaling was applied, but the resolution request failed.", "Маштаб ужыты, але запыт змянення раздзяляльнасці завяршыўся памылкай."),
        ("Failed to change display settings", "Не ўдалося змяніць налады дысплэя"),
        ("Remote connection has closed", "Аддаленае злучэнне закрыта"),
        ("Failed to resize macOS virtual display", "Не ўдалося змяніць памер віртуальнага дысплэя macOS"),
        ("Failed to toggle macOS virtual display", "Не ўдалося ўключыць або выключыць віртуальны дысплэй macOS"),
        ("Failed to start macOS virtual display worker", "Не ўдалося запусціць рабочы працэс віртуальных дысплэяў macOS"),
        ("Virtual display dimensions must be between 320 and 4096", "Памеры віртуальнага дысплэя павінны быць у межах ад 320 да 4096"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "Маштаб віртуальнага дысплэя павінен быць роўны 1 або 2, а абодва памеры ў пікселях павінны дзяліцца на яго без астачы"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "Памеры віртуальнага дысплэя павінны быць у межах ад 1 да 4096 лагічных пікселяў"),
        ("Display configuration response is too large.", "Адказ з канфігурацыяй дысплэя занадта вялікі."),
        ("Invalid display scaling response", "Некарэктны адказ пра маштабаванне дысплэя"),
        ("Invalid display scaling levels", "Некарэктныя ўзроўні маштабавання дысплэя"),
        ("Invalid display scaling range", "Некарэктны дыяпазон маштабавання дысплэя"),
        ("Interface size", "Памер інтэрфейсу"),
        ("Current interface size", "Бягучы памер інтэрфейсу"),
    ].iter().cloned().collect();
}
