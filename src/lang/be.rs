...
("Finished", "Завершана"),
("Speed", "Хуткасць"),
("Custom Image Quality", "Якасць малюнка па запыце"),
("Privacy mode", "Рэжым прыватнасці"),
("Block user input", "Забараніць ўвод на аддаленым прыладзе"),
("Unblock user input", "Адблакіраваць ўвод на аддаленым прыладзе"),
...
("Good image quality", "Добрая якасць малюнка"),
...
("Remote desktop is offline", "Аддалены пульт не ў сетцы"),
("Key mismatch", "Нясуразнасць ключоў"),
("Timeout", "Час ачаквання скончыўся"),
...
("Failed to make direct connection to remote desktop", "Немагчыма ўстанавіць праўлае падключэнне да аддаленага пульту"),
("Set Password", "Усталяваць пароль"),
("OS Password", "Пароль для ўваходу ў аперацыйную сістэму"),
...
("Click to upgrade", "Націсніце для абнаўлення"),
("Click to download", "Націсніце для загрузкі"),
("Click to update", "Націсніце для абнаўлення"),
("Configure", "Наладзіць"),
("config_acc", "Каб аддаленна кіраваць сваім рабочым столам, вам неабходна дазволіць RustDesk правы доступу."),
("config_screen", "Для аддаленага доступу да рабочага столу вам неабходна дазволіць RustDesk правы снямку экрана."),
...
("Create desktop icon", "Стварыць значок на рабочым стале"),
...
("Your installation is lower version.", "Вашая ўсталяваная версія ніжэй"),
...
("setup_server_tip", "Для хуткага падключэння наладзіце свой сервер."),
("Too short, at least 6 characters.", "Занадта кароткі, па крайняй меры 6 сімвалаў."),
("The confirmation is not identical.", "Пацверджанне не супадае"),
("Permissions", "Дазволы"),
("Accept", "Прыняць"),
("Dismiss", "Адхіліць"),
("Disconnect", "Адключыць"),
("Enable file copy and paste", "Дазволіць копіраванне і ўставку файлаў"),
("Connected", "Падключана"),
("Direct and encrypted connection", "Простае і зашыфраванае падключэнне"),
("Relayed and encrypted connection", "Перапасыланае і зашыфраванае падключэнне"),
("Direct and unencrypted connection", "Простае і не зашыфраванае падключэнне"),
("Relayed and unencrypted connection", "Перапасыланае і не зашыфраванае падключэнне"),
("Enter Remote ID", "Увядзіце аддалены ID"),
...
("Enable direct IP access", "Дазволіць просты доступ па IP-адрасе"),
("Rename", "Перайменаваць"),
        ("Space", "Месца"),
("Create desktop shortcut", "Стварыць ярлык на рабочым стале"),
...
("Closed manually by the peer", "Зачынена аддаленым вузлам ручна"),
...
("whitelist_tip", "Толькі IP-адрэсы з белага спісу могуць атрымаць доступ да майго прылады."),
("Login", "Увайсці"),
("Verify", "Праверыць"),
("Remember me", "Запомніць мяне"),
("Trust this device", "Даверыць гэта прылада"),
("Verification code", "Праверачны код"),
("verification_tip", "Выяўлена новае прылада, на зарэгістраваны адрас электроннай пошты адпраўлены праверачны код. Увядзіце яго, каб працягнуць уваход у сістэму."),
("Logout", "Выйсці"),
("Tags", "Цэтлікі"),
        ("Search ID", "Пошук по ID"),
("whitelist_sep", "Раздзел запятой, коскай коскай, прабелам ці новай радкой."),
("Add ID", "Дадаць ID"),
("Add Tag", "Дадаць тэг"),
("Unselect all tags", "Скасаваць выбар усіх метак"),
("Network error", "Памылка сеткі"),
("Username missed", "Адсутнічае імя карыстальніка"),
("Password missed", "Забыты пароль"),
("Wrong credentials", "Няправільныя крэдыціція"),
("The verification code is incorrect or has expired", "Праверачны код няправільны або скончыўся тэрмін яго дзеяння"),
("Edit Tag", "Рэдагаваць метку"),
("Forget Password", "Не запоминаць пароль"),
("Favorites", "Абранае"),
...
("One-Long Tap", "Доўгае націск адным пальцам"),
("Two-Finger Tap", "Націск двума пальцамі"),
("Right Mouse", "Правая кнопка мышы"),
        ("One-Finger Move", "Перамяшчэнне адным пальцам"),
("Double Tap & Move", "Двойны націск і перамяшчэнне"),
("Mouse Drag", "Перацягванне мышчу"),
("Three-Finger vertically", "Трыма пальцамі па вертыкалі"),
("Mouse Wheel", "Кола мышы"),
("Two-Finger Move", "Перамяшчэнне двума пальцамі"),
("Canvas Move", "Перамяшчэнне холста"),
("Pinch to Zoom", "Маштабаванне щыпцамі"),
("Canvas Zoom", "Маштаб холста"),
("Reset canvas", "Скід халста"),
...
("android_input_permission_tip1", "Каб удалёнае ўстройства магло кіраваць вашым Android-прыладай з дапамогай мышы або націсканняў, неабходна дазволіць RustDesk выкарыстоўваць паслугу \"Асаблівыя магчымасці\"."),
("android_input_permission_tip2", "Зайдзіце на адпаведную старонку сістэмных налад, знайдзіце і ўступіце ў \"Ўстаноўленыя паслугі\", ўключыце паслугу \"RustDesk Input\"."),
...
("Peer denied", "Адмова аддаленым вузлам"),
...
("Use permanent password", "Выкарыстоўваць постаянны пароль"),
("Use both passwords", "Выкарыстоўваць абодва паролі"),
("Set permanent password", "Устанавіць постаянны пароль"),
("Enable remote restart", "Дазволіць аддалены перазапуск"),
("Restart remote device", "Перазапусціць аддаленае прылада"),
("Are you sure you want to restart", "Вы ўпэўненыя, што хочаце перазагрузіць?"),
("Restarting remote device", "Прайшоў перазапуск аддаленай прылады"),
("remote_restarting_tip", "Аддаленая прылада перазапускаецца. Закрыйце гэтае паведамленне і праз некаторы час перападключыцеся, выкарыстоўваючы постаянны пароль."),
("Copied", "Скапіравана"),
...
("Ratio", "Суадносіны"),
("Image Quality", "Якасць малюнка"),
("Scroll Style", "Стыль прокруткі"),
("Show Toolbar", "Паказаць панэль інструментаў"),
("Hide Toolbar", "Схаваць панэль інструментаў"),
("Direct Connection", "Прамае злучэнне"),
("Relay Connection", "Рэлейнае злучэнне"),
...
("Dark", "Цёмны"),
("Light", "Светлы"),
("Follow System", "Паводзіцься за сістэмай"),
...
("Deny LAN discovery", "Адмаўленне ад выяўлення ў лакальнай сетцы"),
("Write a message", "Напісаць паведамленне"),
("Prompt", "Падказка"),
        ("Please wait for confirmation of UAC...", "Дачакайцеся пацверджання UAC..."),
("elevated_foreground_window_tip", "Бягучае акно удалёнага рабочага стала патрабуе вышэйшых прывілегій для працы, таму часова немагчыма выкарыстоўваць мыш і клавіятуру. Можна папрасіць аддаленага карыстальніка згорнуць бягучае акно або націснуць кнопку павышэння праваў у акне кіравання падлучэнням. Каб прадухіліць гэтую праблему ў будучыні, рэкамендуецца ўстанавіць праграмнае забеспячэнне на аддаленым прыладзе."),
("Disconnected", "Адключана"),
("Other", "Іншае"),
("Confirm before closing multiple tabs", "Пацвердзіць зачыненне некалькіх ўкладак"),
...
("Wayland requires higher version of linux distro. Please try X11 desktop or change your OS.", "Для Wayland патрабуецца вышэйшая версія дыстрыбутыву Linux. Карыстайцеся рабочым столам X11 або зменіце сваю АС."),
("JumpLink", "Перайсці па спасылцы"),
("Please Select the screen to be shared(Operate on the peer side).", "Выберыце экран для дэманстрацыі (працуйце на бакавой старонцы)."),
...
("Please wait for the remote side to accept your session request...", "Дачакайцеся, пакуль аддаленая старонка прыме ваш запыт на сеанс..."),
("One-time Password", "Аднагаразовы пароль"),
("Use one-time password", "Выкарыстоўваць аднагаразовы пароль"),
("One-time password length", "Даўжыня аднагаразовага пароля"),
("Request access to your device", "Запыт на доступ да вашага прылады"),
("Hide connection management window", "Схаваць акно кіравання падлучэннямі"),
        ("hide_cm_tip", "Дазваляць схаванне ў выпадку, калі прымаюцца сесіі па паролю або выкарыстоўваецца постаянны пароль"),
("wayland_experiment_tip", "Падтрымка Wayland знаходзіцца на эксперымэнтальнай стадыі, калі вам неабходны аўтаматычны доступ, выкарыстоўвайце X11."),
...
("software_render_tip", "Калі ў вас ёсць відэакарта Nvidia і аддаленае акно зачыняецца зразумела пасля падлучэння, магчыма, дапаможа ўстаноўка драйвера Nouveau і выбар выкарыстання праграмнай візуалізацыі. Патрабуецца перазагрузка."),
("Always use software rendering", "Заўсёды выкарыстоўваць праграмную візуалізацыю"),
("config_input", "Каб кіраваць аддаленым рабочым столам праз клавіятуру, неабходна дазволіць RustDesk маніторынг уводу."),
...
("Please confirm if you want to share your desktop?", "Пацвердзіце, калі хочаце дазволіць паказ вашага рабочага стала?"),
("Display", "Адлюстраванне"),
("Default View Style", "Стыль адлюстравання па змаўчанні"),
("Default Scroll Style", "Стыль прокруткі па змаўчанні"),
...
("Codec", "Кодэк"),
("Resolution", "Разразлучэнне"),
("No transfers in progress", "Перадача не ажыццяўляецца"),
("Set one-time password length", "Усталяваць даўжыню адзінразовага пароля"),
...
("login_linux_tip", "Каб ўключыць сеанс рабочага стала X, неабходна ўвайсці ў аддалены акаўнт Linux."),
("verify_rustdesk_password_tip", "Пацвердзіць пароль RustDesk"),
("remember_account_tip", "Запомніць гэты акаўнт"),
("os_account_desk_tip", "Гэты акаўнт выкарыстоўваецца для ўваходу ў аддаленую аперацыйную сістэму і ўключэння сеансу рабочага стала ў рэжыме headless."),
...
("xorg_not_found_text_tip", "Усталюйце Xorg"),
      ("no_desktop_title_tip", "Няма даступных рабочых сталаў"),
("no_desktop_text_tip", "Усталяваце GNOME Desktop"),
("No need to elevate", "Павышэнне праваў не патрабуецца"),
("System Sound", "Сістэмны звук"),
...
("Disable", "Адключыць"),
("Options", "Параметры"),
("resolution_original_tip", "Арыгінальнае разрэшэнне"),
("resolution_fit_local_tip", "Супадзенне з лакальным разрэшэннем"),
("resolution_custom_tip", "Карыстацкае разрэшэнне"),
...
("clipboard_wait_response_timeout_tip", "Час ачаквання адказу капіравання буфера абмену скончыўся"),
("Incoming connection", "Уваходнае падлучэнне"),
("Outgoing connection", "Адходнае падлучэнне"),
("Exit", "Выхад"),
("Open", "Адкрыць"),
...
("synced_peer_readded_tip", "Прылады, якія былі на апошніх сеансах, будуць сінхранізаваныя з адраснай кнігай."),
...
("scam_text1", "Калі вы размаўляеце па тэлефоне з кім-небудзь, каго вы НЕ ВАСТРАЙВАЕЦЕ і НЕ ДАВЕРАЕЦЕ, і ён папрасіць вас выкарыстоўваць RustDesk і запусціць яго службу, не працягвайце і негайна адмяніце размову."),
("scam_text2", "Магчыма, гэта афера, якая паспрабуе ўкраць вашыя грошы або іншую асабістую інфармацыю."),
("Don't show again", "Не паказваць больш"),
("I Agree", "Я згодны"),
("Decline", "Адхіліць"),
("Timeout in minutes", "Час ачаквання (у хвілінах)"),
...
("upgrade_rustdesk_server_pro_to_{}_tip", "Абновіце RustDesk Server Pro да версіі {} або новейшай!"),
("pull_group_failed_tip", "Немагчыма абнавіць групу"),
("Filter by intersection", "Фільтраваць па перасячэнні"),
("Remove wallpaper during incoming sessions", "Схаваць фон рабочага стала падчас ўваходнага сеансу"),
("Test", "Тэст"),
...
("Use all my displays for the remote session", "Выкарыстоўваць усе мае дысплеі для адлеглага сеансу"),
("selinux_tip", "На вашым прыладзе ўключаны SELinux, што можа перашкаджаць правільнай працы RustDesk на кіраванай старонцы."),
...
("True color (4:4:4)", "Праўдзівы колер (4:4:4)"),
...
("idd_not_support_under_win10_2004_tip", "Драйвер непрамой дысплея не падтрымліваецца. Патрабуецца Windows 10 версіі 2004 ці новейшая."),
("switch_display_elevated_connections_tip", "Пераключэнне на неасноўны дысплей не падтрымліваецца ў рэжыме павышэння праваў пры наяўнасці некалькіх падлучэнняў. Паўторыце спробу пасля ўстаноўкі, калі хочаце кіраваць некалькімі дысплеямі."),
("input_source_1_tip", "Крыніца ўводу 1"),
("input_source_2_tip", "Крыніца ўводу 2"),
("capture_display_elevated_connections_tip", "Захоп экрана некалькіх дысплеяў не падтрымліваецца ў рэжыме павышэння праваў. Паўторыце спробу пасля ўстаноўкі, калі хочаце кіраваць некалькімі дысплеямі."),
...
("enable-2fa-desc", "Наладзьце прыкладанне аўтэнтыфікацыі. Выкарыстоўвайце, напрыклад, Authy, Microsoft або Google Authenticator на тэлефоне ці кампутары.\n\nСкануйце QR-код з дапамогай прыкладання аўтэнтыфікацыі і ўвядзіце код, які пакажа гэта прыкладанне, каб уключыць двухфактарную аўтэнтыфікацыю."),
...
("preset_password_warning", "Гэта спецыялізаваная версія з устаноўленым заздалегіды паролем. Любы, хто ведае гэты пароль, можа атрымаць поўны кантроль над вашай прыладай. Калі гэта для вас нечакана, адразу выдаліце гэта праграмнае забеспячэнне."),
...
("allow-only-conn-window-open-tip", "Дазволіць толькі падключэнне пры адкрытай акне RustDesk"),
...
("Follow remote cursor", "Сачыць за адлеглым курсарам"),
("Follow remote window focus", "Сачыць за фокусам адлеглага акна"),
("default_proxy_tip", "Пратакол і порт па змаўчанні: Socks5 і 1080"),
("no_audio_input_device_tip", "Устройства ўваходнага аудыё не знойдзена."),
("Incoming", "Уваходныя"),
("Outgoing", "Адыходныя"),
("Clear Wayland screen selection", "Адмяніць выбар экрана Wayland"),
("clear_Wayland_screen_selection_tip", "Пасля адмяны можна зноў выбраць экран для дэманстрацыі."),
("confirm_clear_Wayland_screen_selection_tip", "Адмяніць выбар экрана Wayland?"),
("android_new_voice_call_tip", "Атрыманы новы запыт на голасавы выклік. Калі вы прымеце яго, гук пераключыцца на голасавае злучэнне."),
("texture_render_tip", "Выкарыстоўваць візуалізацыю тэкстураў для зраблення малюнкаў болей плыннымі."),
