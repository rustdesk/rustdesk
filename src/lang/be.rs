...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Block user input", "Заблакіраваць ўвод на аддаленай прыладзе"),
        ("Unblock user input", "Разблакіраваць ўвод на аддаленай прыладзе"),
        ...
        ("Run without install", "Запусціць без ўсталявання"),
        ...
        ("Direct Connection", "Прамаое падключэнне"),
        ...
        ("Please confirm if you want to share your desktop?", "Вы сапраўды дазваляеце дэмантрацыю працоўнага стала?"),
        ...
        ("login_linux_tip", "Каб ўключыць сеанс працоўнага стала X, трэба ўвайсці ў аддалены ўліковы запіс Linux."),
        ...
        ("Open connection in new tab", "Адкрыць падключэнне ў новай ўкладцы"),
