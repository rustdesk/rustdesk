...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Output resolution", "רזולוציית פלט"),
        ("Width", "רוחב"),
        ("Height", "גובה"),
        ("Swap width and height", "החלפת רוחב וגובה"),
        ("Current resolution", "הרזולוציה הנוכחית"),
        ("Reset changes", "איפוס השינויים"),
        ("Select a resolution supported by the display", "יש לבחור רזולוציה הנתמכת על ידי המסך"),
        ("Display settings changed. Reopen the resolution menu and try again.", "הגדרות התצוגה השתנו. יש לפתוח מחדש את תפריט הרזולוציה ולנסות שוב."),
        ("Closest supported resolution", "הרזולוציה הנתמכת הקרובה ביותר"),
        ("Adjusted to display limits", "הותאם למגבלות המסך"),
        ("Local resolution is unavailable or unsupported", "הרזולוציה המקומית אינה זמינה או אינה נתמכת"),
        ("Looks like", "נראה כמו"),
        ("Rendering quality", "איכות העיבוד"),
        ("Standard", "רגילה"),
        ("Enter dimensions within the range", "יש להזין ממדים בטווח המותר"),
        ("Aspect ratio", "יחס גובה־רוחב"),
        ("Available resolutions", "רזולוציות זמינות"),
        ("System scaling", "קנה המידה של המערכת"),
        ("Recommended", "מומלץ"),
        ("System scaling is unavailable for this display or desktop environment.", "שינוי קנה המידה של המערכת אינו זמין למסך או לסביבת שולחן העבודה הזו."),
        ("The system did not apply the requested scale. Refresh and try again.", "המערכת לא החילה את קנה המידה המבוקש. יש לרענן ולנסות שוב."),
        ("Select a scaling level supported by the display.", "יש לבחור רמת קנה מידה הנתמכת על ידי המסך."),
        ("No permission to change display settings.", "אין הרשאה לשנות את הגדרות התצוגה."),
        ("Invalid display scaling request.", "בקשה לא תקינה לשינוי קנה המידה של התצוגה."),
        ("Display settings are busy. Try again.", "הגדרות התצוגה עסוקות. יש לנסות שוב."),
        ("Display settings timed out. Refresh and try again.", "פג הזמן הקצוב להגדרות התצוגה. יש לרענן ולנסות שוב."),
        ("Use nearest supported scale", "שימוש בקנה המידה הנתמך הקרוב ביותר"),
        ("Scaling was applied, but the resolution request failed.", "קנה המידה הוחל, אך בקשת הרזולוציה נכשלה."),
        ("Failed to change display settings", "שינוי הגדרות התצוגה נכשל"),
        ("Remote connection has closed", "החיבור המרוחק נסגר"),
        ("Failed to resize macOS virtual display", "שינוי גודל המסך הווירטואלי של macOS נכשל"),
        ("Failed to toggle macOS virtual display", "הפעלה או השבתה של המסך הווירטואלי של macOS נכשלה"),
        ("Failed to start macOS virtual display worker", "הפעלת תהליכון העבודה למסכים וירטואליים של macOS נכשלה"),
        ("Virtual display dimensions must be between 320 and 4096", "ממדי המסך הווירטואלי חייבים להיות בין 320 ל־4096"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "קנה המידה של המסך הווירטואלי חייב להיות 1 או 2, ושני הממדים בפיקסלים חייבים להתחלק בו ללא שארית"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "ממדי המסך הווירטואלי חייבים להיות בין 1 ל־4096 פיקסלים לוגיים"),
        ("Display configuration response is too large.", "תגובת תצורת התצוגה גדולה מדי."),
        ("Invalid display scaling response", "תגובה לא תקינה לקנה המידה של התצוגה"),
        ("Invalid display scaling levels", "רמות לא תקינות של קנה המידה של התצוגה"),
        ("Invalid display scaling range", "טווח לא תקין של קנה המידה של התצוגה"),
        ("Interface size", "גודל הממשק"),
        ("Current interface size", "גודל הממשק הנוכחי"),
    ].iter().cloned().collect();
}
