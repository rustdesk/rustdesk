...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Reset changes", "重置修改"),
        ("Select a resolution supported by the display", "请选择此显示器支持的分辨率"),
        ("Display settings changed. Reopen the resolution menu and try again.", "显示设置已变化，请重新打开分辨率菜单后重试。"),
        ("Closest supported resolution", "最接近的可用分辨率"),
        ("Adjusted to display limits", "已按显示器限制调整"),
        ("Local resolution is unavailable or unsupported", "无法获取本机分辨率，或没有可用的匹配模式"),
        ("Looks like", "看起来像"),
        ("Rendering quality", "渲染清晰度"),
        ("Standard", "标准"),
        ("Enter dimensions within the range", "请输入范围内的宽高"),
        ("Aspect ratio", "宽高比"),
        ("Available resolutions", "可用分辨率"),
        ("System scaling", "系统缩放"),
        ("Recommended", "推荐"),
        ("System scaling is unavailable for this display or desktop environment.", "此显示器或桌面环境暂不支持系统缩放。"),
        ("The system did not apply the requested scale. Refresh and try again.", "系统未应用所选缩放比例，请刷新后重试。"),
        ("Select a scaling level supported by the display.", "请选择显示器支持的缩放比例。"),
        ("No permission to change display settings.", "没有更改显示设置的权限。"),
        ("Invalid display scaling request.", "显示缩放请求无效。"),
        ("Display settings are busy. Try again.", "正在处理显示设置，请稍后重试。"),
        ("Display settings timed out. Refresh and try again.", "显示设置请求超时，请刷新后重试。"),
        ("Use nearest supported scale", "使用最接近的可用缩放值"),
        ("Scaling was applied, but the resolution request failed.", "缩放已应用，但分辨率请求失败。"),
        ("Failed to change display settings", "无法更改显示设置"),
        ("Remote connection has closed", "远程连接已关闭"),
        ("Failed to resize macOS virtual display", "无法调整 macOS 虚拟显示器的大小"),
        ("Failed to toggle macOS virtual display", "无法启用或禁用 macOS 虚拟显示器"),
        ("Failed to start macOS virtual display worker", "无法启动 macOS 虚拟显示器工作线程"),
        ("Virtual display dimensions must be between 320 and 4096", "虚拟显示器的宽高必须介于 320 和 4096 之间"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "虚拟显示器缩放倍率必须为 1 或 2，且像素宽高都必须能被该倍率整除"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "虚拟显示器的宽高必须介于 1 和 4096 个逻辑像素之间"),
        ("Display configuration response is too large.", "显示配置响应过大。"),
        ("Invalid display scaling response", "显示缩放响应无效"),
        ("Invalid display scaling levels", "显示缩放等级无效"),
