...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("outgoing_only_desk_tip", "当前版本的软件仅支持发起连接。\n您可以连接至其他设备，但是其他设备无法连接至您的设备。"),
        ...
        ("Team", "团队"),
        ("User", "用户"),
        ("deploy-code-requirement-tip", "部署码必须为12位"),
        ("Invalid deploy code", "无效的部署码"),
        ("Email missed", "邮箱没有填写"),
        ("Login failed", "登录失败"),
        ("Checking deployment...", "检查部署中..."),
        ("Deploying...", "部署中..."),
        ("Deploy with deploy code", "使用部署码部署"),
        ("Deploy with account", "使用账号部署"),
        ("Deploy Code", "部署码"),
        ("Enter 12-character code", "输入12位部署码"),
        ("Deployment Information", "部署信息"),
        ("Email", "邮箱"),
        ("deploy-confirm-tip", "确定要部署到这个团队吗？"),
        ("Confirm", "确认"),
        ("Deploy now", "立即部署"),
        ("Hide left panel", "隐藏左侧栏"),
        ("Show left panel", "显示左侧栏"),
        ("Register", "注册"),
        ("Web Console", "Web 控制台"),
        ("Device Group", "设备组"),
        ("Deployment", "部署"),
