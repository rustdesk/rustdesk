...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("About", "详情信息"),
        ("Slogan_tip", ""),
        ("Privacy Statement", "RustDesk 开源项目"),
        ("Mute", "静音"),
        ("Build Date", "版本日期"),
        ("Version", "版本代号"),
        ("Home", "主页"),
        ...
        ("Privacy mode", "隐私模式"),
        ("Block user input", "阻止用户操作"),
        ("Unblock user input", "取消阻止用户操作"),
        ("Adjust Window", "调节窗口"),
        ("Original", "原始比例"),
        ("Shrink", "收缩"),
        ("Stretch", "伸展"),
        ...
        ("Show quality monitor", "显示质量信息"),
        ("Disable clipboard", "禁用剪贴板"),
        ("Lock after session end", "会话结束后锁定远程设备"),
        ("Insert", "插入"),
        ("Insert Lock", "锁定远程设备"),
        ("Refresh", "刷新画面"),
        ("ID does not exist", "ID 不存在"),
        ("Failed to connect to rendezvous server", "连接失败"),
        ("Please try later", "请稍后再试"),
        ("Remote desktop is offline", "远程设备处于离线状态"),
        ("Key mismatch", "连接密钥错误！"),
        ("Timeout", "连接超时"),
        ...
        ("setup_server_tip", "基于RustDesk开源项目二次开发，由灰太狼叔叔运营！"),
        ...
        ("empty_address_book_tip", "似乎目前云端内无被控端"),
        ("eg: admin", "例如：admin"),
        ("Empty Username", "空用户名"),
        ("Empty Password", "空密码"),
        ("Me", "我"),
        ...
        ("Select", "选择"),
        ("Toggle Tags", "切换标签"),
        ("pull_ab_failed_tip", "获取云端设备失败"),
        ("push_ab_failed_tip", "上传云端设备失败"),
        ("synced_peer_readded_tip", "历史会话中存在的设备将会被重新同步到云端。"),
        ("Change Color", "更改颜色"),
        ("Primary Color", "基本色"),
        ("HSV Color", "HSV 色"),
