...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Direct", "直连"),
        ("Relay", "中继"),
        ("No saved device matches. Enter an ID above.", "没有匹配的已保存设备，请在上方输入 ID。"),
        ("The RustDesk session is not end-to-end encrypted.", "RustDesk 会话未启用端到端加密。"),
        ("Legacy forwarding is active. TCP payload leaves the RustDesk encrypted session after login.", "当前使用旧版转发模式。登录完成后，TCP 数据将离开 RustDesk 加密会话。"),
        ("Unable to open", "无法打开"),
        ("No port forwards configured", "尚未配置端口转发"),
        ("Start Tunnel", "启动隧道"),
        ("Stop Tunnel", "停止隧道"),
        ("Open in Browser", "在浏览器中打开"),
        ("Copy Local URL", "复制本地地址"),
        ("Local URL copied", "本地地址已复制"),
        ...
        ("Legacy", "旧版"),
        ("Port mappings", "端口映射"),
        ("Range: 1024-65535", "范围：1024-65535"),
        ("Range: 1-65535", "范围：1-65535"),
        ("Local port must be between 1024 and 65535.", "本地端口必须在 1024 到 65535 之间。"),
        ("Remote port must be between 1 and 65535.", "远程端口必须在 1 到 65535 之间。"),
        ("Remote host is required.", "远程主机不能为空。"),
        ("Local port is already configured", "本地端口已配置"),
        ("Save", "保存"),
        ("RustDesk ID is required.", "请输入 RustDesk ID。"),
        ("Add at least one port forward.", "请至少添加一个端口转发。"),
        ("Tunnel started", "隧道已启动"),
