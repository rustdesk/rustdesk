...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Width", "Šírka"),
        ("Height", "Výška"),
        ("Swap width and height", "Vymeniť šírku a výšku"),
        ("Current resolution", "Aktuálne rozlíšenie"),
        ("Reset changes", "Obnoviť zmeny"),
        ("Select a resolution supported by the display", "Vyberte rozlíšenie podporované displejom"),
        ("Display settings changed. Reopen the resolution menu and try again.", "Nastavenia displeja sa zmenili. Znova otvorte ponuku rozlíšenia a skúste to opäť."),
        ("Closest supported resolution", "Najbližšie podporované rozlíšenie"),
        ("Adjusted to display limits", "Prispôsobené limitom displeja"),
        ("Local resolution is unavailable or unsupported", "Miestne rozlíšenie nie je dostupné alebo podporované"),
        ("Looks like", "Vyzerá ako"),
        ("Rendering quality", "Kvalita vykresľovania"),
        ("Standard", "Štandardná"),
        ("Enter dimensions within the range", "Zadajte rozmery v povolenom rozsahu"),
        ("Aspect ratio", "Pomer strán"),
        ("Available resolutions", "Dostupné rozlíšenia"),
        ("System scaling", "Systémová mierka"),
        ("Recommended", "Odporúčané"),
        ("System scaling is unavailable for this display or desktop environment.", "Systémová mierka nie je pre tento displej alebo pracovné prostredie dostupná."),
        ("The system did not apply the requested scale. Refresh and try again.", "Systém nepoužil požadovanú mierku. Obnovte údaje a skúste to znova."),
        ("Select a scaling level supported by the display.", "Vyberte úroveň mierky podporovanú displejom."),
        ("No permission to change display settings.", "Nemáte oprávnenie meniť nastavenia displeja."),
        ("Invalid display scaling request.", "Neplatná požiadavka na mierku displeja."),
        ("Display settings are busy. Try again.", "Nastavenia displeja sú zaneprázdnené. Skúste to znova."),
        ("Display settings timed out. Refresh and try again.", "Časový limit nastavení displeja vypršal. Obnovte údaje a skúste to znova."),
        ("Use nearest supported scale", "Použiť najbližšiu podporovanú mierku"),
        ("Scaling was applied, but the resolution request failed.", "Mierka bola použitá, ale požiadavka na rozlíšenie zlyhala."),
        ("Failed to change display settings", "Nepodarilo sa zmeniť nastavenia displeja"),
        ("Remote connection has closed", "Vzdialené pripojenie bolo zatvorené"),
        ("Failed to resize macOS virtual display", "Nepodarilo sa zmeniť veľkosť virtuálneho displeja macOS"),
        ("Failed to toggle macOS virtual display", "Nepodarilo sa zapnúť alebo vypnúť virtuálny displej macOS"),
        ("Failed to start macOS virtual display worker", "Nepodarilo sa spustiť pracovný proces virtuálnych displejov macOS"),
        ("Virtual display dimensions must be between 320 and 4096", "Rozmery virtuálneho displeja musia byť medzi 320 a 4096"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "Mierka virtuálneho displeja musí byť 1 alebo 2 a oba rozmery v pixeloch ňou musia byť deliteľné bezo zvyšku"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "Rozmery virtuálneho displeja musia byť medzi 1 a 4096 logickými pixelmi"),
        ("Display configuration response is too large.", "Odpoveď s konfiguráciou displeja je príliš veľká."),
        ("Invalid display scaling response", "Neplatná odpoveď o mierke displeja"),
        ("Invalid display scaling levels", "Neplatné úrovne mierky displeja"),
        ("Invalid display scaling range", "Neplatný rozsah mierky displeja"),
        ("Interface size", "Veľkosť rozhrania"),
        ("Current interface size", "Aktuálna veľkosť rozhrania"),
    ].iter().cloned().collect();
}
