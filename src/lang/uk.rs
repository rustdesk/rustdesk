...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Listening ...", "Очікування з'єднання..."),
        ...
        ("Wrong credentials", "Неправильні облікові дані"),
        ...
        ("texture_render_tip", "Використовувати рендеринг текстур для плавнішого відображення."),
        ...
        ("cancel-bot-confirm-tip", "Ви впевнені, що хочете вимкнути бота Telegram?"),
        ...
        ("Platform", "Платформа"),
        ("Days remaining", "Днів залишилося"),
        ...
        ("Printer", "Принтер"),
        ("printer-os-requirement-tip", "Функція віддаленого друку потребує Windows 10 або новішої версії."),
        ...
        ("server-oss-not-support-tip", "ПРИМІТКА: RustDesk Server OSS не підтримує цю функцію."),
