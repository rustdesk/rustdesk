...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("view_camera_unsupported_tip", "Перегляд камери не підтримується."),
        ("Enable camera", "Увімкнути камеру"),
        ("No cameras", "Камер не знайдено"),
        ("d3d_render_tip", "Увімкніть цей параметр для покращеного рендерингу."),
        ("Use D3D rendering", "Використовувати D3D рендеринг"),
        ("Printer", "Принтер"),
        ("printer-os-requirement-tip", "Для використання принтера необхідна відповідна версія операційної системи."),
        ("printer-requires-installed-{}-client-tip", "Для використання принтера необхідно встановити клієнт {}."),
        ("printer-{}-not-installed-tip", "Принтер {} не встановлено."),
        ("printer-{}-ready-tip", "Принтер {} готовий до роботи."),
        ("Install {} Printer", "Встановити принтер {}"),
        ("Outgoing Print Jobs", "Вихідні завдання друку"),
        ("Incomming Print Jobs", "Вхідні завдання друку"),
        ...
        ("auto-print-tip", "Автоматично друкувати вхідні завдання."),
        ("print-incoming-job-confirm-tip", "Підтвердити друк вхідного завдання."),
        ("remote-printing-disallowed-tile-tip", "Віддалений друк заборонено."),
        ("remote-printing-disallowed-text-tip", "Адміністратор заборонив використання віддаленого друку."),
