...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Output resolution", "Вихідна роздільна здатність"),
        ("Width", "Ширина"),
        ("Height", "Висота"),
        ("Swap width and height", "Поміняти ширину й висоту"),
        ("Current resolution", "Поточна роздільна здатність"),
        ("Reset changes", "Скинути зміни"),
        ("Select a resolution supported by the display", "Виберіть роздільну здатність, яку підтримує дисплей"),
        ("Display settings changed. Reopen the resolution menu and try again.", "Налаштування дисплея змінилися. Знову відкрийте меню роздільної здатності та повторіть спробу."),
        ("Closest supported resolution", "Найближча підтримувана роздільна здатність"),
        ("Adjusted to display limits", "Пристосовано до обмежень дисплея"),
        ("Local resolution is unavailable or unsupported", "Локальна роздільна здатність недоступна або не підтримується"),
        ("Looks like", "Виглядає як"),
        ("Rendering quality", "Якість відтворення"),
        ("Standard", "Стандартна"),
        ("Enter dimensions within the range", "Введіть розміри в допустимому діапазоні"),
        ("Aspect ratio", "Співвідношення сторін"),
        ("Available resolutions", "Доступні роздільні здатності"),
        ("System scaling", "Системне масштабування"),
        ("Recommended", "Рекомендовано"),
        ("System scaling is unavailable for this display or desktop environment.", "Системне масштабування недоступне для цього дисплея або середовища стільниці."),
        ("The system did not apply the requested scale. Refresh and try again.", "Система не застосувала запитаний масштаб. Оновіть дані та повторіть спробу."),
        ("Select a scaling level supported by the display.", "Виберіть рівень масштабування, який підтримує дисплей."),
        ("No permission to change display settings.", "Немає дозволу на зміну налаштувань дисплея."),
        ("Invalid display scaling request.", "Некоректний запит масштабування дисплея."),
        ...
        ("Failed to toggle macOS virtual display", "Не вдалося ввімкнути або вимкнути віртуальний дисплей macOS"),
        ("Failed to start macOS virtual display worker", "Не вдалося запустити робочий процес віртуальних дисплеїв macOS"),
        ("Virtual display dimensions must be between 320 and 4096", "Розміри віртуального дисплея мають бути в межах від 320 до 4096"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "Масштаб віртуального дисплея має дорівнювати 1 або 2, а обидва розміри в пікселях мають ділитися на нього без остачі"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "Розміри віртуального дисплея мають бути в межах від 1 до 4096 логічних пікселів"),
        ("Display configuration response is too large.", "Відповідь із конфігурацією дисплея завелика."),
        ("Invalid display scaling response", "Некоректна відповідь щодо масштабування дисплея"),
        ("Invalid display scaling levels", "Некоректні рівні масштабування дисплея"),
        ("Invalid display scaling range", "Некоректний діапазон масштабування дисплея"),
