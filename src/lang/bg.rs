...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("drm_capture_tip", "Достъпно е директно заснемане чрез DRM/KMS — не се изисква съгласие от портала. Поддържа достъп без наблюдение и заснемане на екрана за вход."),
