...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Width", "Ширина"),
        ("Height", "Височина"),
        ("Swap width and height", "Размяна на ширината и височината"),
        ("Current resolution", "Текуща разделителна способност"),
        ("Reset changes", "Нулиране на промените"),
        ("Select a resolution supported by the display", "Изберете разделителна способност, поддържана от дисплея"),
        ("Display settings changed. Reopen the resolution menu and try again.", "Настройките на дисплея са променени. Отворете отново менюто за разделителна способност и опитайте пак."),
        ("Closest supported resolution", "Най-близката поддържана разделителна способност"),
        ("Adjusted to display limits", "Съобразено с ограниченията на дисплея"),
        ("Local resolution is unavailable or unsupported", "Локалната разделителна способност е недостъпна или не се поддържа"),
        ("Looks like", "Изглежда като"),
        ("Rendering quality", "Качество на изобразяване"),
        ("Standard", "Стандартно"),
        ("Enter dimensions within the range", "Въведете размери в допустимия диапазон"),
        ("Aspect ratio", "Съотношение на страните"),
        ("Available resolutions", "Налични разделителни способности"),
        ("System scaling", "Системно мащабиране"),
        ("Recommended", "Препоръчително"),
        ("System scaling is unavailable for this display or desktop environment.", "Системното мащабиране е недостъпно за този дисплей или работна среда."),
        ("The system did not apply the requested scale. Refresh and try again.", "Системата не приложи заявения мащаб. Опреснете и опитайте отново."),
        ("Select a scaling level supported by the display.", "Изберете ниво на мащабиране, поддържано от дисплея."),
        ("No permission to change display settings.", "Нямате разрешение за промяна на настройките на дисплея."),
        ("Invalid display scaling request.", "Невалидна заявка за мащабиране на дисплея."),
        ("Display settings are busy. Try again.", "Настройките на дисплея са заети. Опитайте отново."),
        ("Display settings timed out. Refresh and try again.", "Времето за изчакване на настройките на дисплея изтече. Опреснете и опитайте отново."),
        ("Use nearest supported scale", "Използване на най-близкия поддържан мащаб"),
        ("Scaling was applied, but the resolution request failed.", "Мащабът е приложен, но заявката за разделителна способност е неуспешна."),
        ("Failed to change display settings", "Неуспешна промяна на настройките на дисплея"),
        ("Remote connection has closed", "Отдалечената връзка е затворена"),
        ("Failed to resize macOS virtual display", "Неуспешно преоразмеряване на виртуалния дисплей на macOS"),
        ("Failed to toggle macOS virtual display", "Неуспешно включване или изключване на виртуалния дисплей на macOS"),
        ("Failed to start macOS virtual display worker", "Неуспешно стартиране на работния процес за виртуални дисплеи на macOS"),
        ("Virtual display dimensions must be between 320 and 4096", "Размерите на виртуалния дисплей трябва да са между 320 и 4096"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "Мащабът на виртуалния дисплей трябва да е 1 или 2 и да дели без остатък двата размера в пиксели"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "Размерите на виртуалния дисплей трябва да са между 1 и 4096 логически пиксела"),
        ("Display configuration response is too large.", "Отговорът с конфигурацията на дисплея е твърде голям."),
        ("Invalid display scaling response", "Невалиден отговор за мащабирането на дисплея"),
        ("Invalid display scaling levels", "Невалидни нива на мащабиране на дисплея"),
