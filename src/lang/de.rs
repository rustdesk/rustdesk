...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Output resolution", "Ausgabeauflösung"),
        ("Width", "Breite"),
        ("Height", "Höhe"),
        ("Swap width and height", "Breite und Höhe tauschen"),
        ("Current resolution", "Aktuelle Auflösung"),
        ("Reset changes", "Änderungen zurücksetzen"),
        ("Select a resolution supported by the display", "Wählen Sie eine vom Bildschirm unterstützte Auflösung"),
        ("Display settings changed. Reopen the resolution menu and try again.", "Die Anzeigeeinstellungen haben sich geändert. Öffnen Sie das Auflösungsmenü erneut und versuchen Sie es noch einmal."),
        ("Closest supported resolution", "Nächstgelegene unterstützte Auflösung"),
        ("Adjusted to display limits", "An die Bildschirmgrenzen angepasst"),
        ("Local resolution is unavailable or unsupported", "Die lokale Auflösung ist nicht verfügbar oder wird nicht unterstützt"),
        ("Looks like", "Sieht aus wie"),
        ("Rendering quality", "Darstellungsqualität"),
        ("Standard", "Standard"),
        ("Enter dimensions within the range", "Geben Sie Abmessungen innerhalb des Bereichs ein"),
        ("Aspect ratio", "Seitenverhältnis"),
        ("Available resolutions", "Verfügbare Auflösungen"),
        ("System scaling", "Systemskalierung"),
        ("Recommended", "Empfohlen"),
        ("System scaling is unavailable for this display or desktop environment.", "Die Systemskalierung ist für diesen Bildschirm oder diese Desktop-Umgebung nicht verfügbar."),
        ("The system did not apply the requested scale. Refresh and try again.", "Das System hat die angeforderte Skalierung nicht übernommen. Aktualisieren Sie die Einstellungen und versuchen Sie es erneut."),
        ("Select a scaling level supported by the display.", "Wählen Sie eine vom Bildschirm unterstützte Skalierungsstufe."),
        ("No permission to change display settings.", "Keine Berechtigung zum Ändern der Anzeigeeinstellungen."),
        ("Invalid display scaling request.", "Ungültige Anfrage zur Anzeigeskalierung."),
        ("Display settings are busy. Try again.", "Die Anzeigeeinstellungen werden gerade bearbeitet. Versuchen Sie es erneut."),
        ("Display settings timed out. Refresh and try again.", "Zeitüberschreitung bei den Anzeigeeinstellungen. Aktualisieren Sie die Einstellungen und versuchen Sie es erneut."),
        ("Use nearest supported scale", "Nächstgelegene unterstützte Skalierung verwenden"),
        ("Scaling was applied, but the resolution request failed.", "Die Skalierung wurde übernommen, aber die Auflösungsanfrage ist fehlgeschlagen."),
        ("Failed to change display settings", "Anzeigeeinstellungen konnten nicht geändert werden"),
        ("Remote connection has closed", "Die Remote-Verbindung wurde geschlossen"),
        ("Failed to resize macOS virtual display", "Die Größe des virtuellen macOS-Bildschirms konnte nicht geändert werden"),
        ("Failed to toggle macOS virtual display", "Der virtuelle macOS-Bildschirm konnte nicht ein- oder ausgeschaltet werden"),
        ("Failed to start macOS virtual display worker", "Der Arbeitsprozess für virtuelle macOS-Bildschirme konnte nicht gestartet werden"),
        ("Virtual display dimensions must be between 320 and 4096", "Die Abmessungen des virtuellen Bildschirms müssen zwischen 320 und 4096 liegen"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "Die Skalierung des virtuellen Bildschirms muss 1 oder 2 sein und beide Pixelabmessungen ganzzahlig teilen"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "Die Abmessungen des virtuellen Bildschirms müssen zwischen 1 und 4096 logischen Pixeln liegen"),
        ("Display configuration response is too large.", "Die Antwort zur Anzeigekonfiguration ist zu groß."),
        ("Invalid display scaling response", "Ungültige Antwort zur Anzeigeskalierung"),
        ("Invalid display scaling levels", "Ungültige Anzeigeskalierungsstufen"),
        ("Invalid display scaling range", "Ungültiger Anzeigeskalierungsbereich"),
        ("Interface size", "Größe der Benutzeroberfläche"),
        ("Current interface size", "Aktuelle Größe der Benutzeroberfläche"),
    ].iter().cloned().collect();
}
