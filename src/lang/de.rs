...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Verbinden mit dem nbfw-Netzwerk …"),
        ...
        ("install_tip", "Aufgrund der Benutzerkontensteuerung (UAC) kann Fernwartungstool-LX in manchen Fällen nicht ordnungsgemäß funktionieren. Um die Benutzerkontensteuerung zu umgehen, klicken Sie bitte auf die Schaltfläche unten und installieren Fernwartungstool-LX auf dem System."),
        ...
        ("config_acc", "Um Ihren PC aus der Ferne zu steuern, müssen Sie Fernwartungstool-LX Zugriffsrechte erteilen."),
        ("config_screen", "Um aus der Ferne auf Ihren PC zugreifen zu können, müssen Sie Fernwartungstool-LX die Berechtigung \"Bildschirmaufnahme\" erteilen."),
        ...
        ("android_input_permission_tip1", "Damit ein entferntes Gerät Ihr Android-Gerät steuern kann, müssen Sie Fernwartungstool-LX erlauben, den Dienst \"Barrierefreiheit\" zu verwenden."),
        ("android_input_permission_tip2", "Bitte gehen Sie zur nächsten Systemeinstellungsseite, suchen Sie \"Installierte Dienste\" und schalten Sie den Dienst \"Fernwartungstool-LX Input\" ein."),
        ...
        ("Language", "Sprache"),
        ("Keep Fernwartungstool-LX background service", "Fernwartungstool-LX im Hintergrund ausführen"),
        ...
        ("Show Fernwartungstool-LX", "Fernwartungstool-LX anzeigen"),
        ("This PC", "Dieser PC"),
        ("or", "oder"),
        ...
        ("config_input", "Um den entfernten Desktop mit der Tastatur steuern zu können, müssen Sie Fernwartungstool-LX die Berechtigung \"Eingabeüberwachung\" erteilen."),
        ("config_microphone", "Um aus der Ferne sprechen zu können, müssen Sie Fernwartungstool-LX die Berechtigung \"Audio aufzeichnen\" erteilen."),
        ...
        ("still_click_uac_tip", "Der entfernte Benutzer muss immer noch im UAC-Fenster von Fernwartungstool-LX auf \"Ja\" klicken."),
        ...
        ("verify_Fernwartungstool-LX_password_tip", "Fernwartungstool-LX-Passwort bestätigen"),
        ...
        ("scam_text1", "Wenn Sie mit jemandem telefonieren, den Sie NICHT KENNEN, dem Sie NICHT VERTRAUEN und der Sie gebeten hat, Fernwartungstool-LX zu benutzen und den Dienst zu starten, fahren Sie nicht fort und legen Sie sofort auf."),
        ...
        ("upgrade_Fernwartungstool-LX_server_pro_to_{}_tip", "Bitte aktualisieren Sie Fernwartungstool-LX Server Pro auf die Version {} oder neuer!"),
        ...
        ("selinux_tip", "SELinux ist auf Ihrem Gerät aktiviert, was dazu führen kann, dass Fernwartungstool-LX als kontrollierte Seite nicht richtig läuft."),
        ...
        ("powered_by_me", "Unterstützt von Fernwartungstool-LX"),
        ("outgoing_only_desk_tip", "Dies ist eine benutzerdefinierte Ausgabe von Fernwartungstool-LX.\nSie können eine Verbindung zu anderen Geräten herstellen, aber andere Geräte können keine Verbindung zu Ihrem Gerät herstellen."),
        ("preset_password_warning", "Dies ist eine benutzerdefinierte Ausgabe von Fernwartungstool-LX mit einem voreingestellten Passwort. Jeder, der dieses Passwort kennt, kann die volle Kontrolle über Ihr Gerät erlangen. Wenn Sie dies nicht beabsichtigen, deinstallieren Sie diese Software bitte umgehend."),
        ...
        ("allow-only-conn-window-open-tip", "Verbindung nur zulassen, wenn das Fernwartungstool-LX-Fenster geöffnet ist"),
        ...
        ("floating_window_tip", "Es hilft dabei, Fernwartungstool-LX im Hintergrund auszuführen."),
        ...
        ("About Fernwartungstool-LX", "Über Fernwartungstool-LX"),
