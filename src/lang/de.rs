...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Verbinden mit dem GerarDesk-Netzwerk..."),
        ...
        ("install_tip", "Aufgrund der Benutzerkontensteuerung (UAC) kann GerarDesk in manchen Fällen nicht ordnungsgemäß funktionieren. Um die Benutzerkontensteuerung zu umgehen, klicken Sie bitte auf die Schaltfläche unten, um GerarDesk auf dem System zu installieren"),
        ("Click to upgrade", "Upgrade"),
        ("Click to download", "Zum Herunterladen klicken"),
        ("Click to update", "Update"),
        ("Configure", "Konfigurieren"),
        ("config_acc", "Um Ihren PC aus der Ferne zu steuern, müssen Sie GerarDesk Zugriffsrechte erteilen."),
        ("config_screen", "Um aus der Ferne auf Ihren PC zugreifen zu können, müssen Sie GerarDesk \"Bildschirm-Aufnahme\"-Berechtigung erteilen."),
        ...
        ("android_input_permission_tip1", "Damit ein Remote-Gerät Ihr Android-Gerät steuern kann, müssen Sie GerarDesk erlauben, den Dienst \"Barrierefreiheit\" zu verwenden."),
        ("android_input_permission_tip2", "Bitte gehen Sie zur nächsten Systemeinstellungsseite, suchen und geben Sie [Installierte Dienste] ein, schalten Sie den Dienst [GerarDesk Input] ein."),
        ...
        ("Language", "Sprache"),
        ("Keep GerarDesk background service", "GerarDesk im Hintergrund ausführen"),
        ...
        ("Show GerarDesk", "GerarDesk anzeigen"),
        ("This PC", "Dieser PC"),
        ("or", "oder"),
