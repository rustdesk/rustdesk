...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Verbinde mit dem IT-Breitenstein Fernwartung-Netzwerk …"),
        ...
        ("Website", "Webseite"),
        ("About", "Über"),
        ("Slogan_tip", "Definitiv kein Virus /ᐠ-ꞈ-ᐟ\\"),
        ...
        ("install_tip", "Um UAC zu vermeiden, installieren Sie bitte IT-B Fernwartung auf dem System."),
        ...
        ("config_acc", "Um Ihren PC aus der Ferne zu steuern, müssen Sie Breitenstein IT Zugriffsrechte erteilen."),
        ("config_screen", "Um aus der Ferne auf Ihren PC zugreifen zu können, müssen Sie Breitenstein IT die Berechtigung \"Bildschirmaufnahme\" erteilen."),
        ...
        ("setup_server_tip", "Verbunden mit einem IT-Breitenstein Server"),
        ...
        ("android_input_permission_tip1", "Damit ein entferntes Gerät Ihr Android-Gerät steuern kann, müssen Sie Breitenstein IT erlauben, den Dienst \"Barrierefreiheit\" zu verwenden."),
        ("android_input_permission_tip2", "Bitte gehen Sie zur nächsten Systemeinstellungsseite, suchen Sie \"Installierte Dienste\" und schalten Sie den Dienst \"Breitenstein IT Input\" ein."),
        ...
        ("Language", "Sprache"),
        ("Keep Breitenstein IT background service", "Breitenstein IT im Hintergrund ausführen"),
        ...
        ("Show Breitenstein IT", "Breitenstein IT anzeigen"),
        ("This PC", "Dieser PC"),
        ("or", "oder"),
        ...
        ("config_input", "Um den entfernten Desktop mit der Tastatur steuern zu können, müssen Sie Breitenstein IT die Berechtigung \"Eingabeüberwachung\" erteilen."),
        ("config_microphone", "Um aus der Ferne sprechen zu können, müssen Sie Breitenstein IT die Berechtigung \"Audio aufzeichnen\" erteilen."),
        ...
        ("still_click_uac_tip", "Der entfernte Benutzer muss immer noch im UAC-Fenster von Breitenstein IT auf \"Ja\" klicken."),
        ...
        ("verify_rustdesk_password_tip", "Breitenstein IT-Passwort bestätigen"),
        ...
        ("scam_text1", "Wenn Sie mit jemandem telefonieren, den Sie NICHT KENNEN, dem Sie NICHT VERTRAUEN und der Sie gebeten hat, Breitenstein IT zu benutzen und den Dienst zu starten, fahren Sie nicht fort und legen Sie sofort auf."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Bitte aktualisieren Sie Breitenstein IT Server Pro auf die Version {} oder neuer!"),
        ...
        ("selinux_tip", "SELinux ist auf Ihrem Gerät aktiviert, was dazu führen kann, dass Breitenstein IT als kontrollierte Seite nicht richtig läuft."),
        ...
        ("powered_by_me", "Unterstützt von Breitenstein IT"),
        ("outgoing_only_desk_tip", "Dies ist eine benutzerdefinierte Ausgabe von Breitenstein IT.\nSie können eine Verbindung zu anderen Geräten herstellen, aber andere Geräte können keine Verbindung zu Ihrem Gerät herstellen."),
        ("preset_password_warning", "Dies ist eine benutzerdefinierte Ausgabe von Breitenstein IT mit einem voreingestellten Passwort. Jeder, der dieses Passwort kennt, kann die volle Kontrolle über Ihr Gerät erlangen. Wenn Sie dies nicht beabsichtigen, deinstallieren Sie diese Software bitte umgehend."),
