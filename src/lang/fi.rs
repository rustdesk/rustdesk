...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Width", "Leveys"),
        ("Height", "Korkeus"),
        ("Swap width and height", "Vaihda leveys ja korkeus"),
        ("Current resolution", "Nykyinen resoluutio"),
        ("Reset changes", "Palauta muutokset"),
        ("Select a resolution supported by the display", "Valitse näytön tukema resoluutio"),
        ("Display settings changed. Reopen the resolution menu and try again.", "Näyttöasetukset ovat muuttuneet. Avaa resoluutiovalikko uudelleen ja yritä uudelleen."),
        ("Closest supported resolution", "Lähin tuettu resoluutio"),
        ("Adjusted to display limits", "Sovitettu näytön rajoihin"),
        ("Local resolution is unavailable or unsupported", "Paikallinen resoluutio ei ole saatavilla tai sitä ei tueta"),
        ("Looks like", "Näyttää tältä"),
        ("Rendering quality", "Piirron laatu"),
        ("Standard", "Tavallinen"),
        ("Enter dimensions within the range", "Anna mitat sallitulta väliltä"),
        ("Aspect ratio", "Kuvasuhde"),
        ("Available resolutions", "Saatavilla olevat resoluutiot"),
        ("System scaling", "Järjestelmän skaalaus"),
        ("Recommended", "Suositeltu"),
        ("System scaling is unavailable for this display or desktop environment.", "Järjestelmän skaalaus ei ole saatavilla tälle näytölle tai työpöytäympäristölle."),
        ("The system did not apply the requested scale. Refresh and try again.", "Järjestelmä ei ottanut pyydettyä skaalausta käyttöön. Päivitä ja yritä uudelleen."),
        ("Select a scaling level supported by the display.", "Valitse näytön tukema skaalaustaso."),
        ("No permission to change display settings.", "Ei oikeutta muuttaa näyttöasetuksia."),
        ("Invalid display scaling request.", "Virheellinen näytön skaalauspyyntö."),
        ("Display settings are busy. Try again.", "Näyttöasetuksia käsitellään. Yritä uudelleen."),
        ("Display settings timed out. Refresh and try again.", "Näyttöasetusten aikakatkaisu. Päivitä ja yritä uudelleen."),
        ("Use nearest supported scale", "Käytä lähintä tuettua skaalausta"),
        ("Scaling was applied, but the resolution request failed.", "Skaalaus otettiin käyttöön, mutta resoluutiopyyntö epäonnistui."),
        ("Failed to change display settings", "Näyttöasetusten muuttaminen epäonnistui"),
        ("Remote connection has closed", "Etäyhteys on suljettu"),
        ("Failed to resize macOS virtual display", "macOS-virtuaalinäytön koon muuttaminen epäonnistui"),
        ("Failed to toggle macOS virtual display", "macOS-virtuaalinäytön käyttöönotto tai käytöstä poistaminen epäonnistui"),
        ("Failed to start macOS virtual display worker", "macOS-virtuaalinäyttöjen työprosessin käynnistäminen epäonnistui"),
        ("Virtual display dimensions must be between 320 and 4096", "Virtuaalinäytön mittojen on oltava välillä 320–4096"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "Virtuaalinäytön skaalauskertoimen on oltava 1 tai 2 ja jaettava molemmat pikselimitat tasan"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "Virtuaalinäytön mittojen on oltava välillä 1–4096 loogista pikseliä"),
        ("Display configuration response is too large.", "Näyttömäärityksen vastaus on liian suuri."),
        ("Invalid display scaling response", "Virheellinen näytön skaalausvastaus"),
        ("Invalid display scaling levels", "Virheelliset näytön skaalaustasot"),
