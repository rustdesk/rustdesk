...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Yhdistetään TeamDesk verkkoon..."),
        ...
        ("install_tip", "Joissain tapauksissa TeamDesk ei toimi oikein etäpuolella UAC:n vuoksi. Välttääksesi tämän, napsauta alla olevaa painiketta asentaaksesi TeamDeskin järjestelmään."),
        ("Click to upgrade", "Päivitä napsauttamalla"),
        ("Configure", "Määritä"),
        ("config_acc", "Etätyöpöydän hallintaa varten sinun on annettava TeamDeskille ”Esteettömyys”-oikeudet."),
        ("config_screen", "Etätyöpöydän käyttöä varten sinun on annettava TeamDeskille ”Näytön tallennus” oikeudet."),
        ...
        ("Discovered", "Löydetty"),
        ("install_daemon_tip", "Palvelun automaattista käynnistystä varten TeamDesk daemon on asennettava järjestelmään."),
        ("Remote ID", "Etätunnus"),
        ("Paste", "Liitä"),
        ...
        ("android_input_permission_tip1", "Siirry Androidin asetuksiin ja ota TeamDeskille käyttöön 'Syötteen ohjaus' oikeus."),
        ("android_input_permission_tip2", "Jos et löydä asetusta, etsi 'Esteettömyys' ja salli TeamDesk ohjelman käyttö."),
        ("android_new_connection_tip", "Uusi yhteyspyyntö vastaanotettu."),
        ("android_service_will_start_tip", "TeamDesk palvelu käynnistyy taustalla."),
        ("android_stop_service_tip", "Pysäytä taustapalvelu tarvittaessa TeamDeskin asetuksista."),
        ("android_version_audio_tip", "Äänensiirto vaatii Android 10:n tai uudemman."),
        ("android_start_service_tip", "TeamDesk palvelu käynnistetään..."),
        ...
        ("Language", "Kieli"),
        ("Keep TeamDesk background service", "Pidä TeamDeskin taustapalvelu käynnissä"),
        ("Ignore Battery Optimizations", "Ohita akun optimoinnit"),
        ("android_open_battery_optimizations_tip", "Poista TeamDeskin akkuoptimointi, jotta yhteys pysyy vakaana taustalla."),
        ...
        ("verify_teamdesk_password_tip", "Vahvista TeamDesk salasanasi kirjautumista varten"),
        ...
        ("scam_text2", "TeamDesk ei koskaan pyydä maksua tai etäkäyttöä ilman lupaasi."),
        ...
        ("upgrade_teamdesk_server_pro_to_{}_tip", "Päivitä TeamDesk Server Pro versioon {} jatkaaksesi."),
        ...
        ("About TeamDesk", "Tietoa TeamDeskistä"),
        ...
        ("upgrade_remote_teamdesk_client_to_{}_tip", "Päivitä etä-TeamDesk-asiakasversioon {} yhteensopivuuden takaamiseksi"),
        ...
        ("allow-insecure-tls-fallback-tip", "Oletuksena TeamDesk vahvistaa palvelimen varmenteen TLS:ää käyttävissä protokollissa.\nKun tämä asetus on käytössä, TeamDesk ohittaa vahvistusvaiheen ja jatkaa toimintaa, jos vahvistus epäonnistuu."),
        ("Disable UDP", "Poista UDP käytöstä"),
        ("disable-udp-tip", "Määrittää, käytetäänkö vain TCP:tä.\nKun tämä asetus on käytössä, TeamDesk ei enää käytä UDP-porttia 21116, vaan sen sijaan käytetään TCP-porttia 21116."),
        ("server-oss-not-support-tip", "HUOMAUTUS: TeamDesk-palvelimen OSS ei sisällä tätä ominaisuutta."),
        ...
        ("TeamDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that TeamDesk can use it", "TeamDesk ei tavoita etälaitteen työpöytäistuntoa, tarkista että istunto on käynnissä ja että TeamDesk voi käyttää sitä"),
        ...
        ("TeamDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "TeamDesk ei saanut XDG Desktop Portalilta käyttökelpoista näyttöä, PipeWire-kirjasto voi olla liian vanha"),
        ("TeamDesk could not load a GStreamer component needed for screen capture ({})", "TeamDesk ei voinut ladata näytön kaappaukseen tarvittavaa GStreamer-osaa ({})"),
    ].iter().cloned().collect();
}
