...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Service is running", "service loopt"),
        ("Service is not running", "service loopt niet"),
        ...
        ("screenshot-action-tip", "Kies wat u met de gemaakte schermopname wilt doen."),
        ("Save as", "Opslaan als"),
        ("Export", "Exporteren"),
        ...
        ("download-new-version-failed-tip", "Fout bij het downloaden. U kunt het opnieuw proberen of op de knop Downloaden klikken om de applicatie van de officiële website te downloaden en handmatig bij te werken."),
        ...
        ("elevation_username_tip", "Voer uw gebruikersnaam of domeinnaam in"),
        ...
        ("terminal-clipboard-write-tip", "Een app in de terminal wil tekst kopiëren naar het klembord van dit apparaat. Als deze toestemming wordt verleend, dan geldt dit voor terminalapps in alle verbindingen totdat u dit uitzet in de instellingen. Handmatig kopiëren en plakken wordt niet beïnvloed."),
        ("Allow terminal apps to copy to clipboard", "Terminal-apps toestaan om naar het klembord te kopiëren"),
        ("Enable", "Inschakelen"),
        ...
        ("To start a voice call, enable \"Audio capture\" on the \"Screen share\" page.", "Schakel op de pagina "Scherm delen" de optie "Audio-opname" in om een spraakoproep te starten.")
    ].iter().cloned().collect();
}
