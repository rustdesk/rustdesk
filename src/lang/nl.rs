...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("web_id_input_tip", "Het is mogelijk om een ID in te voeren in de server zelf, in de webclient wordt directe IP-toegang niet ondersteund.\nAls je toegang wilt krijgen tot een apparaat op een andere server, voeg dan bijvoorbeeld het serveradres toe (<id>@<server_adres>?key=<key_value>),\n9123456234@192.168.16.1:21117?key=5Qbwsde3unUcJBtrx9ZkvUmwFNoExHzpryHuPUdqlWM=.\nAls je toegang wilt krijgen tot een apparaat op een publieke server, voer dan \"<id>@public\" in, de sleutel is niet nodig voor de publieke server."),
    ].iter().cloned().collect();
}
