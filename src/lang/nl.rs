...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Width", "Breedte"),
        ("Height", "Hoogte"),
        ("Swap width and height", "Breedte en hoogte omwisselen"),
        ("Current resolution", "Huidige resolutie"),
        ("Reset changes", "Wijzigingen terugzetten"),
        ("Select a resolution supported by the display", "Selecteer een resolutie die het beeldscherm ondersteunt"),
        ("Display settings changed. Reopen the resolution menu and try again.", "De beeldscherminstellingen zijn gewijzigd. Open het resolutiemenu opnieuw en probeer het nogmaals."),
        ("Closest supported resolution", "Dichtstbijzijnde ondersteunde resolutie"),
        ("Adjusted to display limits", "Aangepast aan de beeldschermlimieten"),
        ("Local resolution is unavailable or unsupported", "De lokale resolutie is niet beschikbaar of wordt niet ondersteund"),
        ("Looks like", "Ziet eruit als"),
        ("Rendering quality", "Renderkwaliteit"),
        ("Standard", "Standaard"),
        ("Enter dimensions within the range", "Voer afmetingen binnen het bereik in"),
        ("Aspect ratio", "Beeldverhouding"),
        ("Available resolutions", "Beschikbare resoluties"),
        ("System scaling", "Systeemschaal"),
        ("Recommended", "Aanbevolen"),
        ("System scaling is unavailable for this display or desktop environment.", "Systeemschaal is niet beschikbaar voor dit beeldscherm of deze bureaubladomgeving."),
        ("The system did not apply the requested scale. Refresh and try again.", "Het systeem heeft de gevraagde schaal niet toegepast. Vernieuw en probeer het opnieuw."),
        ("Select a scaling level supported by the display.", "Selecteer een schaalniveau dat het beeldscherm ondersteunt."),
        ("No permission to change display settings.", "Geen toestemming om de beeldscherminstellingen te wijzigen."),
        ("Invalid display scaling request.", "Ongeldig verzoek voor beeldschermschaal."),
        ("Display settings are busy. Try again.", "De beeldscherminstellingen zijn bezig. Probeer het opnieuw."),
        ("Display settings timed out. Refresh and try again.", "Time-out bij de beeldscherminstellingen. Vernieuw en probeer het opnieuw."),
        ("Use nearest supported scale", "Dichtstbijzijnde ondersteunde schaal gebruiken"),
        ("Scaling was applied, but the resolution request failed.", "De schaal is toegepast, maar het resolutieverzoek is mislukt."),
        ("Failed to change display settings", "Wijzigen van beeldscherminstellingen mislukt"),
        ("Remote connection has closed", "De externe verbinding is gesloten"),
        ("Failed to resize macOS virtual display", "Grootte van virtueel macOS-beeldscherm wijzigen mislukt"),
        ("Failed to toggle macOS virtual display", "Virtueel macOS-beeldscherm in- of uitschakelen mislukt"),
        ("Failed to start macOS virtual display worker", "Starten van werkproces voor virtuele macOS-beeldschermen mislukt"),
        ("Virtual display dimensions must be between 320 and 4096", "De afmetingen van het virtuele beeldscherm moeten tussen 320 en 4096 liggen"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "De schaal van het virtuele beeldscherm moet 1 of 2 zijn en beide pixelafmetingen exact delen"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "De afmetingen van het virtuele beeldscherm moeten tussen 1 en 4096 logische pixels liggen"),
        ("Display configuration response is too large.", "Het antwoord met de beeldschermconfiguratie is te groot."),
        ("Invalid display scaling response", "Ongeldig antwoord over beeldschermschaal"),
        ("Invalid display scaling levels", "Ongeldige schaalniveaus voor het beeldscherm"),
