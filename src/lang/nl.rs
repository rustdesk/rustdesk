...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("ubuntu-21-04-required", "Ubuntu 21-04 vereist"),
        ("wayland-requires-higher-linux-version", "Wayland vereist een nieuwere Linux-versie"),
        ("xdp-portal-unavailable", "XDP Portal niet beschikbaar"),
        ("JumpLink", "JumpLink"),
        ...
        ("Show on the minimized toolbar", "Op de geminimaliseerde wekbalk weergeven"),
        ...
        ("Your ip is blocked by the peer", "Uw IP wordt door de ander geblokkerd"),
