...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Import server configuration successfully", "Importeren serverconfiguratie geslaagd"),
        ("Export server configuration successfully", "Exporteren serverconfiguratie geslaagd"),
