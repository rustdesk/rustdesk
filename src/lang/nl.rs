...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("drm_capture_tip", "DRM/KMS directe opname is beschikbaar — geen portaltoestemming vereist. Ondersteunt onbeheerde toegang en opname van het aanmeldingsscherm."),
