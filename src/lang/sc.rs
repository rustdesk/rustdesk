...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("To start a voice call, enable \"Audio capture\" on the \"Screen share\" page.", "Pro aviare una mutida de boghe, ativa in sa pàgina 'Cumpartzidura de ischermu' s’elementu 'Catura s’àudio'")
    ].iter().cloned().collect();
}
