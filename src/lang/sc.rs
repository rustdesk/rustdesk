...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Output resolution", "Risolutzione de essida"),
        ("Width", "Largària"),
        ("Height", "Artària"),
        ("Swap width and height", "Iscàmbia largària e artària"),
        ("Current resolution", "Risolutzione atuale"),
        ("Reset changes", "Ripristina is càmbios"),
        ("Select a resolution supported by the display", "Seletziona una risolutzione suportada dae s’ischermu"),
        ("Display settings changed. Reopen the resolution menu and try again.", "Is impostatziones de visualizatzione sunt cambiadas. Torra a abèrrere su menù de risolutzione e proa torra."),
        ("Closest supported resolution", "Risolutzione suportada prus acanta"),
        ("Adjusted to display limits", "Adatadu a is lìmites de s’ischermu"),
        ("Local resolution is unavailable or unsupported", "Sa risolutzione locale no est a disponimentu o no est suportada"),
        ("Looks like", "Paret comente"),
        ("Rendering quality", "Calidade de rapresentatzione"),
        ("Standard", "Istandard"),
        ("Enter dimensions within the range", "Inserta dimensiones in s’intervallu"),
        ("Aspect ratio", "Proportzione de is lados"),
        ("Available resolutions", "Risolutziones a disponimentu"),
        ("System scaling", "Iscala de sistema"),
        ("Recommended", "Cussigiadu"),
        ("System scaling is unavailable for this display or desktop environment.", "S’iscala de sistema no est a disponimentu pro custu ischermu o ambiente de iscrivania."),
        ("The system did not apply the requested scale. Refresh and try again.", "Su sistema no at aplicadu s’iscala pedida. Agiorna e proa torra."),
        ("Select a scaling level supported by the display.", "Seletziona unu livellu de iscala suportadu dae s’ischermu."),
        ("No permission to change display settings.", "Non tenes permissu de cambiare is impostatziones de visualizatzione."),
        ("Invalid display scaling request.", "Pedida de iscala de s’ischermu non vàlida."),
        ("Display settings are busy. Try again.", "Is impostatziones de visualizatzione sunt ocupadas. Proa torra."),
        ("Display settings timed out. Refresh and try again.", "Su tempus de isetu pro is impostatziones de visualizatzione est agabbadu. Agiorna e proa torra."),
        ("Use nearest supported scale", "Imprea s’iscala suportada prus acanta"),
        ("Scaling was applied, but the resolution request failed.", "S’iscala est istada aplicada, ma sa pedida de risolutzione est faddida."),
        ("Failed to change display settings", "No at fatu a cambiare is impostatziones de visualizatzione"),
        ("Remote connection has closed", "Sa connessione remota est serrada"),
        ("Failed to resize macOS virtual display", "No at fatu a cambiare sa mannària de s’ischermu virtuale macOS"),
        ("Failed to toggle macOS virtual display", "No at fatu a ativare o disativare s’ischermu virtuale macOS"),
        ("Failed to start macOS virtual display worker", "No at fatu a aviare su protzessu de traballu de is ischermos virtuales macOS"),
        ("Virtual display dimensions must be between 320 and 4096", "Is dimensiones de s’ischermu virtuale depent èssere intre 320 e 4096"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "S’iscala de s’ischermu virtuale depet èssere 1 o 2 e dividere chena restu ambas is dimensiones in pìxel"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "Is dimensiones de s’ischermu virtuale depent èssere intre 1 e 4096 pìxel lògicos"),
        ("Display configuration response is too large.", "Sa risposta de cunfiguratzione de s’ischermu est tropu manna."),
