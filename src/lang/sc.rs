...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("drm_capture_tip", "Sa captura diretta DRM/KMS est a disponimentu — non serbit su consensu de su portal. Suportat s'atzessu sena assistèntzia e sa captura de sa schermada de intrada."),
