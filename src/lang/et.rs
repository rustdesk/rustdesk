...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "TechDeski võrguga ühendumine..."),
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa TechDesk mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et TechDesk oma süsteemi paigaldada."),
        ("Click to upgrade", "Vajuta täiendamiseks"),
        ("Click to download", "Vajuta allalaadimiseks"),
        ("Click to update", "Vajuta uuendamiseks"),
        ("Configure", "Seadista"),
        ("config_acc", "Töölaua kaugjuhtimiseks tuleb TechDeskile anda \"juurdepääsetavuse\" õigused."),
        ("config_screen", "Töölaua kaugjuhtimiseks tuleb TechDeskile anda \"ekraanisalvestuse\" õigused."),
        ...
        ("android_input_permission_tip1", "Selleks, et kaugseade saaks sinu Androidi seadet juhtida hiire või puute abil, pead andma TechDeskile \"juurdepääsetavuse\" loa."),
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [TechDesk Input] sisse."),
        ...
        ("Language", "Keel"),
        ("Keep TechDesk background service", "Säilita TechDeski taustateenus"),
        ("Ignore Battery Optimizations", "Ignoreeri akuoptimeerimisi"),
        ("android_open_battery_optimizations_tip", "Kui soovid selle funktsiooni keelata, palun mine järgmisele TechDeski rakenduse seadete lehele, leia ja sisesta [Aku], eemalda linnuke valikult [Piiramata]"),
        ...
        ("config_input", "Kaugtöölaua klaviatuuriga juhtimiseks pead andma TechDeskile \"sisendi jälgimise\" õigused."),
        ("config_microphone", "Kaugelt rääkimiseks pead andma TechDeskile \"heli salvestamise\" õigused."),
        ...
        ("still_click_uac_tip", "Kaugkasutaja peab siiski ise vajutama käitatud TechDeski kasutajakonto kontrollis (UAC) OK-nuppu."),
        ...
        ("verify_techdesk_password_tip", "Kinnita TechDeski parool"),
        ...
        ("scam_text1", "Kui räägid telefoniga kellegagi, keda EI TUNNE ja EI USALDA, kes on palunud sul TechDeski kasutada ja teenus käivitada, ära jätka ning lõpeta kõne koheselt."),
        ...
        ("upgrade_techdesk_server_pro_to_{}_tip", "Palun täienda TechDesk Server Pro versioonile {} või uuem!"),
        ...
        ("selinux_tip", "SELinux on su seadmes lubatud, mis võib TechDeskil takistada juhitud poolel toimimist."),
        ...
        ("powered_by_me", "Põhineb TechDeskil"),
        ...
        ("allow-only-conn-window-open-tip", "Luba ühendus ainult siis, kui TechDeski aken on avatud."),
        ...
        ("floating_window_tip", "See aitab säilitada TechDeski taustateenust."),
        ...
        ("About TechDesk", "TechDeski teave"),
        ...
        ("upgrade_remote_techdesk_client_to_{}_tip", "Täiendage TechDeski klient kaugküljel versioonile {} või uuemale!"),
