...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("No cameras", "Kamerad ei leitud"),
        ("d3d_render_tip", "Luba see valik, et parandada renderdamist."),
        ("Use D3D rendering", "Kasutada D3D renderdamist"),
        ("Printer", "Printer"),
        ("printer-os-requirement-tip", "Printeri kasutamiseks on vajalik sobiv operatsioonisüsteemi versioon."),
        ("printer-requires-installed-{}-client-tip", "Printeri kasutamiseks tuleb installida {} klient."),
        ("printer-{}-not-installed-tip", "Printerit {} ei ole installitud."),
        ("printer-{}-ready-tip", "Printer {} on valmis."),
        ("Install {} Printer", "Installi {} printer"),
        ("Outgoing Print Jobs", "Väljaminevad printimisülesanded"),
        ("Incomming Print Jobs", "Sissetulevad printimisülesanded"),
        ("Incoming Print Job", "Sissetulev printimisülesanne"),
        ("use-the-default-printer-tip", "Kasutada vaikimisi printerit."),
        ("use-the-selected-printer-tip", "Kasutada valitud printerit."),
        ("auto-print-tip", "Automaatne printimine sissetulevatest ülesannetest."),
        ("print-incoming-job-confirm-tip", "Kinnita sissetuleva ülesande printimine."),
        ("remote-printing-disallowed-tile-tip", "Kaugprintimine on keelatud."),
        ("remote-printing-disallowed-text-tip", "Administraator on keelanud kaugprintimise kasutamise."),
        ("save-settings-tip", "Salvesta seaded."),
        ("dont-show-again-tip", "Ära näita enam."),
    ].iter().cloned().collect();
}
