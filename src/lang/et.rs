...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa StarDesk mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et StarDesk oma süsteemi paigaldada."),
        ...
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [StarDesk Input] sisse."),
        ...
        ("install_cert_tip", "Paigalda StarDesk sertifikaat"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Palun täienda StarDesk Server Pro versioonile {} või uuem!"),
