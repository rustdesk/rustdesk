...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Output resolution", "Väljundresolutsioon"),
        ("Width", "Laius"),
        ("Height", "Kõrgus"),
        ("Swap width and height", "Vaheta laius ja kõrgus"),
        ("Current resolution", "Praegune resolutsioon"),
        ("Reset changes", "Lähtesta muudatused"),
        ("Select a resolution supported by the display", "Vali kuvari toetatud resolutsioon"),
        ("Display settings changed. Reopen the resolution menu and try again.", "Kuvasätted on muutunud. Ava resolutsioonimenüü uuesti ja proovi veel kord."),
        ("Closest supported resolution", "Lähim toetatud resolutsioon"),
        ("Adjusted to display limits", "Kohandatud kuvari piirangutega"),
        ("Local resolution is unavailable or unsupported", "Kohalik resolutsioon pole saadaval või pole toetatud"),
        ("Looks like", "Näeb välja nagu"),
        ("Rendering quality", "Renderduskvaliteet"),
        ("Standard", "Tavaline"),
        ("Enter dimensions within the range", "Sisesta mõõtmed lubatud vahemikus"),
        ("Aspect ratio", "Kuvasuhe"),
        ("Available resolutions", "Saadaolevad resolutsioonid"),
        ("System scaling", "Süsteemi mastaap"),
        ("Recommended", "Soovitatav"),
        ("System scaling is unavailable for this display or desktop environment.", "Süsteemi mastaap pole selle kuvari või töölauakeskkonna jaoks saadaval."),
        ("The system did not apply the requested scale. Refresh and try again.", "Süsteem ei rakendanud soovitud mastaapi. Värskenda ja proovi uuesti."),
        ("Select a scaling level supported by the display.", "Vali kuvari toetatud mastaabitase."),
        ("No permission to change display settings.", "Puudub luba kuvasätete muutmiseks."),
        ("Invalid display scaling request.", "Vigane kuvamastaabi taotlus."),
        ("Display settings are busy. Try again.", "Kuvasätetega tegeletakse. Proovi uuesti."),
        ("Display settings timed out. Refresh and try again.", "Kuvasätete päring aegus. Värskenda ja proovi uuesti."),
        ("Use nearest supported scale", "Kasuta lähimat toetatud mastaapi"),
        ("Scaling was applied, but the resolution request failed.", "Mastaap rakendati, kuid resolutsioonitaotlus nurjus."),
        ("Failed to change display settings", "Kuvasätete muutmine nurjus"),
        ("Remote connection has closed", "Kaugühendus on suletud"),
        ("Failed to resize macOS virtual display", "macOS-i virtuaalkuvari suuruse muutmine nurjus"),
        ("Failed to toggle macOS virtual display", "macOS-i virtuaalkuvari sisse- või väljalülitamine nurjus"),
        ("Failed to start macOS virtual display worker", "macOS-i virtuaalkuvarite tööprotsessi käivitamine nurjus"),
        ("Virtual display dimensions must be between 320 and 4096", "Virtuaalkuvari mõõtmed peavad jääma vahemikku 320–4096"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "Virtuaalkuvari mastaap peab olema 1 või 2 ning mõlemad pikslimõõtmed peavad sellega jäägita jaguma"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "Virtuaalkuvari mõõtmed peavad jääma vahemikku 1–4096 loogilist pikslit"),
        ("Display configuration response is too large.", "Kuvakonfiguratsiooni vastus on liiga suur."),
        ("Invalid display scaling response", "Vigane kuvamastaabi vastus"),
        ("Invalid display scaling levels", "Vigased kuvamastaabi tasemed"),
        ("Invalid display scaling range", "Vigane kuvamastaabi vahemik"),
        ("Interface size", "Liidese suurus"),
        ("Current interface size", "Praegune liidese suurus"),
    ].iter().cloned().collect();
}
