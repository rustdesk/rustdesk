...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Output resolution", "Utdataoppløsning"),
        ("Width", "Bredde"),
        ("Height", "Høyde"),
        ("Swap width and height", "Bytt bredde og høyde"),
        ("Current resolution", "Gjeldende oppløsning"),
        ("Reset changes", "Tilbakestill endringer"),
        ("Select a resolution supported by the display", "Velg en oppløsning som skjermen støtter"),
        ("Display settings changed. Reopen the resolution menu and try again.", "Skjerminnstillingene er endret. Åpne oppløsningsmenyen på nytt og prøv igjen."),
        ("Closest supported resolution", "Nærmeste støttede oppløsning"),
        ("Adjusted to display limits", "Tilpasset skjermens grenser"),
        ("Local resolution is unavailable or unsupported", "Lokal oppløsning er utilgjengelig eller støttes ikke"),
        ("Looks like", "Ser ut som"),
        ("Rendering quality", "Gjengivelseskvalitet"),
        ("Standard", "Standard"),
        ("Enter dimensions within the range", "Angi dimensjoner innenfor området"),
        ("Aspect ratio", "Sideforhold"),
        ("Available resolutions", "Tilgjengelige oppløsninger"),
        ("System scaling", "Systemskalering"),
        ("Recommended", "Anbefalt"),
        ("System scaling is unavailable for this display or desktop environment.", "Systemskalering er ikke tilgjengelig for denne skjermen eller dette skrivebordsmiljøet."),
        ("The system did not apply the requested scale. Refresh and try again.", "Systemet tok ikke i bruk ønsket skalering. Oppdater og prøv igjen."),
        ("Select a scaling level supported by the display.", "Velg et skaleringsnivå som skjermen støtter."),
        ("No permission to change display settings.", "Ingen tillatelse til å endre skjerminnstillinger."),
        ("Invalid display scaling request.", "Ugyldig forespørsel om skjermskalering."),
        ("Display settings are busy. Try again.", "Skjerminnstillingene er opptatt. Prøv igjen."),
        ("Display settings timed out. Refresh and try again.", "Tidsavbrudd for skjerminnstillingene. Oppdater og prøv igjen."),
        ("Use nearest supported scale", "Bruk nærmeste støttede skalering"),
        ("Scaling was applied, but the resolution request failed.", "Skaleringen ble tatt i bruk, men forespørselen om oppløsning mislyktes."),
        ("Failed to change display settings", "Kunne ikke endre skjerminnstillingene"),
        ("Remote connection has closed", "Den eksterne tilkoblingen er lukket"),
        ("Failed to resize macOS virtual display", "Kunne ikke endre størrelsen på den virtuelle macOS-skjermen"),
        ("Failed to toggle macOS virtual display", "Kunne ikke slå den virtuelle macOS-skjermen av eller på"),
        ("Failed to start macOS virtual display worker", "Kunne ikke starte arbeidsprosessen for virtuelle macOS-skjermer"),
        ("Virtual display dimensions must be between 320 and 4096", "Dimensjonene til den virtuelle skjermen må være mellom 320 og 4096"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "Skaleringen til den virtuelle skjermen må være 1 eller 2 og dele begge pikseldimensjonene uten rest"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "Dimensjonene til den virtuelle skjermen må være mellom 1 og 4096 logiske piksler"),
        ("Display configuration response is too large.", "Svaret med skjermkonfigurasjonen er for stort."),
        ("Invalid display scaling response", "Ugyldig svar om skjermskalering"),
        ("Invalid display scaling levels", "Ugyldige nivåer for skjermskalering"),
        ("Invalid display scaling range", "Ugyldig område for skjermskalering"),
        ("Interface size", "Grensesnittstørrelse"),
        ("Current interface size", "Gjeldende grensesnittstørrelse"),
    ].iter().cloned().collect();
}
