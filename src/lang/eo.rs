...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Output resolution", "Eliga distingivo"),
        ("Width", "Larĝo"),
        ("Height", "Alto"),
        ("Swap width and height", "Interŝanĝi larĝon kaj alton"),
        ("Current resolution", "Nuna distingivo"),
        ("Reset changes", "Restarigi ŝanĝojn"),
        ("Select a resolution supported by the display", "Elektu distingivon subtenatan de la ekrano"),
        ("Display settings changed. Reopen the resolution menu and try again.", "La ekranaj agordoj ŝanĝiĝis. Remalfermu la distingivan menuon kaj reprovu."),
        ("Closest supported resolution", "Plej proksima subtenata distingivo"),
        ("Adjusted to display limits", "Adaptita al la ekranaj limoj"),
        ("Local resolution is unavailable or unsupported", "La loka distingivo ne disponeblas aŭ ne estas subtenata"),
        ("Looks like", "Aspektas kiel"),
        ("Rendering quality", "Bildiga kvalito"),
        ("Standard", "Normala"),
        ("Enter dimensions within the range", "Enigu dimensiojn ene de la intervalo"),
        ("Aspect ratio", "Bildformato"),
        ("Available resolutions", "Disponeblaj distingivoj"),
        ("System scaling", "Sistema skalado"),
        ("Recommended", "Rekomendata"),
        ("System scaling is unavailable for this display or desktop environment.", "Sistema skalado ne disponeblas por ĉi tiu ekrano aŭ labortabla medio."),
        ("The system did not apply the requested scale. Refresh and try again.", "La sistemo ne aplikis la petitan skalon. Aktualigu kaj reprovu."),
        ("Select a scaling level supported by the display.", "Elektu skalan nivelon subtenatan de la ekrano."),
        ("No permission to change display settings.", "Vi ne havas permeson ŝanĝi la ekranajn agordojn."),
        ("Invalid display scaling request.", "Nevalida peto pri ekrana skalado."),
        ("Display settings are busy. Try again.", "La ekranaj agordoj estas okupataj. Reprovu."),
        ("Display settings timed out. Refresh and try again.", "La atendotempo por la ekranaj agordoj finiĝis. Aktualigu kaj reprovu."),
        ("Use nearest supported scale", "Uzi la plej proksiman subtenatan skalon"),
        ("Scaling was applied, but the resolution request failed.", "La skalo estis aplikita, sed la distingiva peto malsukcesis."),
        ("Failed to change display settings", "Malsukcesis ŝanĝi la ekranajn agordojn"),
        ("Remote connection has closed", "La fora konekto fermiĝis"),
        ("Failed to resize macOS virtual display", "Malsukcesis ŝanĝi la grandecon de la virtuala macOS-ekrano"),
        ("Failed to toggle macOS virtual display", "Malsukcesis ŝalti aŭ malŝalti la virtualan macOS-ekranon"),
        ("Failed to start macOS virtual display worker", "Malsukcesis lanĉi la laborprocezon por virtualaj macOS-ekranoj"),
        ("Virtual display dimensions must be between 320 and 4096", "La dimensioj de la virtuala ekrano devas esti inter 320 kaj 4096"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "La skalo de la virtuala ekrano devas esti 1 aŭ 2 kaj dividi ambaŭ pikselajn dimensiojn sen resto"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "La dimensioj de la virtuala ekrano devas esti inter 1 kaj 4096 logikaj pikseloj"),
        ("Display configuration response is too large.", "La respondo pri la ekrana agordo estas tro granda."),
        ("Invalid display scaling response", "Nevalida respondo pri ekrana skalado"),
        ("Invalid display scaling levels", "Nevalidaj ekranaj skalniveloj"),
        ("Invalid display scaling range", "Nevalida ekrana skalintervalo"),
        ("Interface size", "Interfaca grandeco"),
        ("Current interface size", "Nuna interfaca grandeco"),
    ].iter().cloned().collect();
}
