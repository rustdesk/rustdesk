...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Output resolution", "ഔട്ട്പുട്ട് റെസല്യൂഷൻ"),
        ("Width", "വീതി"),
        ("Height", "ഉയരം"),
        ("Swap width and height", "വീതിയും ഉയരവും പരസ്പരം മാറ്റുക"),
        ("Current resolution", "നിലവിലെ റെസല്യൂഷൻ"),
        ("Reset changes", "മാറ്റങ്ങൾ പുനഃസജ്ജമാക്കുക"),
        ("Select a resolution supported by the display", "ഡിസ്‌പ്ലേ പിന്തുണയ്ക്കുന്ന റെസല്യൂഷൻ തിരഞ്ഞെടുക്കുക"),
        ("Display settings changed. Reopen the resolution menu and try again.", "ഡിസ്‌പ്ലേ ക്രമീകരണങ്ങൾ മാറിയിരിക്കുന്നു. റെസല്യൂഷൻ മെനു വീണ്ടും തുറന്ന് ശ്രമിക്കുക."),
        ("Closest supported resolution", "ഏറ്റവും അടുത്ത പിന്തുണയ്ക്കുന്ന റെസല്യൂഷൻ"),
        ("Adjusted to display limits", "ഡിസ്‌പ്ലേയുടെ പരിധികൾക്കനുസരിച്ച് ക്രമീകരിച്ചു"),
        ("Local resolution is unavailable or unsupported", "പ്രാദേശിക റെസല്യൂഷൻ ലഭ്യമല്ല അല്ലെങ്കിൽ പിന്തുണയ്ക്കുന്നില്ല"),
        ("Looks like", "ഇതുപോലെ കാണപ്പെടുന്നു"),
        ("Rendering quality", "റെൻഡറിംഗ് നിലവാരം"),
        ("Standard", "സാധാരണം"),
        ("Enter dimensions within the range", "അനുവദിച്ച പരിധിക്കുള്ളിലെ അളവുകൾ നൽകുക"),
        ("Aspect ratio", "വീതി-ഉയര അനുപാതം"),
        ("Available resolutions", "ലഭ്യമായ റെസല്യൂഷനുകൾ"),
        ("System scaling", "സിസ്റ്റം സ്കെയിലിംഗ്"),
        ("Recommended", "ശുപാർശ ചെയ്യുന്നത്"),
        ("System scaling is unavailable for this display or desktop environment.", "ഈ ഡിസ്‌പ്ലേയ്‌ക്കോ ഡെസ്ക്ടോപ്പ് പരിതസ്ഥിതിക്കോ സിസ്റ്റം സ്കെയിലിംഗ് ലഭ്യമല്ല."),
        ("The system did not apply the requested scale. Refresh and try again.", "ആവശ്യപ്പെട്ട സ്കെയിൽ സിസ്റ്റം പ്രയോഗിച്ചില്ല. പുതുക്കിയ ശേഷം വീണ്ടും ശ്രമിക്കുക."),
        ("Select a scaling level supported by the display.", "ഡിസ്‌പ്ലേ പിന്തുണയ്ക്കുന്ന സ്കെയിലിംഗ് നില തിരഞ്ഞെടുക്കുക."),
        ("No permission to change display settings.", "ഡിസ്‌പ്ലേ ക്രമീകരണങ്ങൾ മാറ്റാൻ അനുമതിയില്ല."),
        ("Invalid display scaling request.", "ഡിസ്‌പ്ലേ സ്കെയിലിംഗ് അഭ്യർത്ഥന അസാധുവാണ്."),
        ("Display settings are busy. Try again.", "ഡിസ്‌പ്ലേ ക്രമീകരണങ്ങൾ തിരക്കിലാണ്. വീണ്ടും ശ്രമിക്കുക."),
        ("Display settings timed out. Refresh and try again.", "ഡിസ്‌പ്ലേ ക്രമീകരണങ്ങളുടെ സമയപരിധി കഴിഞ്ഞു. പുതുക്കിയ ശേഷം വീണ്ടും ശ്രമിക്കുക."),
        ("Use nearest supported scale", "ഏറ്റവും അടുത്ത പിന്തുണയ്ക്കുന്ന സ്കെയിൽ ഉപയോഗിക്കുക"),
        ("Scaling was applied, but the resolution request failed.", "സ്കെയിൽ പ്രയോഗിച്ചു, പക്ഷേ റെസല്യൂഷൻ അഭ്യർത്ഥന പരാജയപ്പെട്ടു."),
        ("Failed to change display settings", "ഡിസ്‌പ്ലേ ക്രമീകരണങ്ങൾ മാറ്റാനായില്ല"),
        ("Remote connection has closed", "റിമോട്ട് കണക്ഷൻ അടച്ചു"),
        ("Failed to resize macOS virtual display", "macOS വെർച്വൽ ഡിസ്‌പ്ലേയുടെ വലുപ്പം മാറ്റാനായില്ല"),
        ("Failed to toggle macOS virtual display", "macOS വെർച്വൽ ഡിസ്‌പ്ലേ പ്രവർത്തനക്ഷമമാക്കാനോ പ്രവർത്തനരഹിതമാക്കാനോ കഴിഞ്ഞില്ല"),
        ("Failed to start macOS virtual display worker", "macOS വെർച്വൽ ഡിസ്‌പ്ലേയുടെ വർക്ക് ത്രെഡ് ആരംഭിക്കാനായില്ല"),
        ("Virtual display dimensions must be between 320 and 4096", "വെർച്വൽ ഡിസ്‌പ്ലേയുടെ അളവുകൾ 320-നും 4096-നും ഇടയിലായിരിക്കണം"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "വെർച്വൽ ഡിസ്‌പ്ലേയുടെ സ്കെയിൽ 1 അല്ലെങ്കിൽ 2 ആയിരിക്കണം; രണ്ട് പിക്സൽ അളവുകളും അതുകൊണ്ട് ശിഷ്ടമില്ലാതെ ഹരിക്കാവുന്നതായിരിക്കണം"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "വെർച്വൽ ഡിസ്‌പ്ലേയുടെ അളവുകൾ 1-നും 4096-നും ഇടയിലുള്ള ലോജിക്കൽ പിക്സലുകളായിരിക്കണം"),
        ("Display configuration response is too large.", "ഡിസ്‌പ്ലേ കോൺഫിഗറേഷൻ മറുപടി വളരെ വലുതാണ്."),
        ("Invalid display scaling response", "ഡിസ്‌പ്ലേ സ്കെയിലിംഗ് മറുപടി അസാധുവാണ്"),
        ("Invalid display scaling levels", "ഡിസ്‌പ്ലേ സ്കെയിലിംഗ് നിലകൾ അസാധുവാണ്"),
