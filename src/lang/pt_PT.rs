...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("drm_capture_tip", "A captura direta DRM/KMS está ativa — não é necessário consentimento do portal. Funciona de forma não assistida e no ecrã de início de sessão."),
