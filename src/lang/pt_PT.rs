...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Width", "Largura"),
        ("Height", "Altura"),
        ("Swap width and height", "Trocar largura e altura"),
        ("Current resolution", "Resolução atual"),
        ("Reset changes", "Repor alterações"),
        ("Select a resolution supported by the display", "Selecione uma resolução compatível com o ecrã"),
        ("Display settings changed. Reopen the resolution menu and try again.", "As configurações do visor foram alteradas. Volte a abrir o menu de resolução e tente novamente."),
        ("Closest supported resolution", "Resolução compatível mais próxima"),
        ("Adjusted to display limits", "Ajustado aos limites do ecrã"),
        ("Local resolution is unavailable or unsupported", "A resolução local está indisponível ou não é compatível"),
        ("Looks like", "Aspeto semelhante a"),
        ("Rendering quality", "Qualidade de renderização"),
        ("Standard", "Normal"),
        ("Enter dimensions within the range", "Introduza dimensões dentro do intervalo"),
        ("Aspect ratio", "Proporção do ecrã"),
        ("Available resolutions", "Resoluções disponíveis"),
        ("System scaling", "Escala do sistema"),
        ("Recommended", "Recomendado"),
        ("System scaling is unavailable for this display or desktop environment.", "A escala do sistema está indisponível para este ecrã ou ambiente de trabalho."),
        ("The system did not apply the requested scale. Refresh and try again.", "O sistema não aplicou a escala pedida. Atualize e tente novamente."),
        ("Select a scaling level supported by the display.", "Selecione um nível de escala compatível com o ecrã."),
        ("No permission to change display settings.", "Sem permissão para alterar as configurações do visor."),
        ("Invalid display scaling request.", "Pedido de escala do visor inválido."),
        ("Display settings are busy. Try again.", "As configurações do visor estão ocupadas. Tente novamente."),
        ("Display settings timed out. Refresh and try again.", "O tempo de espera das configurações do visor expirou. Atualize e tente novamente."),
        ("Use nearest supported scale", "Utilizar a escala compatível mais próxima"),
        ("Scaling was applied, but the resolution request failed.", "A escala foi aplicada, mas o pedido de resolução falhou."),
        ("Failed to change display settings", "Não foi possível alterar as configurações do visor"),
        ("Remote connection has closed", "A ligação remota foi encerrada"),
        ("Failed to resize macOS virtual display", "Não foi possível redimensionar o ecrã virtual do macOS"),
        ("Failed to toggle macOS virtual display", "Não foi possível ativar ou desativar o ecrã virtual do macOS"),
        ("Failed to start macOS virtual display worker", "Não foi possível iniciar o processo dos ecrãs virtuais do macOS"),
        ("Virtual display dimensions must be between 320 and 4096", "As dimensões do ecrã virtual devem estar entre 320 e 4096"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "A escala do ecrã virtual deve ser 1 ou 2 e dividir exatamente ambas as dimensões em píxeis"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "As dimensões do ecrã virtual devem estar entre 1 e 4096 píxeis lógicos"),
        ("Display configuration response is too large.", "A resposta de configuração do visor é demasiado grande."),
        ("Invalid display scaling response", "Resposta de escala do visor inválida"),
        ("Invalid display scaling levels", "Níveis de escala do visor inválidos"),
        ("Invalid display scaling range", "Intervalo de escala do visor inválido"),
    ].iter().cloned().collect();
}
