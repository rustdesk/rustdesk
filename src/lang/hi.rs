...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Output resolution", "आउटपुट रिज़ॉल्यूशन"),
        ("Width", "चौड़ाई"),
        ("Height", "ऊँचाई"),
        ("Swap width and height", "चौड़ाई और ऊँचाई बदलें"),
        ("Current resolution", "वर्तमान रिज़ॉल्यूशन"),
        ("Reset changes", "बदलाव रीसेट करें"),
        ("Select a resolution supported by the display", "डिस्प्ले द्वारा समर्थित रिज़ॉल्यूशन चुनें"),
        ("Display settings changed. Reopen the resolution menu and try again.", "डिस्प्ले सेटिंग्स बदल गई हैं। रिज़ॉल्यूशन मेनू फिर से खोलें और दोबारा कोशिश करें।"),
        ("Closest supported resolution", "निकटतम समर्थित रिज़ॉल्यूशन"),
        ("Adjusted to display limits", "डिस्प्ले की सीमाओं के अनुसार समायोजित"),
        ("Local resolution is unavailable or unsupported", "स्थानीय रिज़ॉल्यूशन उपलब्ध नहीं है या समर्थित नहीं है"),
        ("Looks like", "ऐसा दिखता है"),
        ("Rendering quality", "रेंडरिंग गुणवत्ता"),
        ("Standard", "मानक"),
        ("Enter dimensions within the range", "अनुमत सीमा के भीतर आयाम दर्ज करें"),
        ("Aspect ratio", "पहलू अनुपात"),
        ("Available resolutions", "उपलब्ध रिज़ॉल्यूशन"),
        ("System scaling", "सिस्टम स्केलिंग"),
        ("Recommended", "अनुशंसित"),
        ("System scaling is unavailable for this display or desktop environment.", "इस डिस्प्ले या डेस्कटॉप परिवेश के लिए सिस्टम स्केलिंग उपलब्ध नहीं है।"),
        ("The system did not apply the requested scale. Refresh and try again.", "सिस्टम ने अनुरोधित स्केल लागू नहीं किया। रीफ़्रेश करें और दोबारा कोशिश करें।"),
        ("Select a scaling level supported by the display.", "डिस्प्ले द्वारा समर्थित स्केलिंग स्तर चुनें।"),
        ("No permission to change display settings.", "डिस्प्ले सेटिंग्स बदलने की अनुमति नहीं है।"),
        ("Invalid display scaling request.", "डिस्प्ले स्केलिंग का अनुरोध अमान्य है।"),
        ("Display settings are busy. Try again.", "डिस्प्ले सेटिंग्स व्यस्त हैं। दोबारा कोशिश करें।"),
        ("Display settings timed out. Refresh and try again.", "डिस्प्ले सेटिंग्स का समय समाप्त हो गया। रीफ़्रेश करें और दोबारा कोशिश करें।"),
        ("Use nearest supported scale", "निकटतम समर्थित स्केल का उपयोग करें"),
        ("Scaling was applied, but the resolution request failed.", "स्केल लागू हो गया, लेकिन रिज़ॉल्यूशन अनुरोध विफल रहा।"),
        ("Failed to change display settings", "डिस्प्ले सेटिंग्स नहीं बदली जा सकीं"),
        ("Remote connection has closed", "दूरस्थ कनेक्शन बंद हो गया है"),
        ("Failed to resize macOS virtual display", "macOS के वर्चुअल डिस्प्ले का आकार नहीं बदला जा सका"),
        ("Failed to toggle macOS virtual display", "macOS का वर्चुअल डिस्प्ले चालू या बंद नहीं किया जा सका"),
        ("Failed to start macOS virtual display worker", "macOS के वर्चुअल डिस्प्ले का कार्य थ्रेड शुरू नहीं किया जा सका"),
        ("Virtual display dimensions must be between 320 and 4096", "वर्चुअल डिस्प्ले के आयाम 320 से 4096 के बीच होने चाहिए"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "वर्चुअल डिस्प्ले का स्केल 1 या 2 होना चाहिए और दोनों पिक्सेल आयाम इससे बिना शेष के विभाजित होने चाहिए"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "वर्चुअल डिस्प्ले के आयाम 1 से 4096 तार्किक पिक्सेल के बीच होने चाहिए"),
        ("Display configuration response is too large.", "डिस्प्ले कॉन्फ़िगरेशन का उत्तर बहुत बड़ा है।"),
        ("Invalid display scaling response", "डिस्प्ले स्केलिंग का उत्तर अमान्य है"),
        ("Invalid display scaling levels", "डिस्प्ले स्केलिंग के स्तर अमान्य हैं"),
        ("Invalid display scaling range", "डिस्प्ले स्केलिंग की सीमा अमान्य है"),
        ("Interface size", "इंटरफ़ेस का आकार"),
        ("Current interface size", "इंटरफ़ेस का वर्तमान आकार"),
    ].iter().cloned().collect();
}
