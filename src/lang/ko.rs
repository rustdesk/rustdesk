...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Unlock Security Settings", "보안 설정 해제"),
        ...
        ("Proxy", "프록시"),
        ("Apply", "적용"),
        ("Disconnect all devices?", "모든 기기의 연결을 해제할까요?"),
        ("Clear", ""),
        ("Audio Input Device", ""),
        ("Deny remote access", ""),
        ("Use IP Whitelisting", ""),
