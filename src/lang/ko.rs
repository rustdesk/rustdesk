...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Select a resolution supported by the display", "디스플레이에서 지원하는 해상도를 선택하세요"),
        ("Display settings changed. Reopen the resolution menu and try again.", "디스플레이 설정이 변경되었습니다. 해상도 메뉴를 다시 열고 시도하세요."),
        ("Closest supported resolution", "가장 가까운 지원 해상도"),
        ("Adjusted to display limits", "디스플레이 제한에 맞게 조정됨"),
        ("Local resolution is unavailable or unsupported", "로컬 해상도를 가져올 수 없거나 지원하지 않습니다"),
        ("Looks like", "보이는 해상도"),
        ("Rendering quality", "렌더링 품질"),
        ("Standard", "표준"),
        ("Enter dimensions within the range", "허용 범위 내의 크기를 입력하세요"),
        ("Aspect ratio", "가로세로 비율"),
        ("Available resolutions", "사용 가능한 해상도"),
        ("System scaling", "시스템 배율"),
        ("Recommended", "권장"),
        ("System scaling is unavailable for this display or desktop environment.", "이 디스플레이 또는 데스크톱 환경에서는 시스템 배율을 사용할 수 없습니다."),
        ("The system did not apply the requested scale. Refresh and try again.", "시스템이 요청한 배율을 적용하지 않았습니다. 새로 고친 후 다시 시도하세요."),
        ("Select a scaling level supported by the display.", "디스플레이에서 지원하는 배율을 선택하세요."),
        ("No permission to change display settings.", "디스플레이 설정을 변경할 권한이 없습니다."),
        ("Invalid display scaling request.", "디스플레이 배율 요청이 유효하지 않습니다."),
        ("Display settings are busy. Try again.", "디스플레이 설정을 처리 중입니다. 다시 시도하세요."),
        ("Display settings timed out. Refresh and try again.", "디스플레이 설정 요청 시간이 초과되었습니다. 새로 고친 후 다시 시도하세요."),
        ("Use nearest supported scale", "가장 가까운 지원 배율 사용"),
        ("Scaling was applied, but the resolution request failed.", "배율은 적용되었지만 해상도 요청에 실패했습니다."),
        ("Failed to change display settings", "디스플레이 설정을 변경하지 못했습니다"),
        ("Remote connection has closed", "원격 연결이 종료되었습니다"),
        ("Failed to resize macOS virtual display", "macOS 가상 디스플레이의 크기를 변경하지 못했습니다"),
        ("Failed to toggle macOS virtual display", "macOS 가상 디스플레이를 켜거나 끄지 못했습니다"),
        ("Failed to start macOS virtual display worker", "macOS 가상 디스플레이 작업 스레드를 시작하지 못했습니다"),
        ("Virtual display dimensions must be between 320 and 4096", "가상 디스플레이의 너비와 높이는 320에서 4096 사이여야 합니다"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "가상 디스플레이 배율은 1 또는 2여야 하며, 픽셀 단위 너비와 높이가 모두 이 배율로 나누어떨어져야 합니다"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "가상 디스플레이의 너비와 높이는 1에서 4096 논리 픽셀 사이여야 합니다"),
        ("Display configuration response is too large.", "디스플레이 구성 응답이 너무 큽니다."),
