...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Width", "幅"),
        ("Height", "高さ"),
        ("Swap width and height", "幅と高さを入れ替える"),
        ("Current resolution", "現在の解像度"),
        ("Reset changes", "変更をリセット"),
        ("Select a resolution supported by the display", "ディスプレイが対応している解像度を選択してください"),
        ("Display settings changed. Reopen the resolution menu and try again.", "ディスプレイの設定が変更されました。解像度メニューを開き直して、もう一度お試しください。"),
        ("Closest supported resolution", "最も近い対応解像度"),
        ("Adjusted to display limits", "ディスプレイの制限に合わせて調整済み"),
        ("Local resolution is unavailable or unsupported", "ローカル解像度を取得できないか、対応していません"),
        ("Looks like", "見た目の解像度"),
        ("Rendering quality", "描画品質"),
        ("Standard", "標準"),
        ("Enter dimensions within the range", "範囲内の寸法を入力してください"),
        ("Aspect ratio", "縦横比"),
        ("Available resolutions", "利用可能な解像度"),
        ("System scaling", "システムの拡大率"),
        ("Recommended", "推奨"),
        ("System scaling is unavailable for this display or desktop environment.", "このディスプレイまたはデスクトップ環境では、システムの拡大率を変更できません。"),
        ("The system did not apply the requested scale. Refresh and try again.", "指定した拡大率がシステムに適用されませんでした。更新して、もう一度お試しください。"),
        ("Select a scaling level supported by the display.", "ディスプレイが対応している拡大率を選択してください。"),
        ("No permission to change display settings.", "ディスプレイの設定を変更する権限がありません。"),
        ("Invalid display scaling request.", "ディスプレイの拡大率の要求が無効です。"),
        ("Display settings are busy. Try again.", "ディスプレイの設定を処理中です。もう一度お試しください。"),
        ("Display settings timed out. Refresh and try again.", "ディスプレイの設定がタイムアウトしました。更新して、もう一度お試しください。"),
        ("Use nearest supported scale", "最も近い対応拡大率を使用"),
        ("Scaling was applied, but the resolution request failed.", "拡大率は適用されましたが、解像度の要求に失敗しました。"),
        ("Failed to change display settings", "ディスプレイの設定を変更できませんでした"),
        ("Remote connection has closed", "リモート接続が閉じられました"),
        ("Failed to resize macOS virtual display", "macOS の仮想ディスプレイのサイズを変更できませんでした"),
        ("Failed to toggle macOS virtual display", "macOS の仮想ディスプレイを有効化または無効化できませんでした"),
        ("Failed to start macOS virtual display worker", "macOS の仮想ディスプレイのワーカースレッドを開始できませんでした"),
        ("Virtual display dimensions must be between 320 and 4096", "仮想ディスプレイの幅と高さは 320～4096 の範囲で指定してください"),
        ("Virtual display scale must be 1 or 2 and divide both pixel dimensions", "仮想ディスプレイの倍率は 1 または 2 とし、ピクセル単位の幅と高さがどちらもその倍率で割り切れる必要があります"),
        ("Virtual display dimensions must be between 1 and 4096 logical pixels", "仮想ディスプレイの幅と高さは 1～4096 論理ピクセルの範囲で指定してください"),
        ("Display configuration response is too large.", "ディスプレイ構成の応答が大きすぎます。"),
        ("Invalid display scaling response", "ディスプレイの拡大率の応答が無効です"),
        ("Invalid display scaling levels", "ディスプレイの拡大率の段階が無効です"),
        ("Invalid display scaling range", "ディスプレイの拡大率の範囲が無効です"),
        ("Interface size", "インターフェイスのサイズ"),
        ("Current interface size", "現在のインターフェイスのサイズ"),
    ].iter().cloned().collect();
}
