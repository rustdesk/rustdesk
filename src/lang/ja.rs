...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "StarDeskがUACの影響によりリモート側で正常に動作しない場合があります。UACを回避するには、下のボタンをクリックしてシステムにStarDeskをインストールしてください。"),
        ("Click to upgrade", "アップグレード"),
        ("Click to download", "ダウンロード"),
        ("Click to update", "アップデート"),
        ("Configure", "設定"),
        ("config_acc", "リモートからあなたのデスクトップを操作するには、StarDeskに「アクセシビリティ」権限を与える必要があります。"),
        ("config_screen", "リモートからあなたのデスクトップにアクセスするには、StarDeskに「画面収録」権限を与える必要があります。"),
        ("Installing ...", "インストール中..."),
        ("Install", "インストール"),
        ("Installation", "インストール"),
        ...
        ("android_input_permission_tip1", "このAndroid端末をリモートの端末からマウスやタッチで操作するには、StarDeskに「アクセシビリティ」サービスの使用を許可する必要があります。"),
        ...
        ("Turned off", "オフになりました"),
        ("Language", "言語"),
        ("Keep StarDesk background service", "StarDesk バックグラウンドサービスを維持"),
