...
let tags_arr: any[] = [];
let peers_arr: any[] = [];
let ab = { tags: tags_arr, peers: peers_arr };
let abLoading: boolean;
let abError: string;
let current_menu_peer_id = '';
let current_menu_tag = '';
...
class AddressBook extends React.Component
{
    ...
    async selectedTags() {
        ...
        const tags = await invoke<string>("get_local_option", {key: "selected-tags"});
    ...
    // getPeers() {
    //     let tags = [];
    //     for (let t in this.selectedTags()) {
    //         if (ab.tags.indexOf(t) >= 0) tags.push(t);
    //     }
    //     if (tags.length != this.selectedTags.length) {
    //         // this.selectedTags = tags;
    //         this.setState({selectedTags: tags});
    //         invoke("set_local_option", {key: "selected-tags", value: tags.join(",")});
    ...
    // render() {
    //     if (!await invoke("get_local_option", {key: "access_token"})) {
    //         // TODO:
