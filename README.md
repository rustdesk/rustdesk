<p align="center">
  ...
  <b>We need your help to translate this README, <a href="https://github.com/Digi-Desk2/Digi-Desk2/tree/master/src/lang">RustDesk UI</a> and <a href="https://github.com/Digi-Desk2/doc.Digi-Desk2.com">RustDesk Doc</a> to your native language</b>
</p>
...
Yet another remote desktop software, written in Rust. Works out of the box, no configuration required. You have full control of your data, with no concerns about security. You can use our rendezvous/relay server, [set up your own](https://Digi-Desk2.com/server), or [write your own rendezvous/relay server](https://github.com/Digi-Desk2/Digi-Desk2-server-demo).
...
Desktop versions use Flutter or Sciter (deprecated) for GUI, this tutorial is for Sciter only, since it is easier and more friendly to start. Check out our [CI](https://github.com/Digi-Desk2/Digi-Desk2/blob/master/.github/workflows/flutter-build.yml) for building Flutter version.
...
- **[libs/clipboard](https://github.com/Digi-Desk2/Digi-Desk2/tree/master/libs/clipboard)**: file copy and paste implementation for Windows, Linux, macOS.
- **[src/ui](https://github.com/Digi-Desk2/Digi-Desk2/tree/master/src/ui)**: obsolete Sciter UI (deprecated)
...
- **[flutter](https://github.com/Digi-Desk2/Digi-Desk2/tree/master/flutter)**: Flutter code for desktop and mobile
