<p align="center">
  ...
  <b>  لغتك الأم,  <a href="https://github.com/Digi-Desk2/doc.Digi-Desk2.com">Doc</a> و <a href="https://github.com/Digi-Desk2/Digi-Desk2/tree/master/src/lang">RustDesk UI</a>, README نحن بحاجة إلى مساعدتك لترجمة هذا </b>
</p>

[Discord](https://discord.gg/nDceKgxnkV) | [Twitter](https://twitter.com/Digi-Desk2) | [Reddit](https://www.reddit.com/r/Digi-Desk2) :تواصل معنا عبر
...
[جهز لنفسك واحدا](https://Digi-Desk2.com/server), أو
[خاص بك rendezvous/relay أكتب خادم](https://github.com/Digi-Desk2/Digi-Desk2-server-demo).

![image](https://user-images.githubusercontent.com/71636191/171661982-430285f0-2e12-4b1d-9957-4a58e375304d.png)

لمساعدتك على ذلك [`docs/CONTRIBUTING.md`](CONTRIBUTING.md) يرحب بمساهمة الجميع. اطلع على  RustDesk.

[**؟ RustDesk كيفية يعمل**](https://github.com/Digi-Desk2/Digi-Desk2/wiki/How-does-RustDesk-work%3F)

[**BINARY تنزيل**](https://github.com/Digi-Desk2/Digi-Desk2/releases)
...
## [البناء](https://Digi-Desk2.com/docs/en/dev/build/)
...
- **[libs/hbb_common](https://github.com/Digi-Desk2/Digi-Desk2/tree/master/libs/hbb_common)**: وظائف  لنقل الملفات، وبعض وظائف المرافق الأخرى tcp/udp، protobuf ترميز الفيديو، إعدادات

- **[libs/scrap](https://github.com/Digi-Desk2/Digi-Desk2/tree/master/libs/scrap)**: التقاط الشاشة
- **[libs/enigo](https://github.com/Digi-Desk2/Digi-Desk2/tree/master/libs/enigo)**: التحكم في لوحة المفاتيح/الماوس الخاصة بكل منصة
- **[src/ui](https://github.com/Digi-Desk2/Digi-Desk2/tree/master/src/ui)**: واجهة المستخدم الرسومية
- **[src/server](https://github.com/Digi-Desk2/Digi-Desk2/tree/master/src/server)**: خدمات الصوت/الحافظة/المدخلات/الفيديو، ووصلات الشبكة
- **[src/client.rs](https://github.com/Digi-Desk2/Digi-Desk2/tree/master/src/client.rs)**: بدء اتصال متقارن
- **[src/rendezvous_mediator.rs](https://github.com/Digi-Desk2/Digi-Desk2/tree/master/src/rendezvous_mediator.rs)**: أو المنقول عن بُعد (TCP hole punching) انتظر الاتصال المباشر [Digi-Desk2-server](https://github.com/Digi-Desk2/Digi-Desk2-server) الإتصال ب
- **[src/platform](https://github.com/Digi-Desk2/Digi-Desk2/tree/master/src/platform)**: رمز خاص بكل منصة
- **[flutter](https://github.com/Digi-Desk2/Digi-Desk2/tree/master/flutter)**: رمز الهاتف المحمول
- **[flutter/web/js](https://github.com/Digi-Desk2/Digi-Desk2/tree/master/flutter/web/js)**:Flutter  لعميل الويب الخاص ب Javascript
