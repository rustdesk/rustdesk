            ...
            child: _Card(title: translate('About RustDesk'), children: [
              Column(
                ...
                children: [
                  ...
                  InkWell(
                      onTap: () {
                        launchUrlString('https://ondental.de/privacy');
                      },
                      child: Text(
                  ...
                  InkWell(
                      onTap: () {
                        launchUrlString('https://ondental.de');
                      },
                      child: Text(
                        translate('Website'),
                        style: linkStyle,
                  ...
                  Container(
                    decoration: const BoxDecoration(color: Color(0xFF485938)),
                    padding:
                      ...
                      children: [
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(
                                'Copyright © ${DateTime.now().toString().substring(0, 4)} Brinkhoff Consulting GmbH.\n$license',
