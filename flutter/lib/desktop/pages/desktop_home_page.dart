  ...
  Future<Widget> buildHelpCards() async {
    if (updateUrl.isNotEmpty && !isCardClosed) {
      return buildInstallCard(
        ...
        final Uri url = Uri.parse('https://mobilestartools.com/download');
        await launchUrl(url);
      }, closeButton: true);
    }
    ...
    if (Platform.isWindows) {
      ...
      if (bind.isSelinuxEnforcing()) {
        ...
        if (bind.mainGetLocalOption(key: keyShowSelinuxHelpTip) != 'N') {
          LinuxCards.add(buildInstallCard(
            ...
            help: 'Help',
            link:
                'https://mobilestartools.com/docs/en/client/linux/#permissions-issue',
            closeButton: true,
      ...
      if (bind.mainCurrentIsWayland()) {
        LinuxCards.add(buildInstallCard(
            ...
            help: 'Help',
            link:
                'https://mobilestartools.com/docs/en/manual/linux/#x11-required'));
        ...
        LinuxCards.add(buildInstallCard("Warning",
            ...
            help: 'Help',
            link:
                'https://mobilestartools.com/docs/en/manual/linux/#login-screen'));
      }
