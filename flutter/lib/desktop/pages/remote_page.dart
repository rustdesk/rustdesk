...
class _RemotePageState extends State<RemotePage>
  ...
  Map<int, RenderTexture> _updateGetRenderTextures() {
    final curDisplay = _ffi.ffiModel.pi.currentDisplay;
  ...
  Widget getBodyForDesktop(BuildContext context) {
    var paints = <Widget>[
      MouseRegion(onEnter: (evt) {
        ...
        return Obx(() => _ffi.ffiModel.pi.isSet.isFalse
            ...
            : ImagePaint(
                ...
                renderTextures: _updateGetRenderTextures(),
...
class _ImagePaintState extends State<ImagePaint> {
  ...
  Widget build(BuildContext context) {
    ...
    if (c.imageOverflow.isTrue && c.scrollStyle == ScrollStyle.scrollbar) {
      ...
      final paintWidget = useTextureRender
          ? _BuildPaintTextureRender(c, s, Offset.zero, isViewOriginal())
  ...
  Widget _BuildPaintTextureRender(
      CanvasModel c, double s, Offset offset, bool isViewOriginal) {
