...
class MyTheme {
  ...
  // EDA Renováveis brand green (logo emblem). Universal accent — legible on both
  // light and dark themes (the brand teal #003C48 is too dark for dark-theme use).
  static const Color accent = Color(0xFF6CA830);
  static const Color accent50 = Color(0x776CA830);
  static const Color accent80 = Color(0xAA6CA830);
  ...
  static const Color button = Color(0xFF6CA830);
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    colorScheme: ColorScheme.light(
        primary: Colors.green, secondary: accent, background: grayBg),
...
Color? _msgboxColor(String type) {
  ...
  return Color(0xFF003C48); // EDA Renováveis brand teal (default/info dialogs)
}
