...
class _SettingsState extends State<SettingsPage> with WidgetsBindingObserver {
  ...
  _SettingsState() {
    ...
    _denyLANDiscovery = !option2bool(
        kOptionEnableLanDiscovery, bind.mainGetOptionSync(key: kOptionEnableLanDiscovery));
    _onlyWhiteList = whitelistNotEmpty();
    _enableDirectIPAccess =
        option2bool(kOptionDirectServer, bind.mainGetOptionSync(key: kOptionDirectServer));
    _enableRecordSession = option2bool(
        kOptionEnableRecordSession, bind.mainGetOptionSync(key: kOptionEnableRecordSession));
    _enableHardwareCodec =
        option2bool(kOptionEnableHwcodec, bind.mainGetOptionSync(key: kOptionEnableHwcodec));
    ...
    _allowAutoDisconnect = option2bool(
        kOptionAllowAutoDisconnect, bind.mainGetOptionSync(key: kOptionAllowAutoDisconnect));
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      var checkUpdateOnStartup = mainGetLocalBoolOptionSync(kOptionEnableCheckUpdate);
  ...
  Future<bool> checkAndUpdateIgnoreBatteryStatus() async {
    final res = await AndroidPermissionManager.check(kRequestIgnoreBatteryOptimizations);
  ...
  Future<bool> checkAndUpdateStartOnBoot() async {
    if (!await canStartOnBoot() && _enableStartOnBoot) {
      ...
      debugPrint("checkAndUpdateStartOnBoot and set _enableStartOnBoot -> false");
      gFFI.invokeMethod(AndroidChannel.kSetStartOnBootOpt, false);
      return true;
    } else {
      return false;
  ...
  Widget build(BuildContext context) {
      ...
      if (enable2fa)
        SettingsTile.switchTile(
          ...
          onToggle: (v) async {
            ...
            if (v == false) {
              CommonConfirmDialog(gFFI.dialogManager, translate('cancel-bot-confirm-tip'), () {
      ...
      SettingsTile.switchTile(
        ...
        onToggle: isOptionFixed(kOptionEnableRecordSession)
            ...
            : (v) async {
                ...
                final newValue = await mainGetBoolOption(kOptionEnableRecordSession);
                setState(() {
      ...
      SettingsTile.switchTile(
              ...
              Offstage(
                  ...
                  child: IconButton(
                      ...
                      onPressed: isOptionFixed(kOptionDirectAccessPort)
                          ...
                          : () async {
                              final port =
                                  await changeDirectAccessPort(_localIP, _directAccessPort);
                              setState(() {
        ...
        onToggle: isOptionFixed(kOptionDirectServer)
            ...
            : (_) async {
                ...
                String value = bool2option(kOptionDirectServer, _enableDirectIPAccess);
                await bind.mainSetOption(key: kOptionDirectServer, value: value);
                setState(() {});
              },
      ),
      SettingsTile.switchTile(
              ...
              Offstage(
                  ...
                  child: IconButton(
                      ...
                      onPressed: isOptionFixed(kOptionAutoDisconnectTimeout)
                          ...
                          : () async {
                              final timeout =
                                  await changeAutoDisconnectTimeout(_autoDisconnectTimeout);
                              setState(() {
        ...
        onToggle: isOptionFixed(kOptionAllowAutoDisconnect)
            ...
            : (_) async {
                ...
                String value = bool2option(kOptionAllowAutoDisconnect, _allowAutoDisconnect);
                await bind.mainSetOption(key: kOptionAllowAutoDisconnect, value: value);
                setState(() {});
              },
      )
    ];
    ...
    onFloatingWindowChanged(bool toValue) async {
      ...
      bind.mainSetLocalOption(
          key: kOptionDisableFloatingWindow, value: disable ? 'Y' : defaultOptionNo);
    ...
    final hideSecuritySettings = bind.mainGetBuildinOption(key: kOptionHideSecuritySetting) == 'Y';
    final settings = SettingsList(
      sections: [
        ...
        SettingsSection(title: Text(translate("Settings")), tiles: [
          ...
          SettingsTile(
            title: Text(translate(
                Theme.of(context).brightness == Brightness.light ? 'Light Theme' : 'Dark Theme')),
            ...
            SettingsTile.switchTile(
              ...
              onToggle: isOptionFixed(kOptionEnableHwcodec)
                  ...
                  : (v) async {
                      ...
                      final newValue = await mainGetBoolOption(kOptionEnableHwcodec);
                      setState(() {
        ...
        if (isAndroid)
          SettingsSection(
            ...
            tiles: [
                  ...
                  onToggle: isOptionFixed(kOptionAllowAutoRecordIncoming)
                      ...
                      : (v) async {
                          await bind.mainSetOption(
                              ...
                              value: bool2option(kOptionAllowAutoRecordIncoming, v));
                          final newValue = option2bool(kOptionAllowAutoRecordIncoming,
              ...
              if (!incommingOnly)
                SettingsTile.switchTile(
                  title: Text(translate('Automatically record outgoing sessions')),
                  ...
                  onToggle: isOptionFixed(kOptionAllowAutoRecordOutgoing)
                      ...
                      : (v) async {
                          await bind.mainSetLocalOption(
                              ...
                              value: bool2option(kOptionAllowAutoRecordOutgoing, v));
                          final newValue = option2bool(kOptionAllowAutoRecordOutgoing,
                              bind.mainGetLocalOption(key: kOptionAllowAutoRecordOutgoing));
                          setState(() {
        ...
        if (isAndroid && !disabledSettings && !outgoingOnly && !hideSecuritySettings)
        ...
        SettingsSection(
          ...
          tiles: [
            ...
            SettingsTile(
              ...
              onPressed: (context) => launchUrlString('https://rustdesk.com/privacy.html'),
        ...
        content: Column(
          children: [
              ...
              langs.map((e) {
                ...
                return getRadio(Text(translate(name)), key, lang, isOptFixed ? null : setLang);
              }).toList(),
        ),
      );
  ...
  dialogManager.show((setState, close, context) {
    ...
    return CustomAlertDialog(
      content: Column(children: [
        getRadio(
            Text(translate('Light')), ThemeMode.light, themeMode, isOptFixed ? null : setTheme),
        getRadio(Text(translate('Dark')), ThemeMode.dark, themeMode, isOptFixed ? null : setTheme),
    ...
    return Scaffold(
      ...
      body: SettingsList(sections: [
        SettingsSection(
          tiles: [
            _getPopupDialogRadioEntry(
              ...
              getter: () => bind.mainGetUserDefaultOption(key: kOptionViewStyle),
            ...
            _getPopupDialogRadioEntry(
              ...
              asyncSetter: isOptionFixed(kOptionImageQuality)
                  ...
                  : (value) async {
                      ...
                      showCustomImageQuality.value = value == kRemoteImageQualityCustom;
                    },
            ...
            _getPopupDialogRadioEntry(
              title: 'Default Codec',
              list: codecList,
              getter: () => bind.mainGetUserDefaultOption(key: kOptionCodecPreference),
        ...
        SettingsSection(
          ...
          tiles: otherDefaultSettings().map((e) => otherRow(e.$1, e.$2)).toList(),
        ),
      ]),
    );
  }
  ...
  SettingsTile otherRow(String label, String key) {
    ...
    return SettingsTile.switchTile(
      ...
      onToggle: isOptFixed
          ? null
          : (b) async {
              await bind.mainSetUserDefaultOption(key: key, value: b ? 'Y' : defaultOptionNo);
              setState(() {});
            },
    );
  }
        ...
        actions: [
          Obx(() => IconButton(
              ...
              onPressed: selectedDevices.isEmpty
                  ? null
                  : () {
                      confrimDeleteTrustedDevicesDialog(trustedDevices, selectedDevices);
                    }))
        ],
      ),
      body: FutureBuilder(
  ...
  void showDialog() async {
    gFFI.dialogManager.show((setState, close, context) {
      ...
      return CustomAlertDialog(
        ...
        () => Column(children: [
          ...list
              .map((e) => getRadio(Text(translate(e.label)), e.value, groupValue.value, onChanged))
              .toList(),
          Offstage(
            offstage: !(tail != null && showTail != null && showTail.value == true),
            child: tail,
          ),
        ]),
      ));
