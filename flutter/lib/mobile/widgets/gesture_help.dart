                      ...
                      Transform.translate(
                        ...
                        child: Row(
                          ...
                          children: [
                            Checkbox(
                              value: _touchMode
                                  ? _virtualMouseMode.showVirtualMouseTouchMode
                                  : _virtualMouseMode.showVirtualMouseMouseMode,
                              onChanged: (value) async {
                                if (value == null) return;
                                if (_touchMode) {
                                  await _virtualMouseMode
                                      .toggleVirtualMouseTouchMode();
                                } else {
                                  await _virtualMouseMode
                                      .toggleVirtualMouseMouseMode();
                                }
                                setState(() {});
                              },
                            ),
                                      ...
                                      Expanded(
                                        child: Slider(
                                          value: _virtualMouseMode
                                              .virtualMouseTouchScale,
                                          min: 0.8,
                                          max: 1.8,
                                          divisions: 10,
                                          onChanged: (value) {
                                            _virtualMouseMode
                                                .setVirtualMouseTouchScale(
                                                    value);
                                            setState(() {});
                                          },
                                        ),
