...
class FfiModel with ChangeNotifier {
  ...
  handlePlatformAdditions(
    ...
    if (updateData.isEmpty) {
      _pi.platformAdditions.remove(kPlatformAdditionsTechDeskVirtualDisplays);
      ...
      try {
        ...
        if (!updateJson
            .containsKey(kPlatformAdditionsTechDeskVirtualDisplays)) {
          _pi.platformAdditions
              .remove(kPlatformAdditionsTechDeskVirtualDisplays);
        }
...
class PeerInfo with ChangeNotifier {
  ...
  List<int> get TechDeskVirtualDisplays => List<int>.from(
      platformAdditions[kPlatformAdditionsTechDeskVirtualDisplays] ?? []);
  ...
  bool get isTechDeskIdd =>
      platformAdditions[kPlatformAdditionsIddImpl] == 'techdesk_idd';
