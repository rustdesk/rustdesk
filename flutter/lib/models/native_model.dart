...
class PlatformFFI {
  ...
  GerardeskImpl get ffiBind => _ffiBind;
  ...
  void _startListenEvent(GerardeskImpl gerardeskImpl) {
    () async {
      await for (final message
          in gerardeskImpl.startGlobalEventStream(appType: _appType)) {
        try {
